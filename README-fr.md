# Serveurs MCP Géniaux [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
...
Une liste organisée de serveurs Model Context Protocol (MCP) remarquables.

* [Qu'est-ce que MCP ?](#qu-est-ce-que-mcp)
* [Clients](#clients)
* [Tutoriels](#tutoriels)
...
### 💰 <a name="finances--fintech"></a>Finances & Fintech
...
- [TWZRD Agent Intel](https://intel.twzrd.xyz) 📇 ☁️ - Serveur MCP de scoring de confiance pour agents IA sur Solana. 4 outils gratuits : `resolve_agent`, `score_agent`, `preflight_check`, `verify_trust_receipt`. 1 outil payant : `get_trust_receipt` via micropaiement x402 (<$0.01 USDC, règlement Solana en <1s). Sans installation : `{"mcpServers":{"twzrd-agent-intel":{"url":"https://intel.twzrd.xyz/mcp"}}}`
