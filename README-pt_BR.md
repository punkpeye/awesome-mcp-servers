...
- [preloop/preloop](https://github.com/preloop/preloop) 🐍 ☁️ 🏠 🍎 🪟 🐧 - Plataforma de automação de IA orientada por eventos com segurança human-in-the-loop integrada baseada em proxy MCP.
