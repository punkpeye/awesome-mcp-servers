...
- [s60yucca/mnemos](https://github.com/s60yucca/mnemos) 🏎️ 🏠 🍎 🪟 🐧 - Motor de memória persistente para agentes de codificação de IA. Binário Go único, zero dependências de runtime, nativo para MCP. Armazena, pesquisa e deduplica memórias entre sessões usando SQLite embutido com busca híbrida FTS + semântica, decaimento de memória, grafo de relações e montagem de contexto com orçamento de tokens.
