...
- [kyrodata/mcp](https://github.com/kyrodata/mcp) 🎖️ 📇 ☁️ - Comércio exterior brasileiro do MDIC/ComexStat — exportação e importação desde 2000 por posição (SH4) e país parceiro, em US$ FOB e quilos — mais produção agrícola, balanços de oferta e demanda, leitura de clima e previsões de commodities para soja, café, milho e boi. 14 ferramentas somente de leitura. Toda comparação é entre janelas de mesmo peso, cada uma rotulada com o período que de fato mede, e toda resposta diz a janela e a fonte; "sem sinal" é resposta honesta quando o dado não sustenta um veredito. Remoto, nada a instalar: https://mcp.kyrodata.com/mcp com chave ou OAuth 2.1. No registry oficial como `com.kyrodata/kyrodata`.
