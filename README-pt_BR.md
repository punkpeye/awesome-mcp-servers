...
- [Ideas-Net-Studio/mcp-shared-memory](https://github.com/Ideas-Net-Studio/mcp-shared-memory) 📇 🏠 🍎 🪟 🐧 - Um sistema de gerenciamento de memória compartilhável para ferramentas MCP e times. Fornece armazenamento de memória estruturada que pode ser compartilhado entre múltiplas ferramentas de IA e membros do mesmo time, com integração ao Git para construção colaborativa de memória e controle de versão.
