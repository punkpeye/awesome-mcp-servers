...
- [team-telnyx/telnyx-mcp-server](https://github.com/team-telnyx/telnyx-mcp-server) 🎖️ 🐍 ☁️ 🏠 - Servidor MCP oficial para construir aplicativos de comunicação com IA. Crie assistentes de voz, envie campanhas SMS, gerencie números de telefone e integre mensagens em tempo real com confiabilidade de nível empresarial. Inclui servidores remotos [streamable-http](https://api.telnyx.com/v2/mcp) e [sse](https://api.telnyx.com/mcp/sse).
