...
- [globalpocket/mcp-routing-gateway](https://github.com/globalpocket/mcp-routing-gateway) - Um gateway de roteamento MCP sem estado e Pure Proxy para organizar, filtrar e virtualizar com segurança as ferramentas apresentadas aos LLMs.
...
- [globalpocket/mcp-mlx-launcher](https://github.com/globalpocket/mcp-mlx-launcher) - Um servidor MCP para gerenciar, iniciar e desligar de forma autônoma instâncias locais do `mlx-lm` no Apple Silicon.
