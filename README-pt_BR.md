...
- [hardik-id/azure-resource-graph-mcp-server](https://github.com/hardik-id/azure-resource-graph-mcp-server) 📇 ☁️/🏠 - Um servidor de Protocolo de Contexto de Modelo para consultar e analisar recursos do Azure em escala usando o Azure Resource Graph, permitir que assistentes de IA explorem e monitorem a infraestrutura do Azure.
- [hzy9981/vertex-ai-mcp-bridge](https://github.com/hzy9981/vertex-ai-mcp-bridge) 🐍 ☁️ - Um servidor MCP especializado para gerenciamento e otimização de prompts do Google Vertex AI, com recursos de proxy de ferramentas entre nuvens.
