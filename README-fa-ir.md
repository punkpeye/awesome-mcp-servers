...
- [longbridge/longbridge-mcp](https://github.com/longbridge/longbridge-mcp) [![longbridge/longbridge-mcp MCP server](https://glama.ai/mcp/servers/longbridge/longbridge-mcp/badges/score.svg)](https://glama.ai/mcp/servers/longbridge/longbridge-mcp) 🎖️ 🦀 ☁️ - سرور MCP رسمی کارگزاری Longbridge — 128 ابزار برای نقل‌قول آنی سهام آمریکا/هنگ‌کنگ، اختیار معامله، معاملات، تحلیل بنیادی، هشدار قیمت و تحلیل پرتفولیو. میزبانی در `https://openapi.longbridge.com/mcp` با OAuth 2.1.
