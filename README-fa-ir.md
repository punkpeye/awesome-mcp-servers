...
- [ScrapeGraphAI/scrapegraph-mcp](https://github.com/ScrapeGraphAI/scrapegraph-mcp) 🐍 ☁️ 🏠 🍎 🪟 🐧 - استخراج وب مبتنی بر هوش مصنوعی از طریق [ScrapeGraph AI](https://scrapegraphai.com/) API. تبدیل Markdown، استخراج هوشمند، جستجو، خزش چند صفحه‌ای و گردش کار نماینده. از راه دور یا محلی. پشتیبانی از Claude Desktop، Cursor و [Smithery](https://smithery.ai/server/@ScrapeGraphAI/scrapegraph-mcp).
