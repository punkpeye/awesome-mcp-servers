...
- [memcell-ai/cli](https://github.com/memcell-ai/cli) [![memcell-ai/cli MCP server](https://glama.ai/mcp/servers/memcell-ai/cli/badges/score.svg)](https://glama.ai/mcp/servers/memcell-ai/cli) 📇 🏠 🍎 🪟 🐧 - حافظه زنده برای عامل‌های کدنویسی هوش مصنوعی (Claude Code، Cursor، Copilot، Codex). حافظه پایدار بین ابزارها، فراخوانی تصمیمات و کالیبراسیون نتایج از طریق MCP و هوک‌ها. `npm install -g memcell`
