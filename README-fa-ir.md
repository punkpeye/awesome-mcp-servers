...
- [mobbin/mobbin-mcp-server](https://github.com/mobbin/mobbin-mcp-server) 🎖️ ☁️ - جست‌وجوی نمونه‌های واقعی طراحی رابط کاربری — صفحه‌ها، جریان‌های چندمرحله‌ای کاربر و بخش‌های وب‌سایت — از هزاران اپلیکیشن و وب‌سایت. نقطه پایانی میزبانی‌شده Streamable HTTP در `https://api.mobbin.com/mcp` با OAuth (بدون کلید API) و نمایش گالری تعاملی نتایج به‌صورت درون‌خطی در کلاینت‌های MCP Apps.
