...
- [stackql/stackql](https://github.com/stackql/stackql) 🎖️ 🏎️ ☁️/🏠 🍎 🪟 🐧 - سرور MCP رسمی تعبیه‌شده در StackQL که به عامل‌های هوش مصنوعی امکان کشف، کوئری و فراهم‌سازی منابع را در AWS، Azure، Google Cloud، GitHub، Databricks، Snowflake، Okta، Cloudflare و بیش از ۱۰۰ ارائه‌دهنده دیگر با استفاده از معنای SQL می‌دهد. از انتقال‌های stdio، HTTP و reverse-proxy با حالت‌های ایمنی قابل‌پیکربندی (فقط خواندنی، ایمن، حذف-ایمن، دسترسی کامل) پشتیبانی می‌کند. [stackql.io/docs/mcp](https://stackql.io/docs/mcp) را ببینید.
