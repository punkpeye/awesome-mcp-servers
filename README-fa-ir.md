...
- [s60yucca/mnemos](https://github.com/s60yucca/mnemos) 🏎️ 🏠 🍎 🪟 🐧 - موتور حافظه پایدار برای عامل‌های کدنویسی هوش مصنوعی. یک باینری Go، بدون وابستگی‌های زمان اجرا، بومی MCP. با استفاده از SQLite تعبیه‌شده، حافظه‌ها را در طول جلسات ذخیره، جستجو و حذف تکراری می‌کند با جستجوی ترکیبی FTS + معنایی، افت حافظه، گراف روابط و مونتاژ زمینه با بودجه توکن.
