...
- [opanel-mc/opanel-mcp](https://github.com/opanel-mc/opanel-mcp) [glama](https://glama.ai/mcp/servers/@opanel-mc/opanel-mcp) 📇 ☁️ - OPanel伺服器管理面板集成MCP伺服器，用於大模型輔助管理Minecraft伺服器
