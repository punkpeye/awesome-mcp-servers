...
- [longbridge/longbridge-mcp](https://github.com/longbridge/longbridge-mcp) [![longbridge/longbridge-mcp MCP server](https://glama.ai/mcp/servers/longbridge/longbridge-mcp/badges/score.svg)](https://glama.ai/mcp/servers/longbridge/longbridge-mcp) 🎖️ 🦀 ☁️ - 長橋證券官方 MCP — 128 個工具覆蓋港美股即時行情、期權、交易、基本面、分析師評級、日曆、價格預警、定投計劃與組合分析。托管於 `https://openapi.longbridge.com/mcp`，支援 OAuth 2.1。
