...
- [JamesANZ/video-toolkit-mcp](https://github.com/JamesANZ/video-toolkit-mcp) 📇 ☁️ 🏠 🍎 🪟 🐧 - 影片工具包，用於獲取字幕、下載影片和AI字幕生成。從YouTube/Vimeo/Bilibili獲取字幕，透過yt-dlp下載影片，使用OpenAI Whisper或本地whisper自動生成字幕。
