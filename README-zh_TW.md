...
- [memcell-ai/cli](https://github.com/memcell-ai/cli) [![memcell-ai/cli MCP server](https://glama.ai/mcp/servers/memcell-ai/cli/badges/score.svg)](https://glama.ai/mcp/servers/memcell-ai/cli) 📇 🏠 🍎 🪟 🐧 - 面向 AI 編碼智能體（Claude Code、Cursor、Copilot、Codex）的活體記憶系統。跨工具持久化記憶、決策召回與結果校準。`npm install -g memcell`
