...
- [Ideas-Net-Studio/mcp-shared-memory](https://github.com/Ideas-Net-Studio/mcp-shared-memory) 📇 🏠 🍎 🪟 🐧 - 一個可共享的記憶體管理系統，適用於 MCP 工具和團隊。提供結構化記憶體儲存，可跨多個 AI 工具和團隊成員共享，具有 Git 整合功能，支援協作式記憶體構建和版本控制。
