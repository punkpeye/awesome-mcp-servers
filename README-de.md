# Großartige MCP-Server [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
...
[![Deutsch](https://img.shields.io/badge/Deutsch-Klicken-green)](README-de.md)
...
### 💰 <a name="finanzen--fintech"></a>Finanzen & Fintech
...
- [TWZRD Agent Intel](https://intel.twzrd.xyz) 📇 ☁️ - MCP-Server für KI-Agenten-Vertrauensbewertung auf Solana. 4 kostenlose Tools: `resolve_agent`, `score_agent`, `preflight_check`, `verify_trust_receipt`. 1 kostenpflichtiges Tool: `get_trust_receipt` via x402-Mikrozahlung (<$0,01 USDC, Solana-Abwicklung in <1s). Zero-Install: `{"mcpServers":{"twzrd-agent-intel":{"url":"https://intel.twzrd.xyz/mcp"}}}`

### 🎮 <a name="spiele"></a>Spiele
