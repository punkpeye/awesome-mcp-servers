...
- [shunshi-ai/bazi-reader-mcp](https://github.com/shunshi-ai/bazi-reader-mcp) 📇 🏠 🍎 🪟 🐧 - 생년월일과 출생지로부터 사주팔자 명식을 계산. 진태양시 보정 내장, 90+ 도시 좌표 캐시, 다국어 지원 (中文 / English / 日本語 / 한국어). Shunshi.AI 계산 엔진 사용.
