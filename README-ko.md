...
- [defeatbeta-api MCP](https://github.com/defeat-beta/defeatbeta-api/tree/main/mcp) 🎖 🐍 🏠 🍎 🐧 💰 - Defeat Beta API는 미국 주식 시장의 풍부한 시세와 기본 데이터를 무료로, 제한 없이 제공하며, MCP 인터페이스를 통해 LLM AI 분석 및 거래를 지원합니다.
