...
- [PaddlePaddle/PaddleOCR](https://paddlepaddle.github.io/PaddleOCR/latest/en/version3.x/deployment/mcp_server.html) - AI 애플리케이션에 엔터프라이즈급 OCR 및 문서 분석 기능을 제공하는 MCP 서버.
