...
* [Zlatanwic/wechat-article-read-mcp](https://github.com/Zlatanwic/Wechat-Read-MCP-in-Rust) 🦀 🏠 🪟 🐧 - An MCP Server enabling AI assistants to read WeChat articles which has a good performance and is written in Rust.
