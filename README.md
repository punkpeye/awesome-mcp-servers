...
- [RSNCNetwork/resonance-agent](https://github.com/RSNCNetwork/resonance-agent) 📇 ☁️ - Cross-brand loyalty, rewards, and commerce MCP server. Earn cashback, browse deals, redeem perks, and manage reward programs across retail, dining, travel, and gaming brands. 26+ tools for brand discovery, analytics, leaderboards, and program management. Built on Soneium blockchain with RSNC token economics.
