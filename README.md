...
- [Stagehand MCP Server](https://github.com/browserbase/mcp-server-browserbase) 🌐 - An MCP server that uses [Stagehand](https://www.stagehand.dev/) by [Browserbase](https://www.browserbase.com/) for reliable natural language browser automation 
