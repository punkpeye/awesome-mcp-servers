...
- [TerminalGravity/preflight](https://github.com/TerminalGravity/preflight) 📇 🏠 - 24-tool MCP server for Claude Code that catches vague prompts before they waste tokens. Preflight checks, 12-category scorecards, correction pattern learning, cross-service contract awareness, cost estimation, and semantic session history search with LanceDB vectors.
