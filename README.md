...
- [MinglesAI/ai-site-scorer](https://github.com/MinglesAI/ai-site-scorer) [glama](https://glama.ai/mcp/connectors/io.github.MinglesAI/ai-site-scorer) 🐍 ☁️ - Analyze any website for AI/LLM readiness from Cursor, Claude Desktop, or VS Code. 18 automated checks covering structured data (Schema.org, JSON-LD), llms.txt, robots.txt, sitemap, page speed, content quality, E-E-A-T, and Open Graph. Returns actionable scores and IDE-ready fix prompts. Hosted HTTP transport — no local install needed.
