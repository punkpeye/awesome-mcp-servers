...
- [robot-rubik/scopeshield-mcp](https://github.com/robot-rubik/ceoclaw/tree/master/ceoclaw/scopeshield-mcp) 📇 🏠 🐧 🍎 🪟 - Freelancer scope creep tracker. Log deliverables, track client change requests, calculate scope delta, and generate one-click change orders. Helps freelancers prevent unpaid work.
...
- [robot-rubik/scopeshield-mcp](https://github.com/robot-rubik/ceoclaw/tree/master/ceoclaw/scopeshield-mcp) 📇 ☁️ 🍎 🪟 🐧 - Scope creep tracker for freelancers. Log deliverables, track client change requests with timestamps, calculate scope delta in dollars, and generate one-click change orders. Stop working for free.
