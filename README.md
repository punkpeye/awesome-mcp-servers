...
- [robot-rubik/ceoclaw](https://github.com/robot-rubik/ceoclaw/tree/master/ceoclaw/scopeshield-mcp) 📇 🏠 🐧 🍎 🪟 - ScopeShield MCP: track freelance project scope, log change requests, calculate scope delta, and generate one-click change orders. Helps AI agents protect freelancer income by documenting every deliverable and client-requested change.

- [robot-rubik/scopeshield-mcp](https://github.com/robot-rubik/ceoclaw/tree/master/ceoclaw/scopeshield-mcp) 📇 ☁️ 🍎 🪟 🐧 - MCP server for freelance scope creep tracking. Helps AI agents log project deliverables, track client change requests with timestamps, calculate scope delta in dollars, and generate professional change orders. Stop losing money to unpaid work.
