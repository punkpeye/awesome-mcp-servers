...
- [codyz123/schelling-protocol](https://github.com/codyz123/schelling-protocol) 📇 ☁️ - Universal coordination protocol for AI agents. Discovery, matching, negotiation, contracts, and reputation over plain HTTP. Agents coordinate on behalf of humans — find roommates, hire freelancers, or match any coordination problem through one protocol. 40+ operations, delegation model, live API.
