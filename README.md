...
- [lordbasilaiassistant-sudo/thryx-portfolio-mcp](https://github.com/lordbasilaiassistant-sudo/thryx-portfolio-mcp) 📇 ☁️ - Portfolio of 14 deployed Base mainnet contracts + 4 Clanker tokens, exposed as 14 read-only tools: list & query DeadManSwitch (inheritance dead-man trigger), AddressTaggingMarket (stake-weighted address labels), StealthAddressRegistry (EIP-5564), TimeCapsule, vesting/ENS/DAO/NFT keepers, and a generic ABI-gated view-fn caller. Treasury `0x7a3E312Ec6e20a9F62fE2405938EB9060312E334`. `npx -y @thryx/portfolio-mcp-server`
