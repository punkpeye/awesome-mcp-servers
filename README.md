...
- [ParthJadhav/telegram-notify-mcp](https://github.com/ParthJadhav/telegram-notify-mcp) 📇 🏠 🍎 🪟 🐧 - Send Telegram notifications from AI agents. Supports text messages, photos, and documents via the Telegram Bot API.
