...
- [CSCSoftware/AiDex](https://github.com/CSCSoftware/AiDex) 📇 🏠 🍎 🪟 🐧 - Persistent code indexing for AI assistants using Tree-sitter. Indexes identifiers, methods, and types in 11 languages. ~50 tokens per query vs 2000+ with grep. Includes method signatures, time-based filtering, cross-project search, session notes, task backlog, and interactive browser viewer.
