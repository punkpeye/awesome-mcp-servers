...
- [opportune-to/anr](https://github.com/opportune-to/anr) 📇 ☁️ - Agent Native Registry — rates developer tools 0–100 on how well AI agents can use them end-to-end (discovery, account creation, agent tooling, reliability, pricing). Query via MCP to get agent-ready tool recommendations. Live at [agentnativeregistry.com](https://agentnativeregistry.com).
