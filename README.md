...
- [MikkoParkkola/mcp-gateway](https://github.com/MikkoParkkola/mcp-gateway) 🦀 🏠 🍎 🪟 🐧 - Universal Rust gateway with Meta-MCP pattern (4 tools → 100+), ~95% context token savings, circuit breakers, rate limiting, and 42 starter API capabilities.
