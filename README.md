...
- [lightpanda-io/gomcp](https://github.com/lightpanda-io/gomcp) 🏎 🏠/☁️ 🐧/🍎 - A Go-based MCP server for the Lightpanda browser, the first true headless browser, made for AI
