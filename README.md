...
- [S2TConsulting/accelerators-mcp](https://github.com/S2TConsulting/accelerators-mcp) [glama](https://glama.ai/mcp/servers/@S2TConsulting/accelerators-mcp) 📇 ☁️ - 36 enterprise MCP tools: IAM policy validation, MFA compliance, CloudFormation generation, DynamoDB design, OAuth validation, vector embeddings, error pattern analysis, 12 ACI governance tools for AI agent safety, and stakeholder interview automation. Free tier available.
