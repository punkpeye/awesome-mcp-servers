...
- [PrintrFi/printr-mcp](https://github.com/PrintrFi/printr-mcp) 🎖️ 📇 ☁️ - Create, discover, and track tokens across EVM chains and Solana. Supports autonomous signing, browser-based wallet signing, and AI-generated token images. No API key required.
