...
- [heznpc/iMcp](https://github.com/heznpc/iMcp) 📇 🏠 🍎 - MCP server for the entire Apple ecosystem — 110 tools across 13 apps (Notes, Reminders, Calendar, Contacts, Mail, Messages, Music, Finder, Safari, System, Photos, Shortcuts, Apple Intelligence) with 20 prompts, 4 resources, and dual stdio + HTTP transport.
