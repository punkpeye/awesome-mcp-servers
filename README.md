...
- [ezbiz-services/mcp-govcon](https://github.com/ezbiz-services/mcp-govcon) 📇 ☁️ - Federal contracting intelligence MCP server — search SAM.gov contract opportunities, analyze agency spending patterns, track competitor wins, and monitor small business set-asides (8(a), HUBZone, SDVOSB).
