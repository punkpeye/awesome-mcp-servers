...
- [eren-solutions/mcp-security-audit](https://github.com/eren-solutions/mcp-security-audit) 🐍 ☁️ - AI-powered code security auditor that scans GitHub repositories for vulnerabilities with OWASP/CWE references and remediation guidance.
