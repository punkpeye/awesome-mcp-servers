...
- [kweenkl/kweenkl-mcp](https://github.com/antoinedelorme/kweenkl-mcp) 📇 ☁️ - Send push notifications to iPhone via kweenkl. One API call, one webhook token, instant delivery. Perfect for alerting humans when AI agent tasks complete.
