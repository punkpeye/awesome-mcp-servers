...
- [Philidor-Labs/philidor-mcp](https://github.com/Philidor-Labs/philidor-mcp) 📇 ☁️ - Search 700+ DeFi vaults, compare risk scores, and analyze protocols with multi-vector risk scoring. Streamable HTTP transport, no API key needed.
