...
- [neuledge/context](https://github.com/neuledge/context) 📇 🏠 - Local-first documentation retrieval for AI agents. Indexes docs from any git repo into SQLite with FTS5 for offline, instant, private access to up-to-date library documentation.
