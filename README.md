...
- [MidOS MCP](https://github.com/MidOSresearch/midos) - Community AI knowledge library: 169-tool MCP server with semantic search, RAG over 700+ research chunks, agent memory, quality scoring pipeline, and adaptive multi-model profiles (stdio + HTTP + SSE).
