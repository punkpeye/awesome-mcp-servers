...
- [vswarm-ai/verdictswarm-mcp](https://github.com/vswarm-ai/verdictswarm-mcp) 📇 🏠 - Multi-AI crypto token scanner. Scans Solana tokens for rug pulls, honeypots, and risks using multiple AI models for consensus verdicts.
