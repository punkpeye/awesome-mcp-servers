...
- [lordbasilaiassistant-sudo/obsd-launchpad-mcp](https://github.com/lordbasilaiassistant-sudo/obsd-launchpad-mcp) 📇 ☁️ - AI agent token launchpad on Base. 10 MCP tools: deploy tokens, buy/sell via bonding curve, claim creator fees, get quotes and analytics. Treasury-backed intrinsic value floor, progressive sell tax, auto-distribution. Install: npx -y obsd-launchpad-mcp
