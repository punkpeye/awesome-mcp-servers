...
- [joesaby/doctree-mcp](https://github.com/joesaby/doctree-mcp) 📇 🏠 🍎 🪟 🐧 - BM25 search and tree navigation over markdown docs. Agents search with BM25, read the heading hierarchy, reason about which sections matter, then retrieve exactly what they need — no embeddings, no LLM calls at index time.
