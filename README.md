...
- [Tommertom/safer_fetch_mcp](https://github.com/Tommertom/safer_fetch_mcp) 🐍 🏠 - A web content fetching MCP server with built-in prompt injection safeguards. Converts HTML to markdown while protecting against malicious content that could manipulate the LLM through pattern detection and content boundary wrapping.
