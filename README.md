...
- [kyomi-ai/kyomi-connect](https://github.com/kyomi-ai/kyomi-connect) 🦀 ☁️ - AI data intelligence platform with MCP server for querying 9 data warehouses (BigQuery, Snowflake, PostgreSQL, MySQL, ClickHouse, Redshift, Databricks, SQL Server, Azure Synapse), semantic catalog search, dashboard creation, and automated data monitoring. Learns your business context over time.
