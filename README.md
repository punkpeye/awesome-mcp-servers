...
- [mistaike-ai/mistaike-mcp](https://github.com/mistaike-ai/mistaike-mcp) - [Glama](https://glama.ai/mcp/connectors/io.github.mistaike-ai/mistaike-mcp) 🐍 ☁️ - Two tools in one: (1) 295k+ bug-fix patterns — search by description or code snippet to find known fixes before your AI agent repeats them. (2) DLP layer for your AI agent — automatically redacts PII (emails, SSNs, phone numbers) and secrets (API keys, tokens) from tool call inputs and outputs via an MCP proxy.
