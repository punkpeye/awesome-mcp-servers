...
- [howardpen9/grok-mcp](https://github.com/howardpen9/grok-mcp) 📇 🏠 🍎 🪟 🐧 - MCP server wrapping the xAI Grok Build CLI. Four tools (`grok_chat`, `grok_review`, `grok_consult`, `grok_challenge`) bring Grok in as a peer reviewer and adversarial code-hunter alongside your main model. Install: `npx -y grok-build-mcp`.
