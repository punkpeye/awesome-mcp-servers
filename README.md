...
- [ryudi84/sovereign-web-scraper-mcp](https://github.com/ryudi84/sovereign-mcp-servers/tree/main/web-scraper) 📇 ☁️ - Web scraping toolkit that fetches and cleans HTML, extracts links and metadata, and converts pages to AI-friendly markdown.
...
- [ryudi84/sql-forge-mcp](https://github.com/ryudi84/sovereign-mcp-servers/tree/main/sql-forge) 📇 🏠 - SQL toolkit for building queries, formatting SQL, validating syntax, and generating common query patterns.
...
- [ryudi84/css-forge-mcp](https://github.com/ryudi84/sovereign-mcp-servers/tree/main/css-forge) 📇 🏠 - CSS toolkit for generating flexbox layouts, CSS grid configurations, animations, and media queries.
- [ryudi84/html-forge-mcp](https://github.com/ryudi84/sovereign-mcp-servers/tree/main/html-forge) 📇 🏠 - HTML toolkit for generating boilerplate, minifying and prettifying markup, validating structure, and meta tags.
- [ryudi84/json-forge-mcp](https://github.com/ryudi84/sovereign-mcp-servers/tree/main/json-forge) 📇 🏠 - JSON toolkit for formatting, validating, diffing, querying with JSONPath, and generating JSON Schema from data.
- [ryudi84/regex-lab-mcp](https://github.com/ryudi84/sovereign-mcp-servers/tree/main/regex-lab) 📇 🏠 - Regex toolkit for testing patterns against input, explaining regex syntax, and generating patterns from descriptions.
- [ryudi84/sovereign-api-tester-mcp](https://github.com/ryudi84/sovereign-mcp-servers/tree/main/api-tester) 📇 ☁️ - API testing toolkit for sending HTTP requests, testing endpoints with assertions, and generating cURL commands.
- [ryudi84/yaml-forge-mcp](https://github.com/ryudi84/sovereign-mcp-servers/tree/main/yaml-forge) 📇 🏠 - YAML toolkit for formatting, validating, converting between JSON and YAML, and config templates.
...
- [ryudi84/sovereign-seo-analyzer-mcp](https://github.com/ryudi84/sovereign-mcp-servers/tree/main/seo-analyzer) 📇 ☁️ - SEO analysis toolkit for auditing meta tags, heading structure, links, and keyword density.
...
- [ryudi84/git-forge-mcp](https://github.com/ryudi84/sovereign-mcp-servers/tree/main/git-forge) 📇 🏠 - Git toolkit for generating commit messages, .gitignore files, branch naming, and common Git workflow commands.
