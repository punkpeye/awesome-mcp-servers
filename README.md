...
- [rafsilva85/credit-optimizer-v5](https://github.com/rafsilva85/credit-optimizer-v5) [<img src="https://glama.ai/mcp/servers/rafsilva85/manus-credit-optimizer/badge" height="20" alt="Glama" />](https://glama.ai/mcp/servers/rafsilva85/manus-credit-optimizer) 🐍 ☁️ 🏠 🍎 🪟 🐧 - MCP server that automatically optimizes Manus AI credit consumption by 30-75% with zero quality loss through intelligent model routing, context hygiene, and smart testing.
