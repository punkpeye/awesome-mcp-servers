...
- [trevorflipper/x402-multichain-gateway](https://github.com/trevorflipper/x402-multichain-gateway) 📇 ☁️ - 24 pay-per-call NEAR, Solana & Base blockchain data endpoints via x402 USDC micropayments. No API keys — agents pay $0.001–$0.005 per call with a payment header. Includes analytics dashboard and agent discovery (OpenAPI, A2A, llms.txt).
