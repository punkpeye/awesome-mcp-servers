...
- [VibeCodingInc/vibe-mcp](https://github.com/VibeCodingInc/vibe-mcp) 📇 ☁️ - Social layer for Claude Code. Real-time presence, DMs between developers, "Watch Me Code" terminal streaming, gigs marketplace. 117 tools for collaborative AI coding.
