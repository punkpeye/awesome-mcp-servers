...
- [qualixar/superlocalmemory](https://github.com/qualixar/superlocalmemory) 📇 🐍 🏠 ☁️ 🍎 🪟 🐧 - Local-first AI agent memory with Fisher-Rao information geometry. 87.7% LoCoMo benchmark. Three modes: zero-cloud (EU AI Act compliant), local Ollama, cloud LLM. Bayesian trust scoring, GDPR rights, tamper-proof audit chain. LangChain + CrewAI partner packages. [arXiv paper](https://arxiv.org/abs/2603.14588) | [Glama](https://glama.ai/mcp/servers/qualixar-superlocalmemory)
