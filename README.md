...
- [RioBot-Grind/agentfund-mcp](https://github.com/RioBot-Grind/agentfund-mcp) 📇 ☁️ - Crowdfunding platform for AI agents on Base chain. Milestone-based escrow contracts enabling agents to raise funds, complete tasks, and get paid autonomously.
