...
- [fulcradynamics/fulcra-context-mcp](https://github.com/fulcradynamics/fulcra-context-mcp) 📇 ☁️ - Personal context data for AI agents — biometrics, sleep, activity, calendar, and location via the Fulcra Life API. OAuth2 consent-scoped access to Apple Health, wearable, and phone sensor data.
