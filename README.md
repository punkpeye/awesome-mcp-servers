...
- [bolnet/agent-memory](https://github.com/bolnet/agent-memory) 🐍 🏠 🍎 🪟 🐧 - Embedded memory for AI agents with multi-layer retrieval (SQLite FTS5, pgvector semantic search, Neo4j entity graphs) and automatic contradiction detection. One-command setup with Docker.
