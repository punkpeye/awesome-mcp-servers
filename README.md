...
- [bolivian-peru/os-moda](https://github.com/bolivian-peru/os-moda) 📇 🏠 🐧 - osModa is a NixOS distribution where the AI agent has root through 91 typed MCP tools. The bridge ([packages/osmoda-mcp-bridge](https://github.com/bolivian-peru/os-moda/tree/main/packages/osmoda-mcp-bridge)) wraps 9 Rust daemons (system, processes, services, NixOS config, hash-chained audit ledger, atomic SafeSwitch deploys, P2P encrypted mesh, crypto wallets, local STT/TTS) as typed MCP tools.
