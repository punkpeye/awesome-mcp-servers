...
- [run402-mcp](https://github.com/MajorTal/run402-mcp) 📇 ☁️ - AI-native Postgres + REST API + auth + storage + static sites + serverless functions, payable via x402 USDC on Base. No signups.
