...
- [waftester/waftester](https://github.com/waftester/waftester) 🏎️ ☁️ 🏠 🍎 🪟 🐧 - WAF security testing with 27 MCP tools, 2800+ attack payloads, WAF detection and bypass discovery, and enterprise assessment with quantitative metrics (F1/MCC/FPR). Supports stdio and HTTP transports. `npx -y @waftester/cli mcp`
