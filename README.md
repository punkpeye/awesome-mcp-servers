...
- **[Opus Growth](https://mcp.opus-growth.com)** - Manage Google Ads, Microsoft Advertising, TikTok Ads and LinkedIn Ads from Claude & ChatGPT. 233 tools with real write actions; every change is previewed as a dry run and applied only on approval. Agency/MCC-safe, hosted OAuth, nothing to self-host.
