...
- [mnemo](https://github.com/sattyamjjain/mnemo) 🦀 🏠 - MCP-native embedded memory database for AI agents with REMEMBER/RECALL/FORGET/SHARE primitives, hybrid vector search, AES-256-GCM encryption, and memory poisoning detection.
