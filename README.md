...
- [rodaddy/ProxmoxMCP-Plus](https://github.com/rodaddy/ProxmoxMCP-Plus) 🐍 🏠 🐧 - Enhanced Proxmox VE management with full OpenAPI integration for controlling VMs, containers, and cluster resources from AI assistants.
...
- [rodaddy/HomeMCPBridge](https://github.com/rodaddy/HomeMCPBridge) 🏠 🍎 - Native macOS HomeKit integration for AI assistants via MCP. Control lights, thermostats, and accessories using natural language.
...
- [rodaddy/vaultwarden-secrets](https://github.com/rodaddy/vaultwarden-secrets) 📇 🏠 🍎 🐧 - Secure secrets management with Vaultwarden/Bitwarden CLI, encrypted caching, and macOS Keychain integration.
