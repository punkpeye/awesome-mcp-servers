...
- [System-R-AI/systemr-python](https://github.com/System-R-AI/systemr-python) [glama](https://glama.ai/mcp/servers/System-R-AI/systemr-python) 🐍 ☁️ - Pre-trade risk validation and position sizing for AI trading agents. G-formula position sizing, Iron Fist risk rules, and System R Score evaluation. Remote SSE + Streamable HTTP transport with x402 USDC micropayments.
