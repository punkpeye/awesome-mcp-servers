...
- [statherm/agent-zone-mcp](https://github.com/statherm/agent-zone-mcp) 📇 ☁️ - Vendor-neutral infrastructure knowledge base with 10 tools for searching 200+ DevOps/Kubernetes articles, validating K8s manifests against security policies, and generating step-by-step playbooks with execution templates across 5 validation paths. Free, no API key required.
