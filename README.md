...
- [jasondk/errol-mail](https://github.com/jasondk/errol-mail) 🐍 🏠 🍎 - Comprehensive Apple Mail access with search, threads, attachments, flag management, server message downloads, and prompt injection defenses
