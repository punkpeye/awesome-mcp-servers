...
- [SparkForge](https://github.com/henry-ships/sparkforge) 📇 ☁️ - 33 pay-per-use utility APIs with x402 micropayments and free MCP server at sparkforge.sh/api/mcp — image generation, crypto analysis, web scraping, screenshots, code review, OCR, TTS, meme generation, and more. No API key needed — pay USDC per call.
