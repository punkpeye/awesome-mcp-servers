...
- [nothumansearch/search](https://nothumansearch.ai/mcp) 🏎️ ☁️ - Search engine and discovery index for 8,600+ agent-native services. Query MCP servers, OpenAPI providers, and llms.txt-publishing sites by keyword, category, or minimum agentic readiness score. 6 tools: search_agents, get_site_details, get_stats, submit_site, register_monitor, verify_mcp.
...
- [unitedideas/resolve-mcp](https://github.com/unitedideas/resolve-mcp) 🐍 ☁️ - Structured error recovery for AI agents. Returns resolution playbooks (category, backoff schedule, max retries, recovery steps) for 20+ services including OpenAI, Stripe, Postgres, and AWS. Free tier: 500 requests/month.
