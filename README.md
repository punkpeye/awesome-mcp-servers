...
- [gpartin/CryptoGuardClient](https://github.com/gpartin/CryptoGuardClient) [glama](https://glama.ai/mcp/connectors/run.modal.gpartin--cryptoguard-api-fastapi-app/crypto-guard) 🐍 ☁️ - Per-transaction deterministic crypto validator for AI trading agents. Validate trades (PROCEED/CAUTION/BLOCK), scan tokens, detect rug pulls — powered by WaveGuard physics engine. 5 free calls/day, x402 USDC payments. `pip install CryptoGuardClient`
