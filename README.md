...
- [sparkvibe-io/GuardianShield](https://github.com/sparkvibe-io/GuardianShield) 🐍 🏠 🍎 🪟 🐧 - Universal AI security layer with 16 MCP tools for code vulnerability scanning, PII detection, prompt injection defense, secret detection, dependency CVE auditing (PyPI/npm/Go/Packagist), and audit logging. Zero dependencies.
