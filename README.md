...
- [kiki830621/che-ical-mcp](https://github.com/kiki830621/che-ical-mcp) 🏠 🍎 - Native macOS Calendar & Reminders MCP server with 24 tools via EventKit. Supports recurring events, location-based reminder triggers, multi-keyword search, duplicate detection, conflict checking, and batch operations across iCloud/Google/Exchange calendars.
