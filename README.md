...
- [taskade/mcp](https://github.com/taskade/mcp) 📇 ☁️ 🍎 🪟 🐧 - Official Taskade MCP server with 62+ tools for managing workspaces, projects, tasks, AI agents, templates, media, and sharing. Works with Claude, Cursor, Windsurf, and all MCP-compatible clients.
