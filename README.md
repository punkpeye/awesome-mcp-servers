...
- [telvokdev/librarian](https://github.com/telvokdev/librarian) 📇 🏠 ☁️ - Persistent memory with semantic search, hit-based ranking, universal import from other AI tools, and a marketplace for sharing developer knowledge
