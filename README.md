...
- [isnow890/data4library-mcp](https://github.com/isnow890/data4library-mcp) 📇☁️ - A Model Context Protocol server for Korea's Library Information Naru API, providing comprehensive access to public library data, book searches, loan status, reading statistics, and GPS-based nearby library discovery across South Korea.
