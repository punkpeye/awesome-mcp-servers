...
- [ohsim713-cmd/mcp-simple-memory](https://github.com/ohsim713-cmd/mcp-simple-memory) 📇 🏠 🍎 🪟 🐧 - Persistent session memory for Claude Code with zero external databases. SQLite via WASM (sql.js), keyword + optional Gemini semantic search, tags, projects, and markdown import. One command setup.
