...
- [salveszz/financehub-mcp](https://github.com/salveszz/financehub-mcp) 🐍 ☁️ - Unified financial data MCP server covering crypto, stocks, and forex with 14 tools. Automatic fallback sources (CoinGecko → CoinCap, yfinance → Alpha Vantage → Twelve Data, Frankfurter → ExchangeRate-API). Free tier available via RapidAPI.
