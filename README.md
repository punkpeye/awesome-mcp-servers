...
- [echo-lumen/mcp-security-scan](https://github.com/echo-lumen/mcp-security-scan) 🐍 🏠 🍎 🪟 🐧 - Open-source scanner that connects to running MCP servers and audits them against the OWASP MCP Top 10. Static and dynamic analysis for token exposure, tool poisoning, command injection, privilege escalation, and supply chain risks. Runs locally with no API keys.
