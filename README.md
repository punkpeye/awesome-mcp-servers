...
- [Lcontext/Lcontext](https://github.com/Lcontext/Lcontext) 📇 ☁️ 🍎 🪟 🐧 - Behavioral analytics MCP server that gives AI coding agents real-time user behavior context — page metrics, session sentiment, visitor profiles, and AI-generated insights. Works with Claude Code, Cursor, Windsurf, and any MCP-compatible tool.
