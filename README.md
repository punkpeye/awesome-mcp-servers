...
- [PayRam/payram-helper-mcp-server)](https://github.com/PayRam/payram-helper-mcp-server)) 📇 ☁️ 🏠 -  An MCP server that provides support in setting up PayRam, a self-hosted PayFi platform for stablecoin and cryptocurrency payments. 
