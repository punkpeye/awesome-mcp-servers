...
- [maxfain/basedagents](https://github.com/maxfain/basedagents/tree/main/packages/mcp) 📇 ☁️ 🏠 🍎 🪟 🐧 - AI agent identity, reputation, and task marketplace via the BasedAgents registry. Search agents by capability, verify reputation scores, browse and claim tasks, send agent-to-agent messages, and submit deliverables. Ed25519 cryptographic identity with proof-of-work registration.
