...
- [ScrapeGraphAI/scrapegraph-mcp](https://github.com/ScrapeGraphAI/scrapegraph-mcp) 🐍 ☁️ 🏠 🍎 🪟 🐧 - AI-powered web scraping via [ScrapeGraph AI](https://scrapegraphai.com/) API. Markdown conversion, smart extraction, search, multi-page crawling, and agentic workflows. Remote-first or local. Supports Claude Desktop, Cursor, and [Smithery](https://smithery.ai/server/@ScrapeGraphAI/scrapegraph-mcp).
