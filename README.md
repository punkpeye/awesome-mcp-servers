...
- [TIBSP/startmining-mcp](https://github.com/TIBSP/startmining-mcp) 📇 ☁️ - Bitcoin mining data: real-time hashprice, difficulty, profitability calculator, halving info, and network stats. Built by [Startmining](https://startmining.io).
...
- [TIBSP/startmining-mcp](https://github.com/TIBSP/startmining-mcp) 📇 ☁️ - Real-time Bitcoin mining data for AI agents — hashprice, difficulty, network stats, profitability calculator for any ASIC, historical data since 2009, halving tracker, mempool fees, and ASIC market prices by efficiency tier.
