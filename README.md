...
- [fraction12/agentrem](https://github.com/fraction12/agentrem) 📇 🏠 🍎 🪟 🐧 - Structured reminders for AI agents with time, keyword, condition, session, and heartbeat triggers. Priority-aware with escalation, recurrence, dependencies, token budgets, full-text search, and multi-agent namespaces. CLI + MCP server. `npm install -g agentrem`
