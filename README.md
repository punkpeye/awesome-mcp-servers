...
- [Mastra AI](https://github.com/mastra-ai/mastra) 📇 ☁️ 🏠 🍎 🪟 🐧 - Mastra is a framework for building MCP servers, AI-powered applications, and agents with a modern TypeScript stack.
