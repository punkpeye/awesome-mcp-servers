...
- [crossfin/crossfin-mcp](https://github.com/bubilife1202/crossfin) 📇 ☁️ - AI agent access to Asian crypto markets. Real-time Korean exchange data (Bithumb, Upbit, Coinone, GoPax), cross-exchange routing across 9 exchanges with 11 bridge coins, kimchi premium monitoring, and x402 USDC-paid APIs. Install: `npx -y crossfin-mcp`.
