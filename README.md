...
- [JProx](https://jprox.dev) 📇 ☁️ - Japan proxy MCP server for accessing geo-restricted Japanese sites (Mercari, SUUMO, Rakuten, Amazon JP) through residential IPs. `npx @jprox/mcp`
