...
- [Pharaoh-so/pharaoh-mcp](https://github.com/Pharaoh-so/pharaoh-mcp) 📇 ☁️ 🍎 🪟 🐧 - Codebase intelligence MCP server that maps repositories into Neo4j knowledge graphs, giving AI agents architectural context through 13 tools including blast radius analysis, dependency tracing, dead code detection, and reachability checking.
