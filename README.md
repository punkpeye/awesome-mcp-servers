...
- [Bluecraft-AI/machfive-mcp](https://github.com/Bluecraft-AI/machfive-mcp) [glama](https://glama.ai/mcp/servers/Bluecraft-AI/machfive-mcp) ☁️ - Generate hyper-personalized cold email sequences per lead via AI. List campaigns, generate emails for individual leads or batches, and export results as CSV or JSON.
