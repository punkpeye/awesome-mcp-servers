...
- [joelklabo/maximumsats-mcp](https://github.com/joelklabo/maximumsats-mcp) 📇 ☁️ - Bitcoin & Lightning knowledge tools with L402 pay-per-query AI API. Ask Bitcoin questions, generate images, check Web of Trust scores, and get Lightning network analysis — all payable in sats via Lightning.
