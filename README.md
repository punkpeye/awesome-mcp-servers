...
- [SongT-50/korean-agriculture-mcp](https://github.com/SongT-50/korean-agriculture-mcp) 🐍 ☁️ - Korean agricultural wholesale market real-time auction data from 32+ public markets nationwide. 63K+ daily records covering fruits, vegetables, grains, livestock, and seafood with price comparison and trend analysis via data.go.kr API.
