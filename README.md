...
- [codebase-context](https://github.com/PatrickSys/codebase-context) 📇 🏠 🍎 🪟 🐧 - Local MCP server that surfaces pattern adoption %, 2-hop import impact, and edit-readiness preflight checks from your actual codebase. 30+ languages, fully local, file-watcher auto-refresh.
