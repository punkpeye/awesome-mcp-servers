...
- [phos-nz/analytics-engine](https://analytics.phos.nz/.well-known/agent.json) 🐍 ☁️ - Sales analytics and ML forecasting — data analysis pipelines, ensemble forecasts, RFM customer segmentation, and trend analysis.
- [phos-nz/marketing-engine](https://api.phos.nz/.well-known/agent.json) 🐍 ☁️ - Autonomous AI marketing with 7 specialized agents — content creation, competitor analysis, social media publishing, and campaign management.
- [phos-nz/sales-engine](https://sales.phos.nz/.well-known/agent.json) 📇 ☁️ - Autonomous B2B lead pipeline — prospect discovery, ICP scoring, AI-generated outreach, and pipeline management.
...
- [phos-nz/piranha](https://api.piranha.nz/.well-known/agent.json) 🐍 ☁️ - BJJ video analysis powered by GPU YOLO pose detection and Claude AI — technique recognition, scoring, and coaching feedback.
