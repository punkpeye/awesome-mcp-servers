...
- [Ruya-AI/cozempic](https://github.com/Ruya-AI/cozempic) 🐍 🏠 - ✨ v1.2.x — Self-updating, atomic writes, strict session guard, zero false positives on team detection. Context weight-loss for Claude Code — diagnose, treat, and guard sessions, protect Agent Teams from compaction loss.
