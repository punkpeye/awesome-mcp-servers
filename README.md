...
- [arikusi/deepseek-mcp-server](https://github.com/arikusi/deepseek-mcp-server) [glama](https://glama.ai/mcp/servers/arikusi/deepseek-mcp-server) 📇 ☁️ 🍎 🪟 🐧 - MCP server for DeepSeek AI models (Chat + Reasoner). Multi-turn sessions, model fallback with circuit breaker, function calling, thinking mode, JSON output, and cost tracking.
