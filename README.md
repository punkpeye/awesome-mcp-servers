...
- [christian140903-sudo/soul-mcp](https://github.com/christian140903-sudo/soul-mcp) 📇 🏠 🍎 🪟 🐧 - Persistent AI memory with SQLite FTS5 full-text search, auto-categorization, semantic ranking with temporal decay, and identity system. 11 MCP tools including remember, recall, reflect, and about_me. Fully local, zero cloud dependencies. One-command install: `npx soul-mcp init`.
