...
- [ryudi84/sovereign-mcp-servers](https://github.com/ryudi84/sovereign-mcp-servers/tree/main/cron-forge) 📇 🏠 🍎 🪟 🐧 - Parse and explain cron expressions, validate syntax, and calculate next run times.
- [ryudi84/sovereign-mcp-servers](https://github.com/ryudi84/sovereign-mcp-servers/tree/main/hash-forge) 📇 🏠 🍎 🪟 🐧 - Hash text with MD5, SHA-256, and SHA-512, generate HMAC signatures, and compare hashes.
- [ryudi84/sovereign-mcp-servers](https://github.com/ryudi84/sovereign-mcp-servers/tree/main/json-forge) 📇 🏠 🍎 🪟 🐧 - JSON Swiss Army knife: format, validate, diff, convert (YAML/CSV/XML), minify, and JSONPath query.
- [ryudi84/sovereign-mcp-servers](https://github.com/ryudi84/sovereign-mcp-servers/tree/main/password-forge) 📇 🏠 🍎 🪟 🐧 - Generate secure passwords and passphrases, check password strength, and estimate crack time.
- [ryudi84/sovereign-mcp-servers](https://github.com/ryudi84/sovereign-mcp-servers/tree/main/regex-lab) 📇 🏠 🍎 🪟 🐧 - Test, debug, and validate regular expressions with match highlighting and pattern replacement.
