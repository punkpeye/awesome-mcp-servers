...
- [agtnames/agt](https://github.com/agtnames/agt/tree/main/packages/mcp) 📇 🏠 🍎 🪟 🐧 - Resolve, verify and discover .agt agent names: owner, on-chain records, signed manifest, MCP and A2A endpoints. Read-only over Polygon; nothing to configure.
