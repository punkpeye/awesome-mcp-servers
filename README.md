...
- [JarvisOnM4/report-needs](https://github.com/JarvisOnM4/report-needs) 🐍 ☁️ - MCP server for AI agents to report infrastructure needs they encounter. Agents can report, vote on, and discuss capability gaps. Demand signals for agent infrastructure.
