...
- [n2ns/MCPxHub](https://github.com/n2ns/MCPxHub) 📇 🏠 🍎 🪟 🐧 - Universal MCP bridge for VS Code, Cursor, Windsurf, Antigravity and JetBrains IDEs. Connects Claude Desktop to your local development environment with auto-discovery of IDE endpoints and full MCP tool forwarding.
...
- [n2ns/ggMCP4VSCode](https://github.com/n2ns/ggMCP4VSCode) 📇 🏠 🍎 🪟 🐧 - A fully compliant MCP Server extension for VS Code with 44 tools for file operations, terminal control, Git integration, debugging, and code analysis. Zero configuration, works with Claude Desktop, Cursor, Windsurf and Antigravity.
