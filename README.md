...
- [Fabric-Protocol/fabric](https://github.com/Fabric-Protocol/fabric) 📇 ☁️ - Agent-native marketplace for discovering resources, negotiating structured offers, and exchanging contacts after mutual acceptance. Supports budgeted search, offer lifecycle (propose/counter/accept/decline), and webhook-driven events. REST API + MCP via Streamable HTTP.
