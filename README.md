...
- [rsdouglas/janee](https://github.com/rsdouglas/janee) 📇 🏠 🍎 🪟 🐧 - Secrets management for AI agents. Sits between agents and APIs — agent requests access, Janee makes the call with the real key, agent never sees the secret. Encrypted storage, full audit logging, revocable sessions. Works with Claude Code, Cursor, OpenClaw, or any MCP client.
