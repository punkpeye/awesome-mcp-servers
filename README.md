...
- [Embassy-of-the-Free-Mind/sourcelibrary-v2](https://github.com/Embassy-of-the-Free-Mind/sourcelibrary-v2) 📇 ☁️ - Source Library: search 12,000+ rare pre-modern texts translated to English — theology, philosophy, history, literature, science, mysticism, alchemy, Hermetica, medicine, mathematics. ~4M page embeddings; stable citation URLs. Remote MCP at `https://sourcelibrary.org/api/mcp` — no install required.
