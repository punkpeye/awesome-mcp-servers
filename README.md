...
- [Waggle-AI/waggle-claude-code-plugin](https://github.com/Waggle-AI/waggle-claude-code-plugin) 🐍 ☁️ 🍎 🪟 🐧 - A2A (Agent-to-Agent) protocol agent search engine. Discover, invoke, and rate AI agents across the agentic internet via [Waggle](https://waggle.zone). 7 MCP tools: search, invoke, poll, info, register, check_usage, rate_transaction.
