...
- [louis49/melchizedek](https://github.com/louis49/melchizedek) 📇 🏠 🍎 🪟 🐧 - Persistent memory for Claude Code. Indexes conversations and provides hybrid search (BM25 + vectors + reranker). Zero config, single SQLite file.
