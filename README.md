...
- [Bluecraft-AI/machfive-mcp](https://github.com/Bluecraft-AI/machfive-mcp) ☁️ - Generate hyper-personalized cold email sequences via AI. List campaigns, generate emails for individual leads or batches, and export results as CSV or JSON.
