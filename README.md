...
- [elliotllliu/agent-shield](https://github.com/elliotllliu/agent-shield) [glama](https://glama.ai/mcp/servers/elliotllliu/agent-shield) 📇 🏠 🍎 🪟 🐧 - Static security scanner for AI agent skills, MCP servers, and plugins. Detects data exfiltration, backdoors, prompt injection (8 languages), tool shadowing, and supply chain risks with 31 rules across 3 severity levels. Supports Python, TypeScript, Go, Rust, and .difypkg archives. Runtime MCP proxy interception and optional LLM-powered deep analysis.
