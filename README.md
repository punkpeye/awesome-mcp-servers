...
- [oxgeneral/agentmem](https://github.com/oxgeneral/agentmem) 🐍 🏠 🍎 🪟 🐧 - Lightweight persistent memory for AI agents with hybrid search (FTS5 keywords + vector semantics), 16 MCP tools, namespaces, temporal versioning, and entity extraction. Single SQLite file, 12MB total.
