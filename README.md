...
- [teehooai/teeshield](https://github.com/teehooai/teeshield) 🐍 🏠 🍎 🪟 🐧 - Static security linter for MCP tools that scans tool definitions, scores security risks, and suggests safer descriptions. Detects ambiguous permissions, missing side-effects, and patterns that lead to agent misuse.
