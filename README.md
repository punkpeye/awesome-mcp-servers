...
- [michu5696/paycrow](https://github.com/michu5696/paycrow) 📇 ☁️ - Escrow protection with dispute resolution for AI agent payments on Base. Trust-informed smart escrow (safe_pay), trust scoring from 4 on-chain sources, and the only escrow on Base with real on-chain dispute resolution. 9 MCP tools. USDC payments via x402.
