...
- [refgrow/refgrow-mcp](https://github.com/refgrow/refgrow-mcp) 📇 ☁️ - MCP server for managing affiliate and referral programs. Track referrals, manage affiliates, process conversions, and handle payouts through the Refgrow platform.
