...
- [planu-dev/planu](https://github.com/planu-dev/planu) 📇 🏠 🍎 🪟 🐧 - Spec Driven Development MCP server that gives AI coding agents structured memory of what to build, how to build it, and how to verify it's done. 105 tools for spec lifecycle, estimation, validation, drift detection, and multi-agent orchestration. Any language, no API key required.
