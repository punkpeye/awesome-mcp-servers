...
- <img src="https://flowlink.flow-masters.ru/logo.svg" height="14"/> [FlowLink](https://github.com/braincreator/flowlink) — Governance and risk control gateway for autonomous AI agents. 7-level shield (kill switch, read-only, blacklist, policies, sandbox, approval, backup) with <1ms overhead. Works with Claude Code, Cursor, Copilot, Windsurf. Rust, self-hosted, optional eBPF. [Website](https://flowlink.flow-masters.ru)
