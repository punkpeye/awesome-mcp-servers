...
- [amitpaz1/formbridge](https://github.com/amitpaz1/formbridge) 📇 🏠 - Mixed-mode agent-human form submission infrastructure. AI agents fill what they know via API, humans complete the rest through a pre-filled form URL. Features field-level attribution, rotating resume tokens, approval workflows, webhook delivery, and auto-generated MCP tools from form definitions.
