...
- [cimo-labs/kvault](https://github.com/cimo-labs/kvault) 🐍 🏠 🍎 🪟 🐧 - Personal knowledge base that runs inside Claude Code. 20 MCP tools for entity management, fuzzy deduplication, hierarchical summary propagation, and structured agent memory. Zero extra cost with existing subscriptions.
