...
- [Bajuzjefe/aikido-mcp](https://github.com/Bajuzjefe/Aikido-Security-Analysis-Platform/tree/main/mcp-server) 📇 🏠 🍎 🪟 🐧 - Static security analysis for Aiken smart contracts (Cardano). 75 vulnerability detectors with CWC classification, evidence-based findings, and remediation guidance.
