...
- [meltingpixelsai/harvey-tools](https://github.com/meltingpixelsai/harvey-tools) 📇 ☁️ - Web scraping, screenshots, structured data extraction, code review, content generation, and sentiment analysis for AI agents. x402 USDC micropayments on Solana.
