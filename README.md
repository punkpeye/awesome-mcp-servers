...
- [chihebnabil/page-design-guide-mcp](https://github.com/chihebnabil/page-design-guide-mcp) 🎖️ 📇 ☁️ - An MCP (Model Context Protocol) server that provides design guidance to help LLMs generate better, more modern web pages.
