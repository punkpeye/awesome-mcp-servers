...
- [alaarab/cortex](https://github.com/alaarab/cortex) 📇 🏠 🍎 🪟 🐧 - Persistent memory for Claude Code and GitHub Copilot. Indexes project knowledge, session learnings, and task queues into a searchable MCP server. One command setup: `npx @alaarab/cortex init`.
