...
- [kraklabs/cie](https://github.com/kraklabs/cie) 🏎️ 🏠 🍎 🐧 - Local code intelligence engine providing semantic search, call graph analysis, and 25+ MCP tools for deep codebase understanding. Built with Tree-sitter and CozoDB.
...
- [kraklabs/mie](https://github.com/kraklabs/mie) 🏎️ 🏠 🍎 🐧 - Persistent knowledge graph giving AI agents shared, cross-session memory through MCP. Stores facts, decisions, entities, and relationships with semantic search and conflict detection.
