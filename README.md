...
- [jimmyracheta/ai-runtime-guard](https://github.com/jimmyracheta/ai-runtime-guard) 🐍 🏠 🍎 🐧 - Policy enforcement layer for MCP agents. Blocks dangerous commands, gates risky operations behind human approval, simulates blast radius for wildcard actions, and maintains a full audit trail — without modifying your agent or workflow.
