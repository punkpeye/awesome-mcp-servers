...
- [heeyo-life/skillboss-skills](https://github.com/heeyo-life/skillboss-skills) 📇 ☁️ 🍎 🪟 🐧 - Unified gateway to 100+ AI services (LLMs, image/video generation, TTS) via single API key. OpenAI-compatible.
