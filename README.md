...
- [seriserendipia/resume-onepage-autofit-mcp](https://github.com/seriserendipia/resume-onepage-autofit-mcp) 🐍 🏠 🛠️ - From markdown resume to formatted PDF, a MCP server that generates single-page PDF resumes with smart overflow detection and layered content reduction strategies
