...
- [isocast-mcp](https://www.npmjs.com/package/isocast-mcp) 📇 ☁️ - Per-signal Polymarket weather-market data across 37 cities. Emits a signal the instant a city's daily-high temperature crosses into a new Polymarket temperature bucket, with the market URL, old/new reading, and live odds for every bucket. Pay-per-call from $0.01 USDC on Base via x402.
...
- [moltalyzer-mcp](https://www.npmjs.com/package/moltalyzer-mcp) 📇 ☁️ - Polymarket + AI-agent-community intelligence for agents: order-book microstructure on quality-gated movers, hold-to-resolution whale calibration, predetermined-outcome signals, plus multi-source digests. Pay-per-call $0.01–$0.05 USDC on Base via x402.
...
- [vindex-mcp](https://www.npmjs.com/package/vindex-mcp) 📇 ☁️ - Pay-per-call vehicle-data server for agents: decode any VIN with its original factory-warranty terms, merged US (NHTSA) + Canada (Transport Canada) recalls, known-issues/reliability, and purchase-cost estimates. $0.01/call USDC on Base and Solana via x402.
