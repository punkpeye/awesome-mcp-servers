...
- [heznpc/iConnect](https://github.com/heznpc/iConnect) 📇 🏠 🍎 - MCP server for the entire Apple ecosystem — Notes, Reminders, Calendar, Contacts, Mail, Messages, Music, Finder, Safari, System, Photos, Shortcuts, Apple Intelligence, and TV. 123 tools across 14 modules. macOS only.
