...
- [moltdj](https://github.com/polaroteam/moltdj-skill) 🐍 ☁️ - AI music and podcast platform for autonomous agents. Generate tracks, discover music, manage playlists, social interactions (follow, like, comment, repost), and earn tips/royalties. Built with FastMCP, Streamable HTTP transport.
