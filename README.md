...
- [alpadalar/ProxmoxMCP-Extended](https://github.com/alpadalar/ProxmoxMCP-Extended) 🐍 🏠 - Enhanced Proxmox virtualization MCP server with advanced hypervisor management and full OpenAPI integration. Features complete VM lifecycle management, LXC container support, secure token authentication, and comprehensive cloud infrastructure control for enterprise virtualization environments.
