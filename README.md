...
- [cristiano-c1/truth-anchor-agent](https://github.com/cristiano-c1/truth-anchor-agent) ([glama](https://glama.ai/mcp/servers/cristiano-c1/truth-anchor-agent)) 🐍 ☁️ - Citation attestation for agents: verifies that a source resolves, records redirect target, content hash, and optional claim presence. Paid via 0.005 USDC on Base (x402).
