...
- [Damien829/aipaygen](https://github.com/Damien829/aipaygen) 🐍 ☁️ - 106 AI-powered MCP tools with pay-per-use via x402 USDC micropayments or API key. Research, write, code, translate, scrape, agent memory, 4100+ API catalog, agent builder, 15 models across 7 providers. 10 free calls/day. PyPI: `aipaygen-mcp`.
