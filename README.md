...
- [unitedideas/resolve-mcp](https://github.com/unitedideas/resolve-mcp) 🐍 ☁️ - Structured error recovery for AI agents. Returns resolution playbooks (backoff schedules, retry strategies, recovery steps) for 20+ services including OpenAI, Anthropic, Stripe, AWS, and Postgres. Free tier: 500 requests/month.
