...
- [OilpriceAPI/mcp-server](https://github.com/OilpriceAPI/mcp-server) [glama](https://glama.ai/mcp/servers/@OilpriceAPI/mcp-server) 📇 ☁️ - Real-time oil, gas, and commodity prices from OilPriceAPI. 40+ energy commodities with natural language queries, subscribable price resources, and analyst prompt templates.
...
- [czottmann/kagi-ken-mcp](https://github.com/czottmann/kagi-ken-mcp) 📇 ☁️ - Work with Kagi _without_ API access (you'll need to be a customer, tho). Searches and summarizes. Uses Kagi session token for easy authentication.
