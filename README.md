...
- [previly/mcp](https://app.previly.com/mcp) 🐍 ☁️ - Personal finance AI assistant with 33 tools: transactions, budgets, patrimoine, recurring payments, cash forecasting, double-entry accounting (French PCG), and tax declarations (IR/IS/TVA) with auto-prefill from accounting data. OAuth 2.1 auth.
