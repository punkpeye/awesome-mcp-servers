...
- [SocketDev/socket-mcp](https://github.com/SocketDev/socket-mcp) 🎖️ ☁️ 🐍 📇 🏎️ 🦀 ☕ 💎 A Model Context Protocol (MCP) server for [Socket](https://socket.dev/) integration, allowing AI assistants to efficiently check dependency vulnerability scores and security information.
