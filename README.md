...
- [sarmadparvez/postgresql-mcp](https://github.com/sarmadparvez/postgresql-mcp) [glama](https://glama.ai/mcp/servers/sarmadparvez/postgresql-mcp) 📇 🏠 - PostgreSQL MCP server with full read-write support, atomic transactions, and schema inspection. Works with local, Supabase, AWS RDS, or any self-hosted PostgreSQL instance.
