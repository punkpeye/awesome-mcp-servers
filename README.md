...
- [kcgdz/mcp-print](https://github.com/kcgdz/mcp-print) 🐍 🏠 🍎 🪟 🐧 - Professional print & color workflow MCP server with 12 tools: 2400+ Pantone colors with fuzzy matching, CMYK/RGB conversion, preflight checks, substrate simulation, ink/cost estimation, ICC profiles, spot color separation, barcode coverage, Delta E, and paper weights. 100% offline, zero external dependencies.
