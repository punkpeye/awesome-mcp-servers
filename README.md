...
- [autonsol/sol-mcp](https://github.com/autonsol/sol-mcp) 📇 ☁️ - Solana token risk scoring and pump.fun graduation signals for AI agents. Risk 0-100 with rug detection, whale concentration analysis, live BUY/SKIP decisions feed, and trading performance stats. Remote server — no install needed.
