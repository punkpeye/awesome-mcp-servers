...
- [dkships/substack-publisher-mcp](https://github.com/dkships/substack-publisher-mcp) 📇 ☁️ - MCP server for Substack's official Publisher API. Query posts, analytics, subscriber counts, and publication data from any MCP client.
