...
- [unlikefraction/silicon-friendly](https://github.com/unlikefraction/silicon-friendly) 🐍 ☁️ - Check if any website is AI-agent-friendly. Rates websites on 30 criteria across 5 levels (L1-L5) with tools for search, analysis, submission, and verification. Streamable HTTP endpoint at siliconfriendly.com/mcp.
