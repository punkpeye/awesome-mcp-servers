...
- [floyd-run/mcp-server](https://github.com/floyd-run/mcp-server) 📇 ☁️ - Scheduling and booking engine for AI agents. Check availability, hold slots, and confirm appointments with two-phase booking and conflict-free resource management.
