...
- [sophotechlabs/kube-lint-mcp](https://github.com/sophotechlabs/kube-lint-mcp) 🐍 ☁️ - Validates Kubernetes manifests, Helm charts, and FluxCD resources with kubectl dry-run before committing — preventing deployment and GitOps reconciliation failures.
