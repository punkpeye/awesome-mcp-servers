...
- [bluzername/claude-code-power-stack](https://github.com/bluzername/claude-code-power-stack) 🏠 🍎 🐧 - Curated toolkit bundling Ghost (persistent memory), cc-conversation-search (cross-project session search), session naming, and Manus-style file-based planning into one-command install with cheat sheet PDF.
