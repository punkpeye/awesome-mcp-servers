...
- [imran-siddique/agent-os](https://github.com/imran-siddique/agent-os) 🐍 🏠 🍎 🪟 🐧 - Governance kernel for AI agents providing cryptographic identity (Ed25519), trust scoring, policy enforcement, and Merkle audit trails. Native MCP integration with sub-100μs overhead. Supports EU AI Act, SOC2, HIPAA compliance automation.
