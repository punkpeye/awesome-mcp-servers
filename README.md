...
- [reviewmyemails/prediction-market-mcp](https://github.com/reviewmyemails/prediction-market-mcp) 📇 ☁️ - Unified Polymarket + Kalshi data with cross-platform arbitrage detection, strategy signals, and real-time market prices.
