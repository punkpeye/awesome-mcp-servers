...
- [IdeaLift](https://idealift.startvest.ai/mcp) 📇 ☁️ 🍎 🪟 🐧 - Pre-backlog idea management with decision tracking, signal aggregation, and RICE scoring. Captures product feedback from Slack, Teams, Discord, and GitHub. Tracks the "why" behind decisions with full audit trails.
