...
- [tp-lab/wallet-mcp](https://github.com/TP-Lab/mcp-marketplace/tree/master/apps/wallet-mcp) 🎖️ 📇 ☁️ - An MCP server that provides a seamless integration between AI Clients and user's crypto wallets.
