...
- [PurpleSquirrelMedia/ibmcloud-mcp-server](https://github.com/PurpleSquirrelMedia/ibmcloud-mcp-server) 📇 ☁️ - Comprehensive IBM Cloud integration with 80+ tools for managing VPCs, virtual servers, Kubernetes clusters, databases, storage, and IAM across all IBM Cloud regions.
...
- [PurpleSquirrelMedia/oracle-mcp-server](https://github.com/PurpleSquirrelMedia/oracle-mcp-server) 📇 ☁️ - Oracle Cloud Infrastructure integration with 21 tools for managing compute instances, VCNs, subnets, block storage, and object storage.
...
- [PurpleSquirrelMedia/volcengine-mcp](https://github.com/PurpleSquirrelMedia/volcengine-mcp) 📇 ☁️ - Volcengine/ByteDance Cloud integration with Doubao LLM API support for AI-powered applications.
...
- [PurpleSquirrelMedia/watsonx-mcp-server](https://github.com/PurpleSquirrelMedia/watsonx-mcp-server) 📇 ☁️ - IBM watsonx.ai integration with 4 tools for text generation, embedding, and AI model interaction.
...
- [PurpleSquirrelMedia/ibmz-mcp-server](https://github.com/PurpleSquirrelMedia/ibmz-mcp-server) 📇 🏠 - IBM Z mainframe integration with 13 tools for z/OS dataset management, job submission, console commands, and mainframe operations.
...
- [PurpleSquirrelMedia/mega-mcp-server](https://github.com/PurpleSquirrelMedia/mega-mcp-server) 📇 ☁️ - MEGA cloud storage integration with 18 tools for file upload, download, folder management, and encrypted cloud storage operations.
...
- [PurpleSquirrelMedia/davinci-resolve-mcp](https://github.com/PurpleSquirrelMedia/davinci-resolve-mcp) 📇 🏠 🍎 🪟 🐧 - Professional video editing automation for DaVinci Resolve with 29 tools for timeline management, media pool operations, color grading, and render workflows.
...
- [PurpleSquirrelMedia/guardrails-mcp-server](https://github.com/PurpleSquirrelMedia/guardrails-mcp-server) 📇 🏠 - Content safety guardrails for AI applications with input/output filtering, prompt injection detection, and customizable safety policies.
