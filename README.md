...
- [oxgeneral/agentmem](https://github.com/oxgeneral/agentmem) 🐍 🏠 🍎 🪟 🐧 - Lightweight persistent memory for AI agents with hybrid search (FTS5 keywords + vector semantics), 16 MCP tools, one SQLite file. Namespaces, temporal versioning, entity extraction, 5 memory tiers. 12MB total install.
