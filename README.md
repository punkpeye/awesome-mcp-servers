...
- [luckyPipewrench/pipelock](https://github.com/luckyPipewrench/pipelock) [glama](https://glama.ai/mcp/servers/@luckyPipewrench/pipelock) 🏎️ 🏠 🍎 🪟 🐧 - Open-source firewall for AI agents. Wraps any stdio or HTTP MCP server as a scanning proxy with fail-closed DLP, prompt injection detection, and tool description poisoning prevention. Includes an HTTP fetch proxy with a 9-layer scanner pipeline.
