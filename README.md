...
- [EncrEor/rlm-claude](https://github.com/EncrEor/rlm-claude) 🐍 🏠 🍎 🪟 🐧 - Infinite memory for Claude Code. 14 MCP tools for persistent session memory with chunking, BM25 search, fuzzy grep, insights, and 3-tier retention. Inspired by MIT CSAIL's Recursive Language Models paper.
