...
- [httpay-mcp](https://github.com/Alfredz0x/httpay-mcp) 📇 ☁️ - MCP server exposing 121+ crypto API endpoints from [httpay.xyz](https://httpay.xyz) as tools — token prices, gas oracle, ENS lookup, DeFi yields, wallet risk scores, L2 gas costs, and more. All endpoints are pay-per-call via the x402 protocol ($0.001–$0.05/request).
