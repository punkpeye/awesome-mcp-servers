...
- [InfiniQuest-App/wisdom-store](https://github.com/InfiniQuest-App/wisdom-store) 📇 🏠 🍎 🪟 🐧 - Persistent memory, live context control, and anti-hallucination for AI coding assistants. AST-based project indexing, symbol registry with fuzzy matching, post-write hallucination detection hooks, and flat-file knowledge storage. Includes pre-compact hook to save context before compaction.
