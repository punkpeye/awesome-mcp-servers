...
- [joelklabo/maximumsats-mcp](https://github.com/joelklabo/maximumsats-mcp) 📇 ☁️ - Lightning-powered MCP server for WoT (Web of Trust) scoring, DVM task execution, and L402 micropayments. Provides trust scoring for 52K+ Nostr pubkeys, AI task execution, and pay-per-call API access via Lightning Network.
