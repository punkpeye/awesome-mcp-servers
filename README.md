...
- [0isone/0protocol](https://github.com/0isone/0protocol) 📇 ☁️ - Identity substrate for autonomous agents. Sign plugins, rotate credentials without losing identity, and publicly attest to behavior. Three tools: express, own, transfer.
