...
- [TerminalGravity/preflight](https://github.com/TerminalGravity/preflight) 📇 🏠 🍎 🪟 🐧 - 24-tool MCP server for Claude Code that catches vague prompts before they waste tokens. Features 12-category scorecards, semantic session history search with LanceDB vectors, cross-service contract awareness, correction pattern learning, and cost estimation.
