...
- [maderwin/pinchtab-mcp](https://github.com/maderwin/pinchtab-mcp) 📇 🏠 🍎 🪟 🐧 - Control Chrome via accessibility tree snapshots through PinchTab. Zero-config browser automation with 19 tools.
