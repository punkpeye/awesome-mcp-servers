...
- [indiestack/mcp-server](https://indiestack.fly.dev) 🐍 ☁️ - Search 100+ curated indie-built SaaS tools by intent. Find alternatives to mainstream software (analytics, email, payments) directly from your coding assistant before building from scratch.
