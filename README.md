...
- [preflight-dev/preflight](https://github.com/preflight-dev/preflight) 📇 🏠 - 24-tool MCP server for Claude Code that catches vague prompts before they waste tokens. Includes 12-category prompt scorecards, cross-service contract awareness, session history search with LanceDB vectors, correction pattern learning, and cost estimation.
