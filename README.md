...
* [Oracle Connectorome](https://github.com/qualigenai/oracle-connectorome-mcp-servers) 📇 🏠 - Enterprise-grade Oracle Database connector for MCP with self-healing retries and AI-guided SQL.
