...
- [fnebenfuehr/worktree-cli](https://github.com/fnebenfuehr/worktree-cli) 📇 🏠 - Git worktree management for AI coding assistants. Enables parallel development across multiple branches with hooks, file copying, and native MCP integration.
