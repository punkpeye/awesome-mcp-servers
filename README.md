...
- [victor-1keeper/wechat-trade](https://github.com/victor-1keeper/wechat-trade) 🐍 🏠 🪟 - WeChat copy-trading MCP server with 14 AI tools — message monitoring, auto trade execution (BSC & Solana), sender accuracy ranking, backtesting, and consensus trading. Powered by 1Keeper API.
