...
- [IgorGanapolsky/mcp-memory-gateway](https://github.com/IgorGanapolsky/mcp-memory-gateway) 📇 🏠 ☁️ - Local-first RLHF feedback loop for AI agents — capture thumbs-up/down signals, promote memories, generate prevention rules, and export DPO/KTO training pairs. Available on npm as `rlhf-feedback-loop`.
