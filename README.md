...
- [ai-debugger-inc/aidb](https://github.com/ai-debugger-inc/aidb) 🐍 🏠 🍎 🪟 🐧 - Exposes the full debugging suite to AI agents (breakpoints, variable/state inspection, and stepping) in multiple languages. Local and remote debugging capabilities; first class VS Code `launch.json` support.
