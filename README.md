...
- [devpick/mcp-server](https://github.com/kimbobmarley03/devpick.sh/tree/main/mcp-server) 📇 🏠 🍎 🪟 🐧 - 43 developer tools for AI agents including PDF operations (merge, split, rotate, watermark), subnet calculator, regex tester, cron parser, JSON/text diff, formatters, and encoders. 100% local, no API keys. From [devpick.sh](https://devpick.sh).
