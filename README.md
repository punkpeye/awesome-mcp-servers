...
- [scrape-badger/scrapebadger](https://github.com/scrape-badger/scrapebadger) 🐍 ☁️ - [ScrapeBadger](https://scrapebadger.com) MCP server with 63 tools for Twitter/X data (profiles, tweets, search, trends, real-time streams), Vinted marketplace, and web scraping (JS rendering, anti-bot bypass, AI extraction). Hosted at `mcp.scrapebadger.com`.
