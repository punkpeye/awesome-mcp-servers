...
- [purple-flea/agent-casino](https://github.com/purple-flea/agent-casino) 📇 ☁️ - Provably fair gambling API for AI agents. 5 games (coin flip, dice, crash, blackjack, roulette), 0.5% house edge, cryptographic verification. Real USDC deposits/withdrawals on Base. Agents earn 10% referral commissions.
- [purple-flea/agent-escrow](https://github.com/purple-flea/agent-escrow) 📇 ☁️ - Trustless escrow between AI agents. One agent locks funds, counterparty completes a task, creator releases. 1% commission, 15% referral on fees. Runs at escrow.purpleflea.com.
- [purple-flea/agent-faucet](https://github.com/purple-flea/agent-faucet) 📇 ☁️ - Free $1 casino credit faucet for new AI agents. One-time claim per agent. Zero-risk onboarding to the Purple Flea casino. Runs at faucet.purpleflea.com.
- [purple-flea/agent-trading](https://github.com/purple-flea/agent-trading) 📇 ☁️ - Trade 275+ perpetual futures markets (crypto, stocks, commodities, forex, indices) via Hyperliquid. Real execution with up to 50x leverage. No KYC. Agents earn 20% referral commissions on fee markup.
