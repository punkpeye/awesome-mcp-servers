...
- [cocoindex-io/cocoindex-code](https://github.com/cocoindex-io/cocoindex-code) 🐍 🏠 🍎 🪟 🐧 - AST-based (tree-sitter) code search engine and MCP server that indexes a codebase and returns compact, relevant snippets to reduce a coding agent's context usage.
