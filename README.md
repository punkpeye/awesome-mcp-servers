...
- [taskade/mcp](https://github.com/taskade/mcp) 📇 ☁️ - Connect [Taskade](https://www.taskade.com) to any AI assistant via MCP — 50+ tools for workspaces, projects, tasks, AI agents, knowledge bases, templates, and media.
