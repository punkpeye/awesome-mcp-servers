...
- [starmorph/pixelmuse-cli](https://github.com/starmorph/pixelmuse-cli) 📇 ☁️ 🍎 🪟 🐧 - AI image generation MCP server with 6 models (Flux, Imagen 3, Recraft V4, Nano Banana). Text-to-image from Claude Code, Cursor, and Windsurf. `npx -y pixelmuse-mcp`
