...
- [Cyberweasel777/botindex-mcp-server](https://github.com/Cyberweasel777/botindex-mcp-server) 📇 ☁️ - AI-native signal intelligence API with 15+ x402-gated endpoints covering sports odds, crypto correlations, Solana token launches, Hyperliquid funding arb, and agentic commerce comparison. Free API key tier (500 req/month) + wallet trial + USDC micropayments on Base.
