...
- [arthurpanhku/job-pilot](https://github.com/arthurpanhku/job-pilot) [glama](https://glama.ai/mcp/servers/arthurpanhku/job-pilot)📇 🏠 ☁️ 🍎 🪟 - Intelligent AI Career Co-Pilot powered by MCP. Automates job search on LinkedIn/Indeed with stealth-mode application filing, context-aware resume optimization, and a centralized application tracking dashboard.
