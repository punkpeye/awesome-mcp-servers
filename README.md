...
- [navigatorbuilds/elara-core](https://github.com/navigatorbuilds/elara-core) 🐍 🏠 🍎 🪟 🐧 - Persistent memory, mood, cognition, and self-awareness for AI assistants. 45 MCP tools across 15 modules: semantic memory, emotional state, overnight thinking, reasoning trails, knowledge graphs, workflow patterns, and a decentralized mesh network with post-quantum crypto (Dilithium3 + SPHINCS+). Every install becomes a node. One-line install: `curl -sSL https://raw.githubusercontent.com/navigatorbuilds/elara-core/main/scripts/install.sh | sh`
