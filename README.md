...
- [Shelter](https://github.com/nextauralabs/wealth-vault/tree/main/packages/mcp) 📇 ☁️ - AI financial coaching with safe-to-spend, cash runway, forecast, alerts, and savings opportunities powered by real bank data.
