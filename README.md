...
- [kurovu146/claude-memory-mcp](https://github.com/kurovu146/claude-memory-mcp) [glama](https://glama.ai/mcp/servers/kurovu146/claude-memory-mcp) [![kurovu146/claude-memory-mcp MCP server](https://glama.ai/mcp/servers/kurovu146/claude-memory-mcp/badges/score.svg)](https://glama.ai/mcp/servers/kurovu146/claude-memory-mcp) 📇 🏠 🍎 🪟 🐧 - Long-term memory for Claude Code with SQLite FTS5 full-text search, BM25 ranking, access tracking, and upsert deduplication. Zero config, works out of the box via `npx claude-memory-fts`.
