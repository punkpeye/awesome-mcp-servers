...
- [hostkit-platform/hostkit](https://github.com/hostkit-platform/hostkit/tree/main/packages/mcp-server) 📇 🐍 ☁️/🏠 - AI-agent-native VPS management. Deploy apps, manage PostgreSQL/Redis databases, enable services (auth, payments, SMS, chatbot, voice), configure SSL/nginx, and monitor health — all through MCP tools over SSH to a Linux VPS.
