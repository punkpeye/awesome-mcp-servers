...
- [lukeslp/geepers-kernel](https://github.com/lukeslp/geepers-kernel) 🐍 🏠 - Unified LLM provider library with MCP server infrastructure — 10+ provider abstractions, Dream Cascade and Dream Swarm orchestration patterns, and 15+ structured data API clients (arXiv, Census, GitHub, NASA, and more).
