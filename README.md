...
- [sim-xia/logic-map-mcp](https://github.com/Sim-xia/Logic-map-MCP)📇 🏠 🐧 🍎 🪟 - A Model Context Protocol server that builds reusable language-agnostic logic graphs to help AI agents understand codebase architecture logic, inspired by Windsurf Codemap.
