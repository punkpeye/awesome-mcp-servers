...
- [star-ga/mind-mem](https://github.com/star-ga/mind-mem) 🐍 🏠 🍎 🪟 🐧 - Agent memory with BM25 recall, adaptive block metadata (A-MEM), intent-aware routing, and optional cross-encoder reranking. Zero external dependencies. 14 MCP tools.
