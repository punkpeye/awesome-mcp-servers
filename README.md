...
- [taskade/mcp](https://github.com/taskade/mcp) 📇 ☁️ 🍎 🪟 🐧 - Taskade AI productivity platform with 62+ MCP tools auto-generated from OpenAPI 3.0 spec via `@taskade/mcp-openapi-codegen`. Manage projects, tasks, agents, docs, and team workflows.
