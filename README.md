...
- [sgroy10/speclock](https://github.com/sgroy10/speclock) 📇 🏠 🍎 🪟 🐧 - AI constraint engine with persistent memory, active enforcement, semantic conflict detection, and file-level guards. Stops AI from breaking locked code across sessions. Works with Claude Code, Cursor, Windsurf, Bolt.new, and Lovable.
