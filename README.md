...
- [Philidor-Labs/philidor-mcp](https://github.com/Philidor-Labs/philidor-mcp) 📇 ☁️ - DeFi vault risk analytics with multi-vector risk scoring across 700+ vaults. Search, compare, and analyze risk scores, protocols, and curators across Morpho, Aave, Yearn, and more. No API key required.
