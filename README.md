...
- [engram-sdk](https://github.com/tstockham96/engram) 📇 🏠 🍎 🪟 🐧 - Universal memory layer for AI agents with vector search, automatic consolidation, bi-temporal recall, and MCP tools. Zero-dependency Node.js server, works with any LLM provider.
