...
- [seritalien/brain-protocol](https://github.com/seritalien/brain-protocol) 📇 🏠 ☁️ 🍎 🪟 🐧 - Verifiable memory-as-a-service for AI agents. 31 MCP tools with knowledge graphs, 6 search modes (FTS, semantic, hybrid, RRF, HyDE, PRF), 5D trust scoring, consciousness metrics, brain sync with conflict resolution, and Starknet L3 on-chain anchoring (Proof of Memory). Local SQLite or cloud mode. [npm](https://www.npmjs.com/package/@brain-protocol/mcp)
