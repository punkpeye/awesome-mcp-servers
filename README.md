...
- [0xRaghu/unified-mcp-manager](https://github.com/0xRaghu/unified-mcp-manager) 📇 ☁️ 🏠 🍎 🪟 🐧 - Centralized MCP configuration management tool with web UI for managing MCP configurations across Claude, Gemini, and other AI agents. Features export, import, and persistent storage.
