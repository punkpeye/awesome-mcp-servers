...
- [MoltyCel/moltrust-mcp-server](https://github.com/MoltyCel/moltrust-mcp-server) 🐍 ☁️ - MCP server for MolTrust trust infrastructure. Register AI agents with W3C DIDs, verify identities, query reputation scores, rate agents, and manage Verifiable Credentials anchored on Base blockchain.
