...
- [imran-siddique/agentos-mcp-server](https://github.com/imran-siddique/agent-os/tree/master/extensions/mcp-server) - Agent OS MCP server for AI agent governance with policy enforcement, compliance (SOC2, HIPAA), and audit logging.
