...
- [augiemazza/varrd](https://github.com/augiemazza/varrd) 🐍 ☁️ - AI trading research platform. Test any idea on stocks, ETFs, 35 CME futures, and crypto with event studies, backtesting, walk-forward validation, and Bonferroni-corrected significance testing. Natural language to validated trade setup. 8 tools, 4 prompts. `pip install varrd`.
