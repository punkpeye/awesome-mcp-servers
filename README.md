...
- [kurovu146/claude-memory-mcp](https://github.com/kurovu146/claude-memory-mcp) 📇 🏠 🍎 🪟 🐧 - Long-term memory for Claude Code with SQLite FTS5 full-text search, BM25 ranking, access tracking, and upsert deduplication. Zero config, works out of the box via `npx claude-memory-fts`.
