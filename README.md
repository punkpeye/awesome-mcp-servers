...
- [zip1-io/url-shortener](https://github.com/zip1-io/url-shortener) 🐍 ☁️ 🍎 🪟 🐧 - Free URL shortener with custom aliases, password protection, click analytics, emoji support, and max click limits. Production HTTP MCP endpoint at https://zip1.io/mcp with 30 req/min rate limit.
