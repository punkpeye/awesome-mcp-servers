...
- [Pharaoh](https://pharaoh.so) 📇 ☁️ - Codebase intelligence platform that parses repositories into Neo4j knowledge graphs, providing AI agents with architectural awareness through 16 MCP tools including blast radius analysis, function search, dead code detection, dependency tracing, and reachability checking.
