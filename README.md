...
- [InsForge/insforge-mcp](https://github.com/InsForge/insforge-mcp) 📇 ☁️ - Backend platform for agentic development providing authentication, databases, file storage, serverless functions, real-time capabilities, and AI gateway integration.
