...
- [rohansx/workz](https://github.com/rohansx/workz) 🦀 🏠 🍎 🐧 - Git worktree manager with zero-config dependency syncing, fuzzy switching, and built-in MCP server. Auto-symlinks node_modules/target/.venv, copies .env files, and lets Claude Code manage worktrees autonomously via `workz mcp`.
