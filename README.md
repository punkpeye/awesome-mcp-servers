...
- [skillboss-skills](https://github.com/heeyo-life/skillboss-skills) 📇 ☁️ 🍎 🪟 🐧 - Unified API gateway for 100+ AI models and services (GPT-5, Claude Opus, o1-Pro, Gemini, FLUX, Replicate, Firecrawl, etc). One API key, one balance. Works with Claude Code, Cursor, Windsurf.
