...
- [trssantos/decay-memory](https://github.com/trssantos/decay-memory) 🐍 🏠 🍎 🪟 🐧 - Three-layer memory with biological decay for AI agents. Memories fade based on importance and access frequency — core never decays, active has 30-day half-life, passing has 7-day half-life. SQLite-backed with seven tools: remember, recall, forget, promote, list, stats, and decay_cycle.
