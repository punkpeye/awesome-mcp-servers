...
- [GlyphForge](https://github.com/PLR2388/GlyphForge) 📇 ☁️ - Unicode text transformation API and MCP server with 31+ styles (bold, italic, fraktur, vaporwave, zalgo, etc.). Transform text via REST API or MCP tools. Free tier: 3,000 requests/month.
