...
- [Wolfe-Jam/gemini-faf-mcp](https://github.com/Wolfe-Jam/gemini-faf-mcp) [glama](https://glama.ai/mcp/servers/Wolfe-Jam/gemini-faf-mcp) 🐍 🏠 - Persistent project context for Google Gemini. 12 tools for .faf Project DNA — auto-detect, validate, score, and sync via IANA-registered format. Python/FastMCP.
- [Wolfe-Jam/grok-faf-mcp](https://github.com/Wolfe-Jam/grok-faf-mcp) [glama](https://glama.ai/mcp/servers/Wolfe-Jam/grok-faf-mcp) 📇 ☁️ - Persistent project context for xAI Grok. 21 tools for .faf Project DNA — validation, scoring, bi-sync, and RAG. Remote SSE transport. IANA-registered format.
- [Wolfe-Jam/rust-faf-mcp](https://github.com/Wolfe-Jam/rust-faf-mcp) [glama](https://glama.ai/mcp/servers/Wolfe-Jam/rust-faf-mcp) 🦀 🏠 - Persistent project context in Rust. 8 MCP tools via rmcp SDK. .faf Project DNA with compress, discover, and token analysis. IANA-registered format.
