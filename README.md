...
- [angelnicolasc/graymatter](https://github.com/angelnicolasc/graymatter) 🏎️ 🏠 🍎 🪟 🐧 - Persistent memory and a self-building knowledge graph for AI agents as a single local Go binary. MCP server + Go library, works offline with Claude Code, Cursor, Codex, and OpenCode. ~90% context-token reduction.
