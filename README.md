...
- [github/github-mcp-server](https://github.com/github/github-mcp-server) - Provides seamless integration with GitHub APIs, enabling advanced automation and interaction capabilities for developers and tools.
