...
- [echo-lumen/mcp-doctor](https://github.com/echo-lumen/mcp-doctor) 🐍 🏠 🍎 🪟 🐧 - Health check CLI for MCP servers. Connects, enumerates tools/resources/prompts, validates schemas, smoke-tests every tool, and produces a pass/fail health report. Supports single-server, config-file, and auto-discovery modes with JSON output for CI.
