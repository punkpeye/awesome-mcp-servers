...
- [NeuralRays/codexray](https://github.com/NeuralRays/codexray) 📇 🏠 🍎 🪟 🐧 - Semantic code intelligence MCP server with 16 tools. Pre-indexes codebases into a SQLite knowledge graph with TF-IDF semantic search, call graphs, impact analysis, dead code detection, and complexity metrics. Saves AI agents 30%+ tokens. Supports 15 languages via tree-sitter.
