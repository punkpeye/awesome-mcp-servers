...
- [starbuck100/agentaudit-mcp](https://github.com/starbuck100/agentaudit-mcp) 📇 ☁️ 🏠 🍎 🪟 🐧 - Open-source security scanner for AI agent packages (MCP servers, skills). Scans for vulnerabilities, supply chain risks, and tool poisoning. Available as CLI (`npx agentaudit audit <package>`) and MCP server.
