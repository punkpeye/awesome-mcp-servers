...
- [boutquin/mcp-server-email](https://github.com/boutquin/mcp-server-email) 🏎️ ☁️ 🍎 🪟 🐧 - Multi-account IMAP/SMTP email MCP server with 22 tools for reading, sending, searching, organizing, threading, and batch operations. Connection pooling, rate limiting, retry with backoff, and OAuth2 device-code flow.
