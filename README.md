...
- [ndl-systems/kevros-sdk](https://github.com/ndl-systems/kevros-sdk) 🐍 ☁️ 🏠 🍎 🪟 🐧 - Agentic identity trust and PQC-resilient security for AI agents. Issue and verify trust certificates, check peer reputation scores, verify release tokens, and generate tamper-evident audit trails with post-quantum cryptographic signatures. Free tier included.
