...
- [cristiano-c1/truth-anchor-agent](https://github.com/cristiano-c1/truth-anchor-agent) ([glama](https://glama.ai/mcp/servers/cristiano-c1/truth-anchor-agent)) 🐍 ☁️ - Real-time URL verification and fact-checking grounded via on-chain USDC micro-payments on Base (x402).
