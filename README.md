...
- [KGT24k/mcp-tool-search](https://github.com/KGT24k/mcp-tool-search) 🔗 ☁️ - MCP proxy server that reduces context token usage by 85-96% via lazy tool loading. Serves 100+ MCP servers through a single connection with LRU caching, gzip compression, and retry logic.
