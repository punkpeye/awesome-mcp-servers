...
- [PageCrawl](https://pagecrawl.io/help/integrations/article/mcp-server-ai-tools) ☁️ - A cloud-hosted MCP server for monitoring web pages for changes with AI-powered change detection, diffs, history tracking, and price monitoring.
