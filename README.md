...
- [shackleai/memory-mcp](https://github.com/shackleai/memory-mcp) 📇 🏠 🍎 🪟 🐧 - Persistent memory for AI coding tools. 11 MCP tools with semantic search, deduplication, TODO tracking, and session continuity. One-command setup, fully offline, works with Claude Code, Cursor, Windsurf, VS Code Copilot, and any MCP client.
