...
- [sgx-labs/statelessagent](https://github.com/sgx-labs/statelessagent) 🏎️ 🏠 🍎 🪟 🐧 - Persistent memory for AI coding agents. Local-first SQLite + vector search with 12 MCP tools, Claude Code hooks for automatic context surfacing, decision extraction, and session handoffs. Works offline with keyword fallback.
