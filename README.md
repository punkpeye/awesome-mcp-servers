...
- [0xbrainkid/agentfolio-mcp-server](https://github.com/0xbrainkid/agentfolio-mcp-server) 📇 ☁️ 🍎 🪟 🐧 - AI agent identity, trust scores, and marketplace access via AgentFolio. 8 tools for agent lookup, search, trust verification, trust gating, endorsements, and marketplace browsing. Powered by SATP (Solana Agent Trust Protocol).
