...
- [Delegueinu/onlyswaps](https://github.com/Delegueinu/onlyswaps) 📇 ☁️ - Multi-chain DEX meta-aggregator for AI agents. Queries 15+ DEX aggregators (0x, 1inch, Paraswap, Li.Fi, etc.) across 13 chains to find best swap prices. Built for MCP with tools for quotes, swaps, portfolio tracking, and transaction management.
