...
- [policylayer/intercept](https://github.com/policylayer/intercept) 📇 🏠 🍎 🪟 🐧 - Transparent MCP proxy that enforces YAML policies on every tool call before it reaches upstream. Rate limits, spend caps, argument validation, unconditional blocks, and full audit logging. Drop-in — no agent or server changes needed.
