...
- [cnghockey/sats4ai-mcp-server](https://github.com/cnghockey/sats4ai-mcp-server) 📇 ☁️ - Bitcoin-powered AI tools via Lightning Network micropayments (L402). Image, text, video, music, speech, 3D, file conversion, and SMS — no signup or API keys required.
