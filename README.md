...
- [strategyconnect/webcite-mcp-server](https://github.com/strategyconnect/webcite-mcp-server) 📇 ☁️ - Fact-check AI claims against authoritative sources with stance analysis, credibility scores, and verdicts. Supports streaming verification, file uploads, and threaded sessions. Works with any MCP client.
