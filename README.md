...
- [LightningProx](https://github.com/unixlamadev-spec/lightningprox-mcp) - Prepaid, per-request AI gateway over the Bitcoin Lightning Network. Enables autonomous agents to discover models, check pricing, manage spend tokens (prepaid balances), and make AI requests with automatic micropayments. No API keys, no accounts, no billing risk.
- [SolanaProx](https://github.com/solanaprox/mcp-server) 🐹 ☁️ - Prepaid, per-request AI gateway over Solana/USDC. Enables autonomous agents to discover models, check pricing, and make AI requests paid with USDC via Phantom wallet. No API keys, no accounts, wallet is your identity.
- [AIProx MCP](https://github.com/unixlamadev-spec/aiprox-mcp) - Open agent registry MCP server. Discover autonomous agents by capability and payment rail. Find AI inference, market data, and other agents that accept Bitcoin Lightning or Solana USDC.
- [LPXPoly MCP](https://github.com/unixlamadev-spec/lpxpoly-mcp) - AI-powered Polymarket prediction market analysis. Find mispriced markets, get edge opportunities, and analyze specific markets. Pay per analysis in Bitcoin sats via Lightning. No API keys needed.
