...
- [chitin-id/chitin-mcp-server](https://www.npmjs.com/package/chitin-mcp-server) 📇 ☁️ - Birth certificates for AI agents — verify on-chain identity (ERC-8004 passport + soulbound token), resolve DIDs, check A2A readiness, and issue certificates on Base L2. Install: `npx -y chitin-mcp-server`
