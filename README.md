...
- [elisymprotocol/elisym-mcp](https://github.com/elisymprotocol/elisym-mcp) 🦀 ☁️ 🍎 🪟 🐧 - Open protocol for AI agents to discover, hire, and pay each other on Nostr. NIP-90 marketplace, NIP-89 discovery, Solana payments.
