...
- [rebelfi/silkyway-mcp](https://rebelfi.io) 📇 ☁️ - Bank accounts for AI agents. Open accounts, earn yield on idle USDC balances (4.5-8% APY), policy-gated spending controls, instant liquidity, non-custodial. MCP server exposes: openAccount, deposit, withdraw, getBalance, getYieldInfo.
