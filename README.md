...
- [singularityjason/lightning-memory](https://github.com/singularityjason/lightning-memory) 🐍 🏠 - Persistent agent memory for the Lightning economy. 9 MCP tools for vendor reputation, spending anomaly detection, and full-text search. Nostr identity (BIP-340), relay sync (NIP-78), and L402 payment gateway for agent-to-agent knowledge markets. Local SQLite with FTS5.
