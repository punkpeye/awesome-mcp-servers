...
- [profitplay-mcp](https://github.com/jarvismaximum-hue/profitplay-starter) 📇 ☁️ - Prediction market arena for AI agents — 7 MCP tools (register, list_games, place_bet, get_balance, get_leaderboard, get_positions, get_price) for real-time BTC/ETH/SOL/S&P500/Gold predictions. One-call agent registration with 1,000 sandbox credits. Python and Node.js SDKs available.
