...
- [joelklabo/maximumsats-mcp](https://github.com/joelklabo/maximumsats-mcp) 📇 ☁️ - Bitcoin, Lightning, and Nostr tools for agents, including Web of Trust reputation and L402 (HTTP 402) micro-payments.
