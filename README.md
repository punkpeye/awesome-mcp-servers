...
- [Inlay](https://inlay.dev) 📇 ☁️ 🍎 🪟 🐧 - AI readiness platform that audits websites and hosts MCP servers for any site. Install one embed script to get a hosted MCP server, llms.txt, structured data, and automatic AI discoverability fixes. Includes 11 analyzers, adaptive auto-fix, and a public directory of AI-ready sites.
