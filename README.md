...
- [KeyID-AI/KeyID](https://github.com/KeyID-AI/KeyID) 📇 ☁️ 🏠 🍎 🪟 🐧 - Agent email, SMS, OTP/TOTP, and signup session infrastructure. Agents self-provision email addresses and phone numbers, extract verification codes, manage TOTP authenticators, and run full signup flows with browser state persistence. 47 tools, 8 prompts. Local (`npx @keyid/agent-kit`) or remote (`https://keyid.ai/mcp`).
