...
- [base-batch-send-mcp](https://github.com/lordbasilaiassistant-sudo/base-batch-send-mcp) 📇 🏠 - Batch-send ETH or ERC-20 tokens to multiple recipients in one transaction on Base. Airdrops, payroll, and token distribution for AI agents.
- [base-lp-locker-mcp](https://github.com/lordbasilaiassistant-sudo/base-lp-locker-mcp) 📇 🏠 - Lock LP tokens on Base with time-based unlock. Prove liquidity is locked for token launches. 6 tools for AI agents.
- [base-token-factory-mcp](https://github.com/lordbasilaiassistant-sudo/base-token-factory-mcp) 📇 🏠 - Deploy vanilla ERC-20 tokens on Base in one tool call. Factory pattern with deployment tracking.
- [base-token-sniper-mcp](https://github.com/lordbasilaiassistant-sudo/base-token-sniper-mcp) 📇 🏠 - Discover and trade new token launches on Base. Watch launches, snipe buy, multi-quote, and safety checks for AI agents.
- [base-wallet-toolkit-mcp](https://github.com/lordbasilaiassistant-sudo/base-wallet-toolkit-mcp) 📇 🏠 - Base chain wallet toolkit for AI agents — check balances, estimate gas, inspect tokens, verify allowances, resolve ENS, check tx status.
