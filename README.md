...
- [SebastianMaciel/jsx-notation](https://github.com/SebastianMaciel/jsx-notation) 📇 🏠 🍎 🪟 🐧 - Compresses React JSX/TSX, HTML, and SVG files by ~40% into a compact notation optimized for LLM token consumption. Fully reversible. MCP server with read, encode, decode, and write tools.
