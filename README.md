...
- [Fabber-bot/mcp-ssh-server](https://github.com/Fabber-bot/mcp-ssh-server) 🐍 🏠 🍎 🪟 🐧 - Secure SSH server with host allowlisting, command restrictions, SFTP file transfer, and audit logging. Supports key-based auth and persistent connections.
