...
- [Bande-a-Bonnot/Boucle-framework](https://github.com/Bande-a-Bonnot/Boucle-framework) 🦀 🏠 🍎 🪟 🐧 - File-based persistent memory (Broca) for AI agents using human-readable Markdown. BM25 search, knowledge management, session logging, and plugin system. No database required.
