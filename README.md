...
- [RPGMais/mcp-n8n](https://github.com/RPGMais/mcp-n8n) 📇 ☁️ 🏠 - The most complete MCP server for [n8n](https://n8n.io) — 43 tools covering workflows, executions, data tables, tags, credentials, users, variables, projects, audit, and webhooks.
