...
- [tymrtn/U1F4E7](https://github.com/tymrtn/U1F4E7) 🐍 🏠 🍎 🪟 🐧 - Envelope (📧) — BYO mailbox email API with MCP server. Connect any IMAP/SMTP account and get agent-native email with draft previews, human-in-the-loop approval gates, domain policies, action audit logs, open tracking, and thread reconstruction. Built for AI agents that need to send email with human oversight.
