...
- [quantacodes/seomcp-proxy](https://github.com/quantacodes/seomcp-proxy) 📇 ☁️ - 39 SEO tools for Claude and other AI assistants. Keyword research, site auditing, backlink analysis, rank tracking. Cloud API at [seomcp.dev](https://seomcp.dev).
