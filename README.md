...
- [Deesmo/Arch-AI-Tools](https://github.com/Deesmo/Arch-AI-Tools) 📇 ☁️ 🍎 🪟 🐧 - 58+ production API tools behind one MCP server — web scraping, AI generation (Claude/GPT-4/Grok/Gemini), screenshot capture, image gen, crypto data, email, webhooks, and more. Supports x402 USDC payments, credit billing, and BYOK (bring your own API key).
