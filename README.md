...
- [charliebot8888/SafeLink](https://github.com/charliebot8888/SafeLink) 📇 🏠 🍎 🪟 🐧 - Security-first MCP server for agent-to-agent hiring with on-chain escrow, x402 USDC micropayments, MPC wallets (Coinbase AgentKit / Privy), ERC-8004 identity, proof-before-settlement, and policy-gated transactions on Base.
