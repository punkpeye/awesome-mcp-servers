...
- [sheawinkler/ContextLattice](https://github.com/sheawinkler/ContextLattice) 🐍 🏠 - Private-by-default, local-first memory/context/task orchestrator with HTTP-first MCP-compatible ingress, durable multi-sink fanout, and federated retrieval for long-horizon agent workflows.
