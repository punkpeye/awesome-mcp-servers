...
- [seomcp/seomcp-saas](https://github.com/quantacodes/seomcp-saas) 📇 ☁️ - SEO MCP server with 39 tools for AI agents — Google Search Console, GA4 Analytics, Indexing API, IndexNow, Core Web Vitals, schema validation, and site auditing. One MCP endpoint for all SEO workflows. Works with Claude, Cursor, and Windsurf. Available at [seomcp.dev](https://seomcp.dev).
