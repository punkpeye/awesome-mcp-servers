...
- [manavaga/web3-signals-mcp](https://github.com/manavaga/web3-signals-mcp) 🐍 ☁️ - Multi-agent crypto market intelligence with 5 AI agents scoring 20 assets (0-100) across whale, derivatives, technical, narrative, and market dimensions. MCP SSE transport + x402 micropayments ($0.001 USDC on Base).
