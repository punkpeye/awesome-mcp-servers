...
- [agentskill-sh/mcp-server](https://github.com/agentskill-sh/mcp-server) 📇 ☁️ 🏠 🍎 🪟 🐧 - Search, discover, and install AI agent skills from [agentskill.sh](https://agentskill.sh) — the largest skills directory with 44k+ skills for Claude Code, Cursor, Copilot, Windsurf, and more.
