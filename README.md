...
- [gptcompany/pepers](https://github.com/gptcompany/pepers) 🐍 🏠 - Academic paper pipeline with 11 MCP tools: discover papers from arXiv/OpenAlex, extract LaTeX formulas, validate math with multi-engine CAS consensus (SymPy + SageMath), and generate Python/C99/Rust code. Every formula is algebraically verified.
