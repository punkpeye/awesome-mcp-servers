...
- [jshorwitz/synter-media](https://github.com/jshorwitz/synter-media) 🐍 ☁️ 🏠 - Cross-platform advertising MCP server supporting Google Ads, Meta, LinkedIn, Reddit, Microsoft, TikTok, and X (7 platforms). 100+ tools for campaign creation, performance reporting, budget optimization, and AI creative generation with Imagen 4, Veo, Flux.
