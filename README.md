...
- [bitbond/token-tool-mcp](https://github.com/bitbond/token-tool-mcp) 📇 🏠 - Deploy and manage compliant ERC-20 tokens from any AI agent. 17 tools, 10 networks, CertiK-audited contracts. Features whitelist/blacklist compliance, pausable tokens, and real-time deployment tracking. Built on [Bitbond TokenTool](https://tokentool.bitbond.com) (8,300+ deployments).
