...
- [AgentPay](https://github.com/joepangallo/mcp-server-agentpay) 📇 ☁️ - Payment gateway for AI agents with tool discovery, pay-per-call metering, Stripe + x402 USDC funding, and reliability monitoring.
