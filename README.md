...
- [guard0-ai/g0](https://github.com/guard0-ai/g0) 📇 🏠 🍎 🪟 🐧 - The control layer for AI agents — discovers MCP server configurations across 18 AI developer tools, scans for security risks with 1,200+ rules, detects rug-pulls via tool description hash pinning, finds shadow AI services on the network, and tests agents against 4,000+ adversarial payloads. Includes endpoint scoring, fleet-wide monitoring, and compliance mapping to OWASP Agentic Top 10 and 9 other standards.
