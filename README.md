...
- [antonio-mello-ai/mcp-proxmox](https://github.com/antonio-mello-ai/mcp-proxmox) [glama](https://glama.ai/mcp/servers/antonio-mello-ai/mcp-proxmox) 🐍 ☁️/🏠 - Manage Proxmox VE clusters — list nodes/VMs/containers, control lifecycle, manage snapshots, and monitor resources.
