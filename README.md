...
- [nhadaututtheky/neural-memory](https://github.com/nhadaututtheky/neural-memory) 🐍 🏠 🍎 🪟 🐧 - Graph-based persistent memory for Claude Code with spreading activation retrieval. 28 MCP tools, habits tracking, connection explainer, multi-brain management, and proactive auto-save. Local SQLite storage with optional Ollama/Gemini/OpenAI embeddings.
