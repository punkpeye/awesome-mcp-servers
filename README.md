...
- [GibsonAI/mcp](https://github.com/GibsonAI/mcp) ⛃ ☁️ — MCP Server for creating and evolving database schemas and run SQL queries against multiple relational databases (Postgres, MySQL).
