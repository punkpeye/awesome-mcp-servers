...
- [taskade/mcp](https://github.com/taskade/mcp) 🎖️ 📇 ☁️ 🍎 🪟 🐧 - Official Taskade MCP server with 62+ AI-powered tools for project management, tasks, workflows, and AI agents. Manage projects, automate workflows, and orchestrate AI agent teams through natural language.
