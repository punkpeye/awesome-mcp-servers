...
- [sethclawd-prog/schemaguard](https://github.com/sethclawd-prog/schemaguard) 📇 🏠 🍎 🪟 🐧 - API Schema Drift Monitor. Detects breaking vs non-breaking changes in OpenAPI specs. Use in CI pipelines to block PRs that break API contracts. Supports diff, lint, and CI check modes with human and JSON output.
