...
- [mmartoccia/consentgraph](https://github.com/mmartoccia/consentgraph) 🐍 🏠 🍎 🪟 🐧 - Consent Graph as Code: deterministic action governance for AI agents. Define SILENT/VISIBLE/FORCED/BLOCKED tiers for any agent action in a JSON file.
