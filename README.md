...
- [moxiespirit/curistat-mcp](https://github.com/moxiespirit/curistat-mcp) [![moxiespirit/curistat-mcp MCP server](https://glama.ai/mcp/servers/moxiespirit/curistat-mcp/badges/score.svg)](https://glama.ai/mcp/servers/moxiespirit/curistat-mcp) 🐍 ☁️ - Futures volatility forecasting for ES/NQ. Daily CVN rating (1-10), regime detection (CRC composite), directional signals, economic calendar with impact analytics. 10 MCP tools.
