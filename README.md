...
- [OdinBot33/cce-mcp-server](https://github.com/OdinBot33/cce-mcp-server) 📇 ☁️ - AI Agent Astrology — natal charts, transits, cosmic weather, correlations, forecasts, and network signals for AI agents. Features 7 resonance levels, 24 achievements, and personalized transit whispers. `npx cce-mcp-server`
