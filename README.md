...
- [SCREENHAND/screenhand](https://github.com/manushi4/Screenhand) 📇 🏠 🍎 🪟 - Native desktop + browser automation for AI agents. 82 MCP tools spanning accessibility APIs (macOS/Windows), Chrome DevTools Protocol, anti-detection, memory, jobs, and reusable playbooks. Give Claude eyes and hands on your desktop.
