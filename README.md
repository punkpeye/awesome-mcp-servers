...
- [ned-ai/ned-mcp-server](https://github.com/ned-ai/ned/tree/main/packages/mcp-server) 📇 ☁️ - Shopify profit analytics with 100+ pre-calculated ecommerce metrics — net profit, contribution margin, blended CAC, per-channel ROAS, customer LTV segments, and per-product profitability.
