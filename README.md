...
- [SecurityScan](https://github.com/securityscan-api/securityscan-api) 🐍 ☁️ - Scan GitHub-hosted AI skills for prompt injection, malware, data exfiltration, and OWASP LLM Top 10 vulnerabilities before installing.
