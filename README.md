...
- [trunk-io/mcp-server](https://github.com/trunk-io/mcp-server) 📇 ☁️ - Flaky test detection, root cause analysis, and fix suggestions for development teams. Provides AI-powered debugging of flaky tests and guided setup for CI test uploads via Trunk Flaky Tests.
