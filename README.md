...
- [gethopp/figma-mcp-bridge](https://github.com/gethopp/figma-mcp-bridge) 🎖️ 📇 🏠 🍎 🪟 🐧 - Bypass Figma API rate limits with live Figma document data streaming to AI tools. Features WebSocket-based plugin-server bridge, leader election for multi-instance management, and seamless integration with AI coding assistants.
