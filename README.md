...
- [entire-vc/evc-spark](https://github.com/entire-vc/evc-spark) 📇 ☁️ 🏠 🍎 🪟 🐧 - Search and discover 4,500+ AI assets (agents, MCP servers, skills, prompts) from the Spark marketplace. Browse by category, get install instructions, and find popular tools — all from within your coding environment.
