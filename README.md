...
- [Vincentwei1021/agent-toolbox](https://github.com/Vincentwei1021/agent-toolbox) 📇 ☁️ 🍎 🪟 🐧 - Production-ready MCP server providing 7 tools for AI agents: web search, content extraction, webpage screenshots, weather forecasts, financial market data, email validation, and text translation. 1,000 free calls/month, no setup required.
