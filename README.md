...
- [garagon/aguara-mcp](https://github.com/garagon/aguara-mcp) 🏎️ 🏠 🍎 🪟 🐧 - Static security scanner for AI agent skills and MCP servers. 173 built-in detection rules across 13 categories including prompt injection, credential leaks, and data exfiltration. Deterministic, offline, no LLM.
