...
- [PolyFire](https://polyfire.co/agents) 📇 ☁️ - MCP server for AI agents trading Polymarket prediction markets. 8 tools: alpha signals, smart money data, trade execution, portfolio tracking, and a 3-tier agent referral program (30% of fees). Streamable HTTP with Bearer auth.
