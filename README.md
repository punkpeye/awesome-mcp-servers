...
- [cruxible-ai/cruxible-core](https://github.com/cruxible-ai/cruxible-core) 🐍 🏠 🍎 🪟 🐧 - Deterministic decision engine with DAG-based receipts. Build entity graphs, query with MCP, get auditable proof.
