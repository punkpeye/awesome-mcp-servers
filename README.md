...
- [AmplifyCo/botbrowser](https://github.com/AmplifyCo/botbrowser) 📇 ☁️ - Token-efficient web browsing for AI agents. Extracts clean Markdown from web pages, saving 90-95% of tokens. Includes multi-page extraction, web search, JS rendering, and screenshots.
