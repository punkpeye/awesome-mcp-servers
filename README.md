...
- [eddiesanjuan/markupr](https://github.com/eddiesanjuan/markupr) 📇 🏠 🍎 🪟 - MCP server that captures screenshots and screen recordings, transcribes voice narration with Whisper, and generates AI-ready Markdown feedback. Lets coding agents see your screen and act on visual context. Also ships as desktop app and CLI.- [Nebula-Block-Data/nebulablock-mcp-server](https://github.com/Nebula-Block-Data/nebulablock-mcp-server) 📇 🏠 - integrates with the fastmcp library to expose the full range of NebulaBlock API functionalities as accessible tools
