...
- [billylui/temporal-cortex-mcp](https://github.com/billylui/temporal-cortex-mcp) 🦀 ☁️ 🏠 - AI-native calendar middleware for scheduling, availability, and conflict-free booking across Google Calendar, Outlook, and CalDAV. 11 tools across 4 layers: temporal context, calendar operations, multi-calendar availability merging, and Two-Phase Commit booking. Deterministic datetime resolution and RRULE expansion powered by Truth Engine.
