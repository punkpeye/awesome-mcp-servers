...
- [LinChuang2008/vigilops](https://github.com/LinChuang2008/vigilops) 🐍 🏠 - AI-powered monitoring MCP server with 5 tools: server health, alert queries, log search, AI incident analysis, and service topology. Features auto-remediation with 6 built-in runbooks and DeepSeek root cause analysis.
