...
- [Bluecraft-AI/machfive-mcp](https://github.com/Bluecraft-AI/machfive-mcp) [glama](https://glama.ai/mcp/connectors/io.github.Bluecraft-AI/machfive) ☁️ - Generate hyper-personalized cold email sequences per lead via AI. List campaigns, generate emails for individual leads or batches, and export results as CSV or JSON.
