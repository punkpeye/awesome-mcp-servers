...
- [Cursor Usage](https://github.com/ofershap/cursor-usage) - Enterprise AI coding usage analytics — track spend, model usage, and costs across Cursor/Claude Code sessions via MCP server
