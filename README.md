...
- [jamesrez/valoria-intelligence](https://github.com/jamesrez/valoria-intelligence) 📇 ☁️ - Agent economy intelligence — indexes 89K+ x402 services and MCP servers, tracks $46M+ in on-chain payments. Find opportunities, analyze competitors, get pricing recommendations. 5 paid x402 endpoints + free MCP tools.
