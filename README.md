...
- [raphasouthall/neurostack](https://github.com/raphasouthall/neurostack) - Local-first MCP server for Markdown knowledge graphs. Semantic search, prediction error tracking, and Leiden community detection — no cloud required.
