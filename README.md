...
- [formback/formback-mcp](https://github.com/LedMeIn/formback/tree/main/mcp) 📇 ☁️ - MCP server for [FormBack](https://formback.email) form backend API. Manage forms and submissions from AI assistants — create forms, list submissions, get account stats. Available on npm as `formback-mcp`.
