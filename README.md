...
- [Blue-Gamma/BlueGamma](https://www.bluegamma.io/documentation/integrations/index) 🐍 ☁️ - MCP server providing real-time interest rate derivatives pricing, swap curves, FX rates, government yields, and 39+ benchmark index fixings (SOFR, EURIBOR, SONIA, and more) for AI-powered financial analysis.
