...
- [xujfcn/crazyrouter-mcp](https://github.com/xujfcn/crazyrouter-mcp) 📇 ☁️ 🍎 🪟 🐧 - Unified AI API gateway with 627+ models (GPT-5, Claude, Gemini, DeepSeek, Llama 4, Qwen3). Chat, image generation (DALL-E 3, Midjourney, Flux), video generation (Sora 2, Kling V2, Veo 3), music, TTS — all via one OpenAI-compatible API key with competitive pricing.
