...
- [NerveNetwork/nerve-agent](https://github.com/NerveNetwork/nerve-agent) 📇 ☁️ 🏠 - Nerve blockchain JSON-RPC & REST MCP server for AI agents — query balances, validate addresses, get transaction history, and swap tokens via NerveSwap. No gas fees on Nerve network, no private key required.
