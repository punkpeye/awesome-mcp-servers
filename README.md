...
- [ai-dashboad/flutter-skill](https://github.com/ai-dashboad/flutter-skill) 🏠 🍎 🪟 🐧 - E2E testing bridge that gives AI eyes and hands inside any app. Supports Flutter, iOS, Android, Web, Electron, Tauri, KMP, React Native, and .NET MAUI.
