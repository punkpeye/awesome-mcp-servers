...
- [AnimaApp/mcp-server-guide](https://github.com/AnimaApp/mcp-server-guide) 📇 ☁️ - Connect AI coding agents to Anima Playground, Figma designs, and your design system. Bridge prototypes to production code.
