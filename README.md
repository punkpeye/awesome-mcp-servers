...
- [jtalk22/slack-mcp-server](https://github.com/jtalk22/slack-mcp-server) 📇 🏠 🍎 🪟 - Access Slack DMs, channels, and message history using browser tokens. Includes Web UI for claude.ai.
