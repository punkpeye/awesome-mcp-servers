...
- [lightpaperorg/lightpaper](https://github.com/lightpaperorg/lightpaper) 🐍 ☁️ - API-first publishing platform. Publish markdown documents as permanent, discoverable web pages with quality scoring and author gravity. 20 MCP tools for document management, search, identity verification, and content discovery.
