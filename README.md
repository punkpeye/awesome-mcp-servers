...
- [JStuBran/pii-redactor](https://github.com/JStuBran/pii-redactor) 📇 ☁️ - Detect and redact PII (names, emails, phones, SSNs, credit cards) from text using Microsoft Presidio. Pay-per-use via x402 USDC on Base. Remote: `https://pii-redactor-production-1dd5.up.railway.app/mcp`
- [JStuBran/weather-signal-api](https://github.com/JStuBran/weather-signal-api) 📇 ☁️ - Bias-corrected temperature forecasts for 8 global cities + Polymarket edge signals. Free forecast endpoint, pay-per-signal via x402 USDC on Base. Remote: `https://weather-signal-production.up.railway.app/mcp`
- [JStuBran/structured-data-api](https://github.com/JStuBran/structured-data-api) 📇 ☁️ - Extract structured JSON from any URL or text using a custom schema. Pay-per-use via x402 USDC on Base. Remote: `https://structured-data-production.up.railway.app/mcp`
- [JStuBran/whale-alert-api](https://github.com/JStuBran/whale-alert-api) 📇 ☁️ - Track large cryptocurrency transactions across Ethereum, Bitcoin, Solana, Base, and Arbitrum with exchange labels and USD valuations. Pay-per-use via x402 USDC on Base. Remote: `https://whale-alert-api-production.up.railway.app/mcp`
- [JStuBran/wallet-risk-api](https://github.com/JStuBran/wallet-risk-api) 📇 ☁️ - Analyze any EVM wallet address for scam interactions, mixer usage, sanction exposure, and composite risk scores. Pay-per-use via x402 USDC on Base. Remote: `https://wallet-risk-api-production.up.railway.app/mcp`
- [JStuBran/token-sentiment-api](https://github.com/JStuBran/token-sentiment-api) 📇 ☁️ - Real-time sentiment analysis for any crypto token aggregating X/Twitter, Reddit, and news signals into normalized scores. Pay-per-use via x402 USDC on Base. Remote: `https://token-sentiment-api-production.up.railway.app/mcp`
