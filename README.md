...
- [MetriLLM/metrillm-mcp](https://github.com/MetriLLM/metrillm/tree/main/mcp) 📇 🏠 - Benchmark local LLM models from any MCP client. Measures performance (tok/s, TTFT, memory), quality (reasoning, math, coding, instruction following, structured output, multilingual), and computes a hardware fitness verdict. Works with Ollama.
