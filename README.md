...
- [stellagent/presso-setup](https://github.com/stellagent/presso-setup) 📇 ☁️ - AI-powered e-commerce analytics platform connecting 11+ data sources (GA4, Google Ads, Meta Ads, Shopify, Search Console, Amazon Ads, GTM, Klaviyo) to AI assistants via one-click OAuth. Read-only access, no raw data storage.
