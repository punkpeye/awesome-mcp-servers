...
- [blynk-iot/blynk-mcp](https://blynk.cloud/mcp) - Create, monitor, and control IoT devices on the Blynk platform. Manage device templates, datastreams, events, and read live sensor data.
