...
- [Vanwida/haul-mcp](https://github.com/Vanwida/haul-mcp) 📇 ☁️ - MCP server for HAUL — the agent-native API marketplace. Verify emails and phone numbers programmatically, manage credits, and top up via Stripe. Built for autonomous agents that need consumable API tools without human checkout flows.
