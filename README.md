...
- [GiorgiKemo/mcp-seo-audit](https://github.com/GiorgiKemo/mcp-seo-audit) [glama](https://glama.ai/mcp/servers/@GiorgiKemo/mcp-seo-audit) 🐍 🏠 - SEO audit server with 23 tools: Google Search Console analytics, Indexing API, Core Web Vitals (CrUX), striking distance keywords, keyword cannibalization detection, and automated site audits.
