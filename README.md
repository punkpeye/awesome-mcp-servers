...
- [financedistrict-platform/fd-agent-wallet-skills](https://github.com/financedistrict-platform/fd-agent-wallet-skills) ☁️ - MCP server for agentic crypto wallet management. Transfer tokens, swap, deposit for yield, and manage wallets across 9+ chains including Base, Ethereum, Arbitrum, BSC, and Solana. Supports x402 micropayments and stablecoin settlement. ([Docs](https://developers.fd.xyz))
