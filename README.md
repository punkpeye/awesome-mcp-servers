...
- <img src="https://cdn.simpleicons.org/python" height="14"/> [click-to-mcp](https://github.com/Coding-Dev-Tools/click-to-mcp) - Auto-wrap any Click/typer Python CLI as an MCP server. Zero code changes - discover, serve, and connect CLI tools through the Model Context Protocol.
