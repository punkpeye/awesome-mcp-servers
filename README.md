...
- [aegis-zk/aegisprotocol](https://github.com/aegis-zk/aegisprotocol/tree/main/packages/mcp-server) [glama](https://glama.ai/mcp/servers/aegis-zk/aegisprotocol) 📇 ☁️ 🍎 🪟 🐧 - On-chain trust verification for AI agent tools. Query the AEGIS Protocol registry (Base Mainnet) to check skill attestations, trust scores, audit status, and risk surfaces before running third-party MCP servers. 233+ skills indexed with automated discovery.
