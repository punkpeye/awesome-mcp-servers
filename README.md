...
- [ajtgjmdjp/boj-mcp](https://github.com/ajtgjmdjp/boj-mcp) 🐍 ☁️ - First Python MCP server for Bank of Japan statistics. Access CGPI (Corporate Goods Price Index), TANKAN (Short-term Economic Survey), Flow of Funds, Balance of Payments, and BIS statistics. No API key required. Sister project of edinet-mcp and estat-mcp.
