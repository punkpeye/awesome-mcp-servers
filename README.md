...
- [mrliuzhiyu/textview-mcp](https://github.com/mrliuzhiyu/textview-mcp) 📇 ☁️ 🍎 🪟 🐧 - Persistent memory for AI agents via TextView cloud. Save, search, and retrieve documents across sessions. Works with Claude, Cursor, Windsurf, and any MCP client.
