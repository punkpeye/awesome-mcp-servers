...
- [elestirelbilinc-sketch/vap-showcase](https://github.com/elestirelbilinc-sketch/vap-showcase) 🐍 ☁️ 🍎 🪟 🐧 - Execution control layer for AI agents calling paid APIs. Pre-commit pricing, budget enforcement, deterministic retry behavior. Images ($0.18), Videos ($1.96), Music ($0.68).
