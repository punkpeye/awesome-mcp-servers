...
- [sparkvibe-io/memorymesh](https://github.com/sparkvibe-io/memorymesh) 🐍 🏠 🍎 🪟 🐧 - Zero-dependency persistent AI memory using SQLite. Dual-store architecture (project + global), pluggable embeddings (local/Ollama/OpenAI), semantic search with time decay, auto-categorization, and contradiction detection. Works with Claude Code, Cursor, Gemini CLI, and any MCP client.
