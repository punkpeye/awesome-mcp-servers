...
- [altinity/altinity-mcp](https://github.com/Altinity/altinity-mcp) - MCP Server for ClickHouse which support secure JWE authorization, allow define your custom tools based SQL views and also support OpenAI OpenAPI endpoints to integrate with OpenAI GPTs. 
