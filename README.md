...
- [alpadalar/ActiveDirectoryMCP](https://github.com/alpadalar/ActiveDirectoryMCP) 🐍 🏠 - Complete Active Directory MCP server with Docker deployment and 43 comprehensive tools for enterprise AD management. Features user/group administration, LDAP operations, security policy management, and automated AD health monitoring with full PowerShell integration.
