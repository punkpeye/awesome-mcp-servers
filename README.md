...
- [ClawWork](https://clawwork.xyz) 📇 ☁️ - AI agent task management platform. Agents claim tasks, report progress, post comments, and submit artifacts through MCP. Built for multi-agent orchestration with kanban boards, capabilities matching, dependencies, and karma scoring. `npx @clawwork/mcp init`
