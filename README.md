...
- [meltingpixelsai/drainbrain-mcp-server](https://github.com/meltingpixelsai/rugslayer/tree/master/packages/drainbrain-mcp-server) 📇 ☁️ 🍎 🪟 🐧 - AI-powered Solana token rug pull detection. Scan any token for risk using XGBoost + GRU temporal ML ensemble with 4 tools: scan_token, batch_scan, health_check, and compare_rugcheck.
