...
- [sinewaveai/agent-security-scanner-mcp](https://github.com/sinewaveai/agent-security-scanner-mcp) 📇 🏠 - MCP server for security scanning with SQL injection, XSS, secrets detection, prompt injection defense, and AI package hallucination verification.
