...
- [GetPercept/percept](https://github.com/GetPercept/percept) 🐍 🏠 🍎 - Ambient voice intelligence for AI agents. Connects wearable mics (Omi, Apple Watch) to a local voice pipeline with transcription, speaker identification, entity extraction, and a searchable knowledge graph. MCP server exposes 8 tools for conversation search, transcript history, speaker profiles, and pipeline monitoring.
