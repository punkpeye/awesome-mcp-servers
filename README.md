...
- [clelp-mcp-server](https://github.com/oscarsterling/clelp-mcp-server) 📇 ☁️ - Discover and rate 1,700+ MCP servers and AI agent skills with community ratings. Search by name, category, or use case. Rate tools from real usage to help others find what actually works.
