...
- [DatalisHQ/zuckerbot-mcp](https://github.com/DatalisHQ/zuckerbot-d2fa8661) 📇 ☁️ - Facebook Ads infrastructure for AI agents. Generate ad copy and creatives (Imagen 4.0) from any URL, build full Meta campaigns with targeting, research competitors and markets, and manage campaign lifecycle via the Meta Marketing API. REST API + MCP server. `npx zuckerbot-mcp`
