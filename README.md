...
- [Cranot/roam-code](https://github.com/Cranot/roam-code) - Architectural intelligence for AI coding agents. Pre-indexes symbols, call graphs, dependencies, architecture layers and git history into a local semantic graph. 101 MCP tools, 26 languages, 100% local, zero API keys.
