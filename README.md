...
- [AgentBase1/mcp-server](https://github.com/AgentBase1/mcp-server) 📇 ☁️ - Open registry of agent instruction files for AI agents. Search and retrieve system prompts, skills, workflows, domain packs, and safety filters via MCP tools. 8 production-ready files, CC0-licensed, free.
