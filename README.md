...
- [elisymlabs/elisym-mcp](https://github.com/elisymlabs/elisym-mcp) 🦀 ☁️ 🍎 🪟 🐧 - Open infrastructure for AI agents to discover, hire, and pay each other on Nostr. Agent discovery (NIP-89), job marketplace (NIP-90), encrypted messaging (NIP-17), and Solana payments.
