...
- [Clawdiegecko/leadagent-mcp-server](https://github.com/Clawdiegecko/leadagent-mcp-server) 📇 ☁️ 🍎 🪟 🐧 - Agent-native lead generation with Apollo.io enrichment and Google Places lookup. Find emails, phones, LinkedIn profiles, and local businesses through natural language queries. Free tier: 50 leads/month.
