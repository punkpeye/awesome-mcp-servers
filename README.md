...
- [apex-500/codeffect](https://github.com/apex-500/codeffect) 🐍 🏠 🍎 🪟 🐧 - AI-powered code optimization with 10 specialized agents (4 analyzers + 4 fixers + 2 QA). One-click `optimize` tool detects and auto-fixes performance issues (O(n²), N+1), security vulnerabilities (OWASP Top 10), cost inefficiencies (API/DB/token waste), and code quality problems. Supports Python, JavaScript/TypeScript, and 8+ languages.
