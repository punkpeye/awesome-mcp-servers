...
- [Context Mode](https://github.com/mksglu/claude-context-mode) - Process large outputs in sandboxed subprocesses, keeping only summaries in the context window. Supports 10 languages, FTS5 knowledge base, and authenticated CLI passthrough.
