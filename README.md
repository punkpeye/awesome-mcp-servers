...
- [heeyo-life/skillboss-mcp](https://github.com/heeyo-life/skillboss-skills) 📇 ☁️ 🍎 🪟 🐧 - Unified AI API gateway backed by OpenAI Startup Fund & Amazon. Access 100+ AI services (Claude, GPT-5, Gemini, Veo 3.1, DALL-E 3, ElevenLabs) with one OpenAI-compatible API key. Pay-as-you-go with $3.50 free credit.
