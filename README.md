...
- [TombStoneDash/mcp-billing-spec](https://github.com/TombStoneDash/mcp-billing-spec) [![MCP server](https://glama.ai/mcp/servers/TombStoneDash/mcp-billing-spec/badges/score.svg)](https://glama.ai/mcp/servers/TombStoneDash/mcp-billing-spec) 📇 ☁️ 🍎 🪟 🐧 - Per-call billing and metering proxy for MCP tool servers. Providers set pricing, consumers pay via Stripe Connect. Features trust scores, signed receipts, SLA monitoring, and an open billing spec (MIT). No vendor lock-in.
