...
- [nghizas/grounded-mcp](https://github.com/nghizas/grounded-mcp) 🐍 ☁️ - Real-time package versions, download counts, licenses, deprecation status, and service status for 1,000+ npm/PyPI packages and 76 cloud services. Source-attributed, timestamped facts instead of hallucinated answers.
