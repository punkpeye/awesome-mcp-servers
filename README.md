...
- [fastMCP4J](https://github.com/tersePrompts/fastMCP4J) ☕ - Java library for building MCP servers with annotations. Minimal dependencies (12 jars), <500ms startup. Built-in tools: Memory, Todo, Planner, File Read/Write, Bash execution, Telemetry.
