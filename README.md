...
- [avifenesh/agnix](https://github.com/avifenesh/agnix) 🦀 🏠 🍎 🪟 🐧 - Linter and MCP server for AI agent configuration files. Validates MCP configs (*.mcp.json) with 12 protocol compliance rules, plus 156 total rules covering CLAUDE.md, SKILL.md, hooks, .cursorrules, and more. Includes auto-fix, LSP server, and SARIF output.
