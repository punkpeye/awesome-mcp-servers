...
- [alvabillwu/mcp-compliance-lite](https://github.com/alvabillwu/mcp-compliance-lite) - MCP spec conformance tester -- validate JSON-RPC compliance, tool schemas, and error codes against the MCP spec.
- [alvabillwu/mcp-factory](https://github.com/alvabillwu/mcp-factory) - MCP server scaffolding CLI -- generate complete MCP server projects with one command.
- [alvabillwu/mcp-guard](https://github.com/alvabillwu/mcp-guard) - Security scanner for MCP server tool manifests -- detect dangerous capabilities before you connect.
- [alvabillwu/mcp-probe](https://github.com/alvabillwu/mcp-probe) - Probe and inspect any MCP server from the CLI -- discover tools, resources, prompts, and invoke tools with zero dependencies.
- [alvabillwu/mcpindex](https://github.com/alvabillwu/mcpindex) - Searchable index and discovery tool for MCP servers -- aggregate from any registry, dedupe, merge, and relevance-search.
