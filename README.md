...
- [rsdouglas/janee](https://github.com/rsdouglas/janee) 📇 🏠 🍎 🪟 🐧 - Secrets management for MCP servers. Janee encrypts API keys and credentials with AES-256-GCM, injecting them at runtime so AI agents never see plaintext secrets. Features access policies, audit logging, and a CLI for secret lifecycle management.
