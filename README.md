...
- [gitscrum-core/mcp-server](https://github.com/gitscrum-core/mcp-server) 📇 ☁️ 🍎 🪟 🐧 - GitScrum Studio MCP server for project management. Manage tasks, sprints, time tracking, invoicing, proposals, and client workflows with AI assistants.
