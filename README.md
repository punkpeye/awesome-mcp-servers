...
- [pytheum/pytheum-mcp](https://github.com/pytheum/pytheum-mcp) 🐍 📇 ☁️ 🏠 🍎 🪟 🐧 - Point-in-time prediction-market context for AI agents. Four tools route news / social / macro events to relevant Kalshi, Polymarket, and Manifold markets via the public api.pytheum.com endpoint. Install: `npx -y @pytheum/mcp` (Claude Desktop) or `uvx pytheum-mcp` (Cursor / uv-native). Docs: https://github.com/pytheum/pytheum-doc
