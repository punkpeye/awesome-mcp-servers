...
- [lukeslp/mcp-dreamwalker](https://github.com/lukeslp/mcp-dreamwalker) 🐍 🏠 - Multi-agent orchestration for Claude Code via MCP. Deploys parallel research agents across academic, news, technical, and financial sources, synthesizes through hierarchical tiers, and generates PDF/DOCX/Markdown reports with citations.
