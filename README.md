...
- [pramodbhatofficial/databricks-mcp-server](https://github.com/pramodbhatofficial/databricks-mcp-server) 🐍 ☁️ - 263 tools across 28 Databricks service domains including Unity Catalog, SQL, Compute, Jobs, Serving, Vector Search, Apps, Lakebase, and more. SDK-first with selective tool loading and role-based presets.
