...
- [san-npm/mcp-services](https://github.com/san-npm/mcp-services) 📇 ☁️ - Multi-tool MCP server for AI agents — screenshot any URL, generate PDFs, WHOIS/DNS lookup, and multi-chain blockchain data (Ethereum, Base, Arbitrum, Optimism, Polygon, Celo). Free, no API key needed.
