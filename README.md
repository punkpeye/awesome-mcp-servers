...
- [panther-labs/mcp-panther](https://github.com/panther-labs/mcp-panther) 🐍 ☁️ - MCP server that enables security professionals to interact with Panther's platform using natural language for writing detections, querying logs, and managing alerts.
