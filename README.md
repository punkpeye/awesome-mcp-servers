...
* [Oracle Connectorome](https://github.com/qualigenai/mcp-oracle-connector) 📇 🏠 - Enterprise-grade Oracle Database connector for MCP with self-healing retries and AI-guided SQL.
