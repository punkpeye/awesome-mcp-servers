...
- [amitpaz1/formbridge](https://github.com/amitpaz1/formbridge) 📇 🏠 🍎 🪟 🐧 - Mixed-mode form submission infrastructure for AI agents. Agents fill what they know via MCP, humans complete the rest through a web UI with resume tokens, field attribution, and approval workflows.
...
- [amitpaz1/agentgate](https://github.com/amitpaz1/agentgate) 📇 ☁️ 🏠 🍎 🪟 🐧 - Human-in-the-loop approval system for AI agents. Define policies to auto-approve, auto-deny, or route sensitive actions to humans via dashboard, Slack, Discord, or email. Includes SDK, CLI, and webhooks.
