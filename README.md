...
- [taskade/mcp](https://github.com/taskade/mcp) 📇 ☁️ 🍎 🪟 🐧 - AI-powered project management MCP server with 62+ tools for tasks, projects, agents, templates, media, and team collaboration. Works with Claude, Cursor, Windsurf, and VS Code.
