...
- [jghiringhelli/codeseeker](https://github.com/jghiringhelli/codeseeker) 📇 🏠 🍎 🪟 🐧 - Semantic code search and knowledge graph MCP server. Provides hybrid search (vector + text + path), dependency analysis, duplicate/dead code detection, and auto-detected coding standards for Claude Code, Cursor, and Copilot.
