...
- [pixell-global/sayou](https://github.com/pixell-global/sayou) 🐍 🏠 🍎 🪟 🐧 - Persistent knowledge workspace for AI agents. Versioned markdown files with YAML frontmatter, token-budget-aware reads, full-text search, key-value store, and 11 MCP tools. Works with Claude Code, Cursor, and Windsurf.
