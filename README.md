...
- [manavaga/web3-signals-mcp](https://github.com/manavaga/web3-signals-mcp) 🐍 ☁️ - AI-powered crypto signal intelligence for 20 assets. Fuses whale tracking, derivatives, technicals, narrative, and market data into scored 0-100 signals with LLM insights. Free, no API key, SSE transport.
