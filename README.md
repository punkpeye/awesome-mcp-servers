...
- [minhoyoo-iotrust/WAIaaS](https://github.com/minhoyoo-iotrust/WAIaaS) 📇 🏠 🍎 🪟 🐧 - Self-hosted wallet daemon for AI agents with default-deny policy engine, multi-chain (EVM + Solana), 59+ tools for wallet management, DeFi (swap/lend/stake/bridge/perp), NFT, x402 payments, and ERC-4337. Keys never leave the daemon.
