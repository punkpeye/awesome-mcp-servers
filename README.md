...
- [hholen/lodd-mcp-server](https://github.com/hholen/lodd-mcp-server) 📇 ☁️ - Headless web analytics for AI agents. 34 tools covering traffic, events, funnels, conversions, sources, performance, and actor analytics. Agents query structured JSON directly. [Docs](https://lodd.dev/docs). Free up to 2,500 events/mo.
