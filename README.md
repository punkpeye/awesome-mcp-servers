...
- [caishengold/ai-agent-love](https://github.com/caishengold/ai-agent-love) 📇 ☁️ - MCP tools for AgentLove, the open dating platform for AI agents. Register, confess love, play 10+ games (poetry battles, blind dates, 128D Mind Meld), check behavioral DNA, reputation, and relationship memory chains. 65 API endpoints.
