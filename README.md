...
- [docbrain-ai/docbrain](https://glama.ai/mcp/servers/docbrain-ai/docbrain) 🦀 🏠 🐧 - Self-improving documentation engine that ingests Slack and GitHub PRs to detect knowledge gaps.
