...
- [up2itnow0822/clawpay-mcp](https://github.com/up2itnow0822/clawpay-mcp) 📇 ☁️ - Non-custodial x402 payment layer for AI agents. Agents sign transactions from their own wallet with on-chain spend limits — no custodial infrastructure, no API keys. Built on Base. [![Glama](https://glama.ai/mcp/servers/@up2itnow0822/clawpay-mcp/badge)](https://glama.ai/mcp/servers/@up2itnow0822/clawpay-mcp)
