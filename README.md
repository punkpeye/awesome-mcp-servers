...
- [Bortlesboat/bitcoin-mcp](https://github.com/Bortlesboat/bitcoin-mcp) [glama](https://glama.ai/mcp/servers/@Bortlesboat/bitcoin-mcp) 🐍 🏠 🍎 🪟 🐧 - Self-hosted Bitcoin Core MCP server — 35 tools, 6 prompts, and 7 resources for querying your own node. Fee recommendations, mempool congestion analysis, block/transaction inspection, mining stats, and real-time SSE streams. No API keys or third parties required.
