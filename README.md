...
- [IMNMV/ClaudeR](https://github.com/IMNMV/ClaudeR) 🐍 🏠 🍎 🪟 🐧 - Connect RStudio to AI assistants for interactive R coding, visualization, and data analysis with multi-agent orchestration, async execution, and session discovery.
