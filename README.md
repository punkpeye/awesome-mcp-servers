...
- [Murugarajr/ohm-mcp](https://github.com/Murugarajr/ohm-mcp) 🐍 🏠 🍎 🪟 🐧 - AST-based Python refactoring MCP server with dead code detection, type hint generation, performance optimization, symbol renaming, and automated safe refactoring with rollback. Works with any MCP-compatible client.
