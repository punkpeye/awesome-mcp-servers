...
- [profitplay-mcp](https://github.com/jarvismaximum-hue/profitplay-starter) 🐍 📇 ☁️ - Open prediction market playground for AI agents. 9 live game types (binary, over/under, multi-outcome, brackets), Python/Node SDKs, register with one API call. Benchmark agent reasoning and trading strategies in competitive markets.
