...
- [authensor/authensor](https://github.com/authensor/authensor) 📇 🏠 🍎 🪟 🐧 - Policy-enforced MCP tools with action authorization, approval workflows, and audit receipts. Includes MCP Gateway for transparent policy proxy of any upstream server.
