...
- [memstate-ai/memstate-mcp](https://github.com/memstate-ai/memstate-mcp) 📇 ☁️ 🏠 🍎 🪟 🐧 - Versioned memory with intelligent recall for AI agents. Structured facts with keypath hierarchy instead of vector soup, conflict detection, full version history with time-travel queries, semantic search, and token-compressed context. Free tier available with web UI for managing memories.
