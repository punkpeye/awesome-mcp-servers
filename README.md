...
- [bibinprathap/VeritasGraph](https://github.com/bibinprathap/VeritasGraph/tree/master/mcp/powerbi-mcp) 🐍 ☁️ 🏠 🪟 - Enterprise MCP server for Power BI with 34+ tools, natural language DAX queries, dual Desktop/Cloud connectivity, and security features. ([demo](https://www.youtube.com/watch?v=dt4ubeCLmtQ))
