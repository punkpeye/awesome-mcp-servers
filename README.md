...
- [Ruya-AI/cozempic](https://github.com/Ruya-AI/cozempic) [![Ruya-AI/cozempic MCP server](https://glama.ai/mcp/servers/Ruya-AI/cozempic/badges/score.svg)](https://glama.ai/mcp/servers/Ruya-AI/cozempic) 🐍 🏠 - Context weight-loss for Claude Code — diagnose, treat, and guard sessions, protect Agent Teams from compaction loss. Self-updating, atomic writes, strict session guard.
