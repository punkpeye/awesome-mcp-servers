...
- [get-cotrader/cotrader-mcp](https://github.com/get-cotrader/cotrader-mcp) ☁️ - AI-powered stock screener for 11,000+ US stocks. Screen using natural language queries (e.g., "RSI under 30 with price above 200 EMA") and detect chart patterns including support/resistance, trendlines, channels, double bottoms, pennants, and head & shoulders.
