...
- [contentapi-mcp-server](https://www.npmjs.com/package/contentapi-mcp-server) 📇 ☁️ - Extract content from YouTube (transcripts), web pages, Twitter/X, and Reddit via a single unified API. Built for RAG pipelines and AI agents with built-in chunking, batch processing, and structured content trees. Free tier: 5,000 requests/month. ([getcontentapi.com](https://getcontentapi.com))
