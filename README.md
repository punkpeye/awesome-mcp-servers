...
- [marlinjai/email-mcp](https://github.com/marlinjai/email-mcp) 📇 ☁️ 🍎 🪟 🐧 - Unified email MCP server with 24 tools for Gmail, Outlook, iCloud, and IMAP. Native batch operations for bulk delete/move/mark, lightweight search mode, OAuth2 flows, and encrypted credential storage.
