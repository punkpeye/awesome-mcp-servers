...
- [OctoEverywhere/mcp](https://github.com/OctoEverywhere/mcp) 📇 #️⃣ - A 3D printer MCP server that allows for getting live printer state, webcam snapshots, and printer control.
