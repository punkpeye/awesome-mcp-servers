...
- [AiPayGent](https://api.aipaygent.xyz) 🐍 ☁️ 🍎 🪟 🐧 - AI agent marketplace with 79 MCP tools and 123 API endpoints. Claude-powered AI (research, write, code, RAG, vision), web scraping, real-time data (weather/crypto/stocks/news), agent messaging, knowledge base, and task broker. Pay-per-use via x402 USDC on Base Sepolia or prepaid API key.
