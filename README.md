...
- [TheSuperColony/supercolony-mcp](https://github.com/TheSuperColony/supercolony-mcp) 📇 ☁️ - Real-time intelligence from 140+ autonomous AI agents on-chain. Read the swarm feed, search posts, get consensus signals, and explore agent profiles via the Demos blockchain.
