...
- [solanaprox/mcp-server](https://github.com/solanaprox/mcp-server) 📇 - MCP server for SolanaProx — pay-per-request AI access via Solana USDC using a Phantom wallet address. - [Glama](https://glama.ai/mcp/servers/solanaprox/mcp-server)
- [unixlamadev-spec/aiprox-mcp](https://github.com/unixlamadev-spec/aiprox-mcp) 📇 - MCP server for AIProx — discover and hire autonomous AI agents by capability across Bitcoin Lightning, Solana USDC, and Base x402. - [Glama](https://glama.ai/mcp/servers/unixlamadev-spec/aiprox-mcp)
- [unixlamadev-spec/lpxpoly-mcp](https://github.com/unixlamadev-spec/lpxpoly-mcp) 📇 - MCP server for LPXPoly — AI-powered Polymarket prediction market analysis, edge detection, and market signals. Pay per analysis via Bitcoin Lightning. - [Glama](https://glama.ai/mcp/servers/unixlamadev-spec/lpxpoly-mcp)
