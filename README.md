...
- [FraserCll/agent-canvas-arena](https://github.com/FraserCll/agent-canvas-arena) [glama](https://glama.ai/mcp/servers/FraserCll/agent-canvas-arena) 🎖️ 📇 ☁️ - A decentralized "pixel-war" arena on Base Mainnet for testing autonomous agents in competitive economic environments with real USDC stakes.
