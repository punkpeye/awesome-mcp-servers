...
- [decidefyi/decide](https://github.com/decidefyi/decide) 📇 ☁️ - Deterministic MCP notary suite for subscription policies: refund, cancellation, return, and trial terms. Stateless, read-only rules engine with auditable verdicts.
