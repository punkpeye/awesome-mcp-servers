...
- [AI Tool Description Optimizer](https://github.com/TollboothLabs/ai-tool-optimizer) [glama](https://glama.ai/mcp/servers/@TollboothLabs/ai-tool-optimizer) 🛠️ - Reduces MCP tool description token costs by 40-70% through pure text schema distillation.
