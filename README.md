...
- [thebasedcapital/brainbox](https://github.com/thebasedcapital/brainbox) 📇 🏠 🍎 🪟 🐧 - Hebbian memory for AI agents. Learns file access patterns, builds neural pathways through spreading activation, predicts next tools and files, saves tokens. Works as MCP server, Claude Code hooks, or Kilo Code plugin.
