...
- [ajtgjmdjp/boj-mcp](https://github.com/ajtgjmdjp/boj-mcp) 🐍 ☁️ - Access Bank of Japan statistics (CGPI, TANKAN, Flow of Funds, Balance of Payments, BIS). 16 flat file datasets with automatic Shift_JIS handling. No API key required. Published on [PyPI](https://pypi.org/project/boj-mcp/). Sister project of edinet-mcp and estat-mcp.
