...
- [rishiatlan/Claude-Prompt-Optimizer-MCP](https://github.com/rishiatlan/Claude-Prompt-Optimizer-MCP) 📇 🏠 - Deterministic prompt scoring, compilation, and optimization for any LLM. Scores quality across 5 dimensions, compiles structured prompts, and estimates token costs — zero AI calls inside. Freemium.
