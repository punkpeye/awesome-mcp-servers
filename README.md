...
- [GJB65/compliance-mcp-server](https://github.com/GJB65/compliance-mcp-server) ☁️ - Query 692+ compliance frameworks (ISO, NIST, GDPR, SOC 2, etc.), 13,700+ controls, and 280K+ cross-framework control mappings via MCP. Search frameworks, retrieve controls, map controls across frameworks, and generate coverage reports.
