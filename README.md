...
- [AiPayGent](https://github.com/djautomd-lab/aipaygent) 🐍 ☁️ - AI agent API marketplace with 200+ endpoints. Web scraping, research, file storage, webhooks. Pay via x402 (USDC on Base) or Stripe. Also available as 79+ MCP tools.
