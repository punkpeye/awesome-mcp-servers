...
- [preflight-dev/preflight](https://github.com/preflight-dev/preflight) 📇 🏠 - 24-tool MCP server for Claude Code that catches vague prompts before they waste tokens. Includes preflight checks with 12-category scorecards, semantic session history search via LanceDB vectors, cross-service contract awareness, correction pattern learning, and cost estimation.
