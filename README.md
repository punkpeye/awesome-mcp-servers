...
- [granular-software/mcpresso](https://github.com/granular-software/mcpresso) - OAuth 2.1 authentication framework for MCP servers with user management, JWT tokens, and database-backed session management
