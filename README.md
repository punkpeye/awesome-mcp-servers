...
- [jimmyracheta/ai-runtime-guard](https://github.com/jimmyracheta/ai-runtime-guard) [glama](https://glama.ai/mcp/servers/jimmyracheta/ai-runtime-guard) 🐍 🏠 🍎 🐧 - Policy enforcement layer for MCP agents. Blocks dangerous commands, gates risky operations behind human approval, simulates blast radius for wildcard actions, automatic backup of altered files and maintains a full audit trail — without modifying your agent or workflow.
