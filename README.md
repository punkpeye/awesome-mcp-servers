...
- [OzorOwn/defi-mcp](https://github.com/OzorOwn/defi-mcp) 📇 ☁️ 🏠 - DeFi MCP server: token prices (CoinGecko), multi-chain wallet balances, EVM gas prices across 6 chains, and DEX swap quotes via 1inch (EVM) + Jupiter (Solana). No API key required for basic usage.
