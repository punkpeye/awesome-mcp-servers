...
- [albertnahas/icogenie](https://github.com/albertnahas/icogenie) 📇 ☁️ - AI-powered SVG icon generation MCP server. Generate production-ready icons from text descriptions with support for single icons, bundles, style customization, and regeneration.
