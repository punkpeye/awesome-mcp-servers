...
* [sigil-eu/sigil-py](https://github.com/sigil-eu/sigil-py) 🐍 🏠 🍎 🪟 🐧 - SIGIL — security middleware for AI agent tool calls. Secret scanning (43+ patterns: AWS, OpenAI, GitHub, PII, prompt injection), policy enforcement, and tamper-evident audit logging for MCP, LangChain, CrewAI, AutoGen, and OpenAI Agents. MIT licensed.
