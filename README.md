...
- [preflight-dev/preflight](https://github.com/preflight-dev/preflight) 📇 🏠 - 24-tool MCP server for Claude Code that catches vague prompts before they waste tokens. Features 12-category scorecards, semantic session history search with LanceDB vectors, cross-service contract awareness, correction pattern learning, and cost estimation. Built from analysis of 512 real Claude Code sessions.
