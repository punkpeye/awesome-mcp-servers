...
- [odei-ai/mcp-odei](https://github.com/odei-ai/mcp-odei) 📇 ☁️ - Constitutional knowledge graph for AI agents. Query a 7-layer world model (91 nodes), run safety guardrail checks (APPROVED/REJECTED/ESCALATE), and audit EVM smart contracts. Production since Jan 2026.
