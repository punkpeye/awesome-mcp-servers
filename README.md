...
- [mgorunuch/memgraph-mcp-server](https://github.com/mgorunuch/memgraph-mcp-server) 🏎️ 🏠 - Go implementation of Memgraph MCP Server with Homebrew integration and built-in safety controls for destructive queries.- [modelcontextprotocol/server-postgres](https://github.com/modelcontextprotocol/servers/tree/main/src/postgres) 📇 🏠 - PostgreSQL database integration with schema inspection and query capabilities
