...
- [Docat0209/mcp-openapi](https://github.com/Docat0209/mcp-openapi) 📇 ☁️ 🏠 🍎 🪟 🐧 - Zero-config OpenAPI/Swagger to MCP tools converter. Point at any spec URL and get instant MCP tools with LLM-optimized flat parameter schemas, built-in auth (Bearer, API key, OAuth2), auto-retry, and smart response truncation.
