...
- [skyvanguard/infra-ops-mcp](https://github.com/skyvanguard/infra-ops-mcp) 📇 ☁️/🏠 🍎 🪟 🐧 - The most comprehensive infrastructure MCP server with 92 tools across 13 categories: system monitoring, Docker/Kubernetes, multi-cloud (AWS/Azure/GCP), databases (PostgreSQL/MySQL/MongoDB/Redis), CI/CD (GitHub Actions/GitLab), IaC (Terraform/Ansible/Pulumi), security scanning, SSH fleet management, DNS, backups, and monitoring. Features a 3-tier permission model and cross-platform support.
