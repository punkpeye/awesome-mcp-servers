...
- [Docat0209/mcp-graphql](https://github.com/Docat0209/mcp-graphql) [glama](https://glama.ai/mcp/servers/Docat0209/mcp-graphql) 📇 ☁️ 🏠 🍎 🪟 🐧 - Zero-config GraphQL to MCP tools converter. Auto-discovers queries and mutations via introspection, flattens nested InputObject types for better LLM accuracy, with retry logic and smart truncation.
- [Docat0209/mcp-openapi](https://github.com/Docat0209/mcp-openapi) [glama](https://glama.ai/mcp/servers/Docat0209/mcp-openapi) 📇 ☁️ 🏠 🍎 🪟 🐧 - Zero-config OpenAPI/Swagger to MCP tools converter. Point at any spec URL and get instant MCP tools with LLM-optimized flat parameter schemas, built-in auth (Bearer, API key, OAuth2), and smart response truncation.
