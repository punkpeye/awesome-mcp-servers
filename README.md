...
- [pyroprompts/mcp-stdio-to-streamable-http-adapter](https://github.com/pyroprompts/mcp-stdio-to-streamable-http-adapter) - Connect to Streamable HTTP MCP Servers even if the MCP Client only supports STDIO.
