...
- [jcc-ne/mcp-skill-server](https://github.com/jcc-ne/mcp-skill-server) 🐍 🏠 🍎 🪟 🐧 - Build MCP skills with rapid local iteration — skip the deploy-test-redeploy cycle and ship securely when ready.
