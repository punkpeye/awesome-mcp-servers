...
- [khadinakbaronline/telegram-channel-scraper-mcp](https://github.com/khadinakbaronline/telegram-channel-scraper-mcp) 📇 ☁️ 🏠 🍎 🪟 🐧 - Scrape public Telegram channels for messages, emails, leads, and channel metadata. No Telegram login or API key required. Features incremental scraping, related channel discovery, and lead extraction. Powered by Apify.
