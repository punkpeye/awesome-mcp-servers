...
- [sooda-ai/sooda-mcp](https://github.com/sooda-ai/sooda-mcp) 🏎️ ☁️ - Connect AI agents to business agents across company boundaries via Google's A2A protocol. Discover agents, relay messages, browse the network, manage connections, and track conversations through Sooda's platform.
