...
- [signerlabs/ShipSwift](https://github.com/signerlabs/ShipSwift) 📇 ☁️ - AI-native SwiftUI recipe library with 40+ production-ready code recipes for building full-stack iOS apps. Covers animations, charts, UI components, and full-stack modules (auth, subscriptions, camera, chat) with backend code via MCP tools.
