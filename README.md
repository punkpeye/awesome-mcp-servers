...
- [mnardit/agent-recall](https://github.com/mnardit/agent-recall) 🐍 🏠 🍎 🪟 🐧 - Persistent memory and AI briefings for coding agents. SQLite knowledge graph with scoped entities, observations, and relations. LLM-summarized context injected at session start. Drop-in MCP server for Claude Code, Cursor, Windsurf, and Cline.
