...
- [Skyvern-AI/skyvern](https://github.com/Skyvern-AI/skyvern) [![skyvern MCP server](https://glama.ai/mcp/servers/Skyvern-AI/skyvern/badges/card.svg)](https://glama.ai/mcp/servers/Skyvern-AI/skyvern) 🐍 ☁️ 🏠 🍎 🪟 🐧 – AI-powered browser automation MCP server that lets agents control a real browser to navigate sites, fill forms, extract structured data, and run multi-step workflows.
