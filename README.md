...
- [TarteelAI/tarteel-mcp-server](https://mcp.tarteel.ai/mcp) 📇 ☁️ - Quran-focused MCP server for ayah translation, tafsir, mutashabihat lookups, recitation playlists, and prayer times. [glama](https://glama.ai/mcp/connectors/io.github.Khaled-Abdelhamid/tarteel-mcp-server)
