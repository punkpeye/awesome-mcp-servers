...
- [Phos Labs Commerce Intelligence](https://mcp.phoslabs.io) - Commerce intelligence for AI agents: diagnose customer
  drop-offs, fix checkout flows, optimize pricing, predict churn, and run behavioral experiments. 23 tools, pay-per-use
