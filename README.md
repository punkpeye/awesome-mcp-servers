...
- [muvon/octocode](https://github.com/Muvon/octocode) [glama](https://glama.ai/mcp/servers/Muvon/octocode) 🦀 🏠 🍎 🪟 🐧 - Semantic code indexer with GraphRAG knowledge graph. Index your codebase, search in natural language, and expose everything via MCP so AI agents understand architecture — not just files.
