...
- [amichail-1/Orbination-AI-Desktop-Vision-Control](https://github.com/amichail-1/Orbination-AI-Desktop-Vision-Control) 🏠 🪟 - Native Windows desktop automation for AI agents. 45+ tools using UIAutomation + OCR (with dark theme auto-enhancement) instead of screenshots. Includes batch action sequencing, window occlusion detection, and embedded AI workflow instructions.
