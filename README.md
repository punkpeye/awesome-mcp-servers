...
- [mgantlett/sophia-blueprint-mcp](https://github.com/mgantlett/sophia-blueprint-mcp) 🐍 ☁️ - 9-chapter cognitive AI agent architecture blueprint. Query battle-tested patterns for routing, memory, autonomics, identity evolution, and dreaming directly via MCP. Built from a production system running 24/7. [Hosted endpoint](https://sophialabs.gantlett.io/blueprint/mcp).
