...
- [SparkForge](https://sparkforge.sh) 📇 ☁️ - 20+ pay-per-use utility APIs with x402 micropayments — image generation, crypto prices & news summarization, tweet writing, email verification, domain/SSL checks, web scraping, screenshots, code review, text-to-speech, and more. Free MCP server. No API key needed — pay USDC per call.
