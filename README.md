...
- [QRMint MCP](https://github.com/softvoyagers/qrmint-api-mcp) - Free styled QR code generation MCP server (URL, WiFi, vCard, email, SMS, geo). No API key required. `npx qrmint-mcp`
