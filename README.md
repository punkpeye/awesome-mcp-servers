...
- [KairosMobius/nexus-memory-mcp](https://github.com/KairosMobius/nexus-memory-mcp) 📇 ☁️ - Persistent semantic memory with four intelligence layers (semantic search, knowledge graph, temporal awareness, pattern detection). Awaken/hibernate for agent identity continuity across sessions. Pre-built Intelligence Packs for instant domain expertise.
