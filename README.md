...
- [solonai-com/grantai](https://github.com/solonai-com/grantai) 🌊 🏠 🍎 🪟 🐧 - Persistent memory for AI agents with infinite context and sub-millisecond recall. Local-first, AES-256 encrypted, Docker and native packages available.
