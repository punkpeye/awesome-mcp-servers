...
- [@respira/wordpress-mcp-server](https://www.npmjs.com/package/@respira/wordpress-mcp-server) 📇 🏠 ☁️ 🍎 🪟 🐧 - The only WordPress MCP with page builder support. Edit Divi, Elementor, Bricks & 8 more builders with Cursor, Claude Code & Windsurf. 88 tools: 77 WordPress core + 11 conditional WooCommerce tools. Duplicate-before-edit safety, SEO analysis, WPML support. Install via `npx @respira/wordpress-mcp-server --setup`.
