...
- [OilpriceAPI/mcp-server](https://github.com/OilpriceAPI/mcp-server) 📇 ☁️ - Real-time oil, gas, and commodity prices from OilPriceAPI. 40+ energy commodities with natural language queries, subscribable price resources, and analyst prompt templates.
