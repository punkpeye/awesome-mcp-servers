...
- [Money by Parsons.AI](https://money.parsons.ai/api/mcp) 📇 ☁️ - Personal finance MCP server with bank sync via Plaid — query transactions, create budgets, track subscriptions, and monitor net worth with OAuth 2.1 authentication.
