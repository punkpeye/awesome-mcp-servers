...
- [yuvalsuede/memory-mcp](https://github.com/yuvalsuede/memory-mcp) 📇 🏠 🍎 🪟 🐧 - Persistent memory for Claude Code CLI. Silent auto-capture via hooks, Haiku-powered extraction, smart dedup, confidence decay, and mid-session recall via MCP tools.
