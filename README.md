...
- [oculo](https://github.com/xidik12/oculo) 📇 🏠 🍎 🪟 🐧 - AI-powered native browser with 12 MCP tools. Controls the live browser — navigate, click, fill forms, extract data, generate media, run multi-step pipelines. ~30 tokens per page. Autonomous mode, self-healing selectors, 19 stealth patches.
