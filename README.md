...
- [dddabtc/winremote-mcp](https://github.com/dddabtc/winremote-mcp) [![dddabtc/winremote-mcp MCP server](https://glama.ai/mcp/servers/dddabtc/win-remote-mcp/badges/score.svg)](https://glama.ai/mcp/servers/dddabtc/win-remote-mcp) 🐍 🏠 🪟 - Windows remote desktop control and automation via MCP. 40+ tools for screenshots, mouse/keyboard control, file operations, registry, services, OCR, screen recording, and more.
