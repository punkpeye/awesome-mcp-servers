...
- [bzsasson/screaming-frog-mcp](https://github.com/bzsasson/screaming-frog-mcp) 🐍 🏠 🍎 🪟 🐧 - Screaming Frog SEO Spider integration for technical SEO audits. Crawl websites, export crawl data (internal links, response codes, page titles, meta descriptions, etc.), and manage crawl storage through AI assistants.
