...
- [btouchard/herald](https://github.com/btouchard/herald) 🏎️ 🏠 🍎 🪟 🐧 - Self-hosted MCP bridge between Claude Chat and Claude Code. Orchestrate Claude Code tasks asynchronously from/to Claude.ai with 10 tools for task management, Git branching, multi-project support, and OAuth2 security.
