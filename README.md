...
- [cordum-io/cordum](https://github.com/cordum-io/cordum) 🏎️ 🏠 ☁️ 🍎 🪟 🐧 - Safety-first agent orchestration MCP server with pre-dispatch policy evaluation (deny/escalate/allow), output scanning (PII, secrets, injection), job scheduling, workflow engine, and full audit trail. Supports stdio and HTTP/SSE transport.
