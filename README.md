...
- [CycleChain/skillnet-mcp](https://github.com/CycleChain/skillnet-mcp) 🐍 🏠 - Transform diverse sources into structured AI skills, evaluate them, and map skill relationships.
