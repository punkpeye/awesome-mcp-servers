...
- [Mtehabsim/ScreenPilot](https://github.com/Mtehabsim/ScreenPilot) 🐍 🏠 - System-level automation - MCP server enabling AI to fully control and access GUI interaction by providing tools for mouse and keyboard, ideal for general automation, education, and experimentation.
## Frameworks
