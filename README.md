...
- [SCGIS-Wales/helm-mcp](https://github.com/SCGIS-Wales/helm-mcp) 🏎️ 🏠 🍎 🪟 🐧 - An MCP server giving AI assistants full access to Helm — the Kubernetes package manager. Built with the native Helm Go SDK, supporting both Helm v3 and v4 with 44 tools across release management, chart operations, repository management, and more.
