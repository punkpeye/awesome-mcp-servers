...
- [RailPush](https://github.com/muniravila-dotcom/Railpush) 📇 ☁️ 🏠 🍎 🪟 🐧 - AI-native cloud platform (PaaS) with 218 MCP tools for deploying services, managing databases (PostgreSQL, MySQL, MongoDB, Redis, Meilisearch, S3), configuring domains, auto-scaling, and blue-green/canary deployments. Hosted server at mcp.railpush.com.
