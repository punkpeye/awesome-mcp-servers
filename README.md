...
- [JJerryChoi/apex-memory](https://github.com/JJerryChoi/apex-memory) 📇 🏠 🍎 🪟 🐧 - Persistent memory for AI coding agents. Saves decisions, bugs, patterns, and context across sessions. Ultra-lightweight (46 kB), SQLite-backed, zero infrastructure. Works with Claude Code, Cursor, Windsurf, Cline.
