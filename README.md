...
- [0xbrainkid/agentfolio-mcp-server](https://github.com/0xbrainkid/agentfolio-mcp-server) 📇 ☁️ 🍎 🪟 🐧 - Identity and trust layer for AI agents. 8 tools for agent profile lookup, trust score verification, skill-based search, marketplace job browsing, and leaderboard rankings via AgentFolio. SATP on-chain identity on Solana.
