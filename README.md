...
- [elara-core](https://github.com/aivelikivodja-bot/elara-core) 🐍 🏠 🐧 🍎 🪟 - Persistent presence, mood, memory, and self-awareness for AI assistants. 34 MCP tools across 11 modules: semantic memory (ChromaDB), episodic tracking, mood system, dream processing, reasoning trails, corrections, goal tracking, Gmail integration. [Docs](https://elara.navigatorbuilds.com)
