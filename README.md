...
- [commune](https://github.com/shanjairaj7/commune-skill) 📧 ☁️ - Agent-native email API. Gives AI agents a permanent @commune.ai email address with full send/receive, semantic search, triage, HMAC-signed webhooks, and agentless Ed25519 registration. Purpose-built for the agent ecosystem — no OAuth, no browser, no human verification.
