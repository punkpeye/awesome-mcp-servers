...
- [EyevinnOSC/mcp-server](https://github.com/EyevinnOSC/mcp-server) 📇 ☁️ - Deploy and manage 200+ open-source services (databases, storage, media processing, AI) on Eyevinn Open Source Cloud. Provision PostgreSQL, MinIO, ClickHouse, SVT Encore, and more via natural language. Zero vendor lock-in — every service is unmodified open source.
