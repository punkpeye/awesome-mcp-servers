...
- [ebrunet001/lol-mcp](https://github.com/ebrunet001/lol-mcp) 📇 ☁️ - Connect AI assistants to League of Legends data with 13 tools for player profiles, ranked stats, match history, champion mastery, live game scouting, and AI-powered coaching via Apify.
- [ebrunet001/tft-mcp](https://github.com/ebrunet001/tft-mcp) 📇 ☁️ - Connect AI assistants to Teamfight Tactics data with 10 tools for player profiles, ranked stats, match history, composition analysis, augment optimization, and AI coaching via Apify.
...
- [ebrunet001/espn-mcp](https://github.com/ebrunet001/espn-mcp) 📇 ☁️ - Access live ESPN sports data across 25+ leagues with 12 tools for scores, standings, stats, odds, news, schedules, and athlete profiles. No ESPN account required. Hosted on Apify.
...
- [ebrunet001/todoist-mcp-server](https://github.com/ebrunet001/todoist-mcp-server) 📇 ☁️ - Connect AI assistants to Todoist with 35 tools for task management, project organization, labels, comments, and AI-powered features like smart prioritization, focus mode, and daily digest. Natural language in 4 languages. Hosted on Apify.
