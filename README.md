...
- [ESPN MCP Server](https://apify.com/scrapmania/espn-mcp-server) 📇 ☁️ - Real-time ESPN sports data including live scores, standings, game summaries, betting odds, player stats, and news for 25+ leagues (NFL, NBA, MLB, NHL, Premier League, and more).
