...
- [Vigile-ai/vigile-mcp](https://github.com/Vigile-ai/vigile-mcp) 📇 ☁️ - Query trust scores for MCP servers and agent skills. Check if a tool is safe before installing it. Powered by the Vigile AI Security trust registry.
