...
- [Sundeepg98/mcp-server-unipile](https://github.com/Sundeepg98/mcp-server-unipile) 🐍 ☁️ 🍎 🪟 🐧 - The most comprehensive Unipile API MCP server with 95 tools. Unified messaging (LinkedIn, WhatsApp, Instagram, Telegram), email (Gmail, Outlook), calendar, LinkedIn search (people, companies, posts, jobs), profile management, connections, InMail, posts, webhooks, and more.
