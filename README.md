...
- [srclight/srclight](https://github.com/srclight/srclight) 🐍 🏠 - Deep code indexing MCP server with SQLite FTS5, tree-sitter, and embeddings. 25 tools for symbol search, call graphs, git intelligence, and hybrid semantic search.
