...
- [alex-ai-eu/aiqaramba](https://github.com/alex-ai-eu/aiqaramba) 🏎️ ☁️ - Browser-based QA testing for AI-built software. Create agents that open real browsers, navigate pages, fill forms, and report what works and what's broken. Supports targeted tests (30-90s) and full-site discovery scans (3-15min). x402 USDC micropayments — no signup needed.
