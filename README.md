...
- [BigJai/opendirectories-mcp](https://github.com/BigJai/opendirectories-mcp) 🐍 ☁️ - Search 12M+ verified businesses across 10 countries. Government-sourced (ASIC, NDIS, CMS, Companies House), enriched with Google Maps ratings. 6 tools for lead generation, competitive analysis, market research, and business verification.
