...
- [OdellMoreno/uber-apk-signer-mcp](https://github.com/OdellMoreno/uber-apk-signer-mcp)🤖🔏🗝️✅ - An MCP (Model Context Protocol) server that allows you to sign APK files, verify signatures, manage keystores, and perform other APK signing operations directly from your chat interface.
