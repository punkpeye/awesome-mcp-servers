...
- [socialinteldev/social-intel-mcp](https://github.com/socialinteldev/social-intel-mcp) 🐍 ☁️ - Instagram influencer search with pay-per-request via x402 (USDC on Base). Find leads by keyword, country, gender, or follower count. No API keys needed.
