...
- [ContextForge](https://contextforge.dev) 📇 ☁️ 🍎 🪟 🐧 - Persistent memory for AI coding agents with semantic search, Git integration, task tracking, and team collaboration. Web dashboard for managing knowledge across projects.
