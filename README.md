...
- [jtalk22/slack-mcp-server](https://github.com/jtalk22/slack-mcp-server) 📇 ☁️ 🏠 🍎 🪟 🐧 - Session-based Slack MCP for Claude. Local-first stdio/web, secure-default hosted HTTP in v3. DMs, channels, threads, and search with your existing Slack session.
