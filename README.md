...
- [heeyo-life/skillboss-mcp](https://github.com/heeyo-life/skillboss-mcp) 📇 ☁️ 🍎 🪟 🐧 - Unified AI gateway for 100+ services (Claude, GPT, Gemini, DALL-E, Midjourney, Runway, ElevenLabs). One API key, OpenAI-compatible. Switch LLMs, generate images/videos/voice with same code.
