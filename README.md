...
- [KGT24k/config-guard](https://github.com/KGT24k/config-guard) 🔍 🛡️ ☁️ - Zero-dependency security linter for MCP configurations. 22 checks mapped to OWASP MCP Top 10, CVE detection, malicious package scanning, policy-as-code support, and SARIF output for CI/CD integration.
