...
- [PurpleSquirrelMedia/guardrails-mcp-server](https://github.com/PurpleSquirrelMedia/guardrails-mcp-server) 📇 ☁️ - MCP server for IBM watsonx Guardrails AI risk detection, enabling content moderation and safety checks through AI assistants.
- [PurpleSquirrelMedia/ibmcloud-mcp-server](https://github.com/PurpleSquirrelMedia/ibmcloud-mcp-server) 📇 ☁️ - IBM Cloud infrastructure management through MCP, supporting VPC, compute, storage, and Kubernetes operations.
- [PurpleSquirrelMedia/ibmz-mcp-server](https://github.com/PurpleSquirrelMedia/ibmz-mcp-server) 📇 ☁️ - MCP server for IBM Z mainframe operations, enabling AI assistants to interact with z/OS systems and manage mainframe workloads.
- [PurpleSquirrelMedia/mega-mcp-server](https://github.com/PurpleSquirrelMedia/mega-mcp-server) 📇 ☁️ - Aggregated MCP server combining multiple enterprise cloud integrations into a unified interface.
- [PurpleSquirrelMedia/oracle-mcp-server](https://github.com/PurpleSquirrelMedia/oracle-mcp-server) 📇 ☁️ - Oracle Cloud Infrastructure (OCI) management through MCP, supporting compute, networking, storage, and database operations.
- [PurpleSquirrelMedia/volcengine-mcp](https://github.com/PurpleSquirrelMedia/volcengine-mcp) 📇 ☁️ - ByteDance Volcengine cloud platform integration, enabling AI assistants to manage cloud resources on China's leading cloud provider.
- [PurpleSquirrelMedia/watsonx-mcp-server](https://github.com/PurpleSquirrelMedia/watsonx-mcp-server) 📇 ☁️ - IBM watsonx.ai integration for MCP, providing access to foundation models, prompt engineering, and AI workflows.
