...
- [Arcology Knowledge Node](https://github.com/YourLifewithAI/Lifewithai/tree/main/mcp) [glama](https://glama.ai/mcp/connectors/io.github.YourLifewithAI/arcology-knowledge-node) 🐍 ☁️ - Engineering knowledge base for a speculative mile-high city. 8 domains, 32 entries, 140+ open questions, 420+ quantitative parameters. Read-only tools for search, cross-referencing, and consistency checking. Streamable HTTP endpoint at arcology-mcp.fly.dev/mcp.
