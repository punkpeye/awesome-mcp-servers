...
- [structured-world/gitlab-mcp](https://github.com/structured-world/gitlab-mcp) 📇 ☁️ 🏠 - GitLab MCP server with 44 tools across 18 entity types, CQRS architecture, OAuth 2.1, and multiple transports (stdio, SSE, StreamableHTTP).
