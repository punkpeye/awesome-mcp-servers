...
- [bethington/ghidra-mcp](https://github.com/bethington/ghidra-mcp) ☕ 🐍 🏠 🍎 🪟 🐧 - Production-grade Ghidra MCP server with 110 tools for AI-powered reverse engineering. Features cross-binary function documentation transfer via normalized hash index, batch operations (93% API reduction), headless server support, Docker deployment, and automated analysis pipelines.
