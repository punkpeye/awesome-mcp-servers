...
- [kraiter/mcp-server](https://www.npmjs.com/package/@kraiter/mcp-server) 📇 ☁️ - Email automation platform with 62 tools for managing contacts, drip campaigns, transactional sends, segments, templates, and metrics. Supports custom domains and event-driven sequences via natural language.
