...
- [star-ga/mind-mem](https://github.com/star-ga/mind-mem) 🐍 🏠 🍎 🪟 🐧 - Persistent, auditable, contradiction-safe memory for coding agents. Hybrid BM25 + vector retrieval, 18 MCP tools, co-retrieval graph, and MIND-accelerated scoring. Zero external dependencies.
