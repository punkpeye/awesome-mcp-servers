...
- [jtalk22/slack-mcp-server](https://github.com/jtalk22/slack-mcp-server) 📇 ☁️ 🏠 🍎 🪟 🐧 - Session-based Slack MCP server for local-first operators. v3 secure-default hosted HTTP (bearer auth + origin allowlist) while local stdio/web workflows remain unchanged.
