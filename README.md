...
- [imdinu/apple-mail-mcp](https://github.com/imdinu/apple-mail-mcp) 🐍 🏠 🍎 - Fast MCP server for Apple Mail with batch JXA for 87x faster email fetching and an FTS5 search index for ~2ms email body search. 5 tools: list accounts, list mailboxes, get emails (with filters), get email content, and full-text search.
