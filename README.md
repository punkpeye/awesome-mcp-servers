...
- [Ideas-Net-Studio/mcp-shared-memory](https://github.com/Ideas-Net-Studio/mcp-shared-memory) 📇 🏠 🍎 🪟 🐧 - A shareable memory management system for MCP-enabled tools and teams. Provides structured memory storage that can be shared across multiple AI tools and team members, with Git integration for collaborative memory building and version control.
