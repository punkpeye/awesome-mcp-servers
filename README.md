...
- [meetlark/mcp-server](https://www.npmjs.com/package/@meetlark/mcp-server) 📇 ☁️ 🏠 🍎 🪟 🐧 - Meeting scheduling for humans and agents. Create polls, collect availability votes, find times that work for groups. No accounts needed. Also available as a [remote endpoint](https://meetlark.ai/mcp).
