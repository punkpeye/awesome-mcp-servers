...
- [Faktuj MCP](https://github.com/softvoyagers/fakturka-api-mcp) - Free Polish VAT invoice generation MCP server (Faktura VAT) with PDF output and preview. No API key required. `npx faktuj-mcp`
