...
- [alibaizhanov/mengram](https://github.com/alibaizhanov/mengram) 🐍 ☁️ 🏠 🍎 🪟 🐧 - Human-like memory layer for AI agents with semantic, episodic, and procedural memory types. Cognitive Profile generates system prompts from interaction history. Knowledge graph, smart triggers, multi-user isolation, and 12 MCP tools. Python & JS SDKs.
