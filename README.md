...
- [dreamingms/kael-mcp-server](https://github.com/dreamingms/kael-mcp-server) 📇 ☁️ - AI-native tool server with 10 tools: web fetch, screenshot, web search, HTML extraction, PDF parsing, image transformation, DNS lookup, WHOIS, IP geolocation, and sandboxed code execution. Designed for AI agents — cheap compute beats expensive tokens.
