...
- [MaxwellCalkin/sentinel-ai](https://github.com/MaxwellCalkin/sentinel-ai) 🐍 🏠 🍎 🪟 🐧 - Real-time safety proxy for MCP servers — scans tool calls for prompt injection, shell injection, data exfiltration, and auto-redacts PII in responses. Sub-millisecond latency.
