...
- [frankkyazze9/anonymcp](https://github.com/frankkyazze9/anonymcp) 🐍 🏠 🍎 🪟 🐧 - PII detection, anonymization, classification, and audit logging for AI workflows. Wraps Microsoft Presidio with policy-driven governance, YAML-configurable sensitivity rules, and 6 composable tools. Supports TLS, mTLS, API key auth with RBAC, and structured audit trails.
