...
- [TheMemeBanker/nory-mcp-server](https://github.com/TheMemeBanker/nory-mcp-server) 📇 ☁️ 🍎 🪟 🐧 - Enable AI agents to make instant USDC payments via x402 HTTP protocol. Supports Solana and 7+ EVM chains with sub-400ms settlement.
