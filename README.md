...
- [Scottcjn/rustchain-mcp](https://github.com/Scottcjn/rustchain-mcp) [![Scottcjn/rustchain-mcp MCP server](https://glama.ai/mcp/servers/Scottcjn/rustchain-mcp/badges/score.svg)](https://glama.ai/mcp/servers/Scottcjn/rustchain-mcp) 🐍 ☁️ - RustChain Proof-of-Antiquity blockchain + BoTTube AI video platform. 14 tools for checking RTC balances, browsing bounties, uploading videos, and earning tokens with vintage hardware (PowerPC G4=2.5x, G5=2.0x multipliers). Built on createkr's SDK.
