...
- [Wolfe-Jam/grok-faf-mcp](https://github.com/Wolfe-Jam/grok-faf-mcp) 📇 ☁️ - Persistent project context for xAI Grok. 21 tools for .faf Project DNA — validation, scoring, bi-sync, and RAG. Remote SSE transport. IANA-registered format.
