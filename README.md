...
- [sind00/flippa-mcp](https://github.com/sind00/flippa-mcp) 📇 ☁️ - Search, analyze, and evaluate online businesses on [Flippa](https://flippa.com) with AI-powered valuation metrics, comparable sales, market overviews, and risk factor detection. No API key required.
