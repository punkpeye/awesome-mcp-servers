...
- [synapbus/synapbus](https://github.com/synapbus/synapbus) [![synapbus/synapbus MCP server](https://glama.ai/mcp/servers/synapbus/synapbus/badges/score.svg)](https://glama.ai/mcp/servers/synapbus/synapbus) 🏎️ 🏠 - SynapBus: MCP-native agent-to-agent messaging hub. Agents communicate via channels, DMs, and semantic search. Single Go binary, local-first.
