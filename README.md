...
- [liuxiaotong/knowlyr-agent](https://github.com/liuxiaotong/knowlyr-agent/tree/main/packages/sandbox) 🐍 🏠 🍎 🪟 🐧 - Code Agent execution sandbox with Docker isolation, file I/O capture, and timeout enforcement for safe LLM-generated code evaluation.
...
- [liuxiaotong/data-check](https://github.com/liuxiaotong/data-check) 🐍 🏠 🍎 🪟 🐧 - Automated quality checks, anomaly detection, and distribution analysis for LLM training datasets. Supports JSONL/CSV/Parquet with 7 MCP tools.
...
- [liuxiaotong/model-audit](https://github.com/liuxiaotong/model-audit) 🐍 🏠 🍎 🪟 🐧 - LLM distillation detection and model fingerprinting — detect text source, verify model identity, and audit distillation relationships with 5 MCP tools.
