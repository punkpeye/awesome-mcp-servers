...
- [Galbaz1/video-research-mcp](https://github.com/Galbaz1/video-research-mcp) 🐍 ☁️ 🍎 🪟 🐧 - 45-tool MCP server for video analysis (YouTube and local files), deep research, content extraction, web search, and Weaviate knowledge storage. Includes context caching, multi-turn video Q&A sessions, and explainer video synthesis.
...
- [Galbaz1/video-research-mcp](https://github.com/Galbaz1/video-research-mcp) 🐍 ☁️ 🍎 🪟 🐧 - 45-tool MCP server for video analysis, deep research, content extraction, web search, and Weaviate knowledge storage. Powered by Gemini 3.1 Pro with context caching, structured output, and MLflow tracing.
