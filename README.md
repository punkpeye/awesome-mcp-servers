...
- [pylon-apis/pylon](https://github.com/pylon-apis/pylon) 📇 ☁️ - API gateway with 20+ pay-per-request utilities for AI agents (screenshot, OCR, search, translate, PDF parse, web scrape, and more). No API keys — powered by x402 micropayments on Base. MCP server: `npx @pylonapi/mcp`
