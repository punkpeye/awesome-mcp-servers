...
- [DareDev256/fcpxml-mcp-server](https://github.com/DareDev256/fcpxml-mcp-server) 🐍 🏠 🍎 - AI-powered MCP server for Final Cut Pro XML with 53 tools for timeline analysis, health checks, flash frame detection, chapter markers, and non-destructive XML editing.
