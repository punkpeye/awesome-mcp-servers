...
- [tstockham96/engram](https://github.com/tstockham96/engram) 📇 🏠 🍎 🪟 🐧 - Intelligent agent memory with automatic extraction, consolidation, and bi-temporal recall. Scores 80% on LOCOMO benchmark (vs Mem0's 67%) at 93% fewer tokens. Zero native deps, SQLite-backed. `npx engram-sdk`
