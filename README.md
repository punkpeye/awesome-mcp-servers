...
- [AbdumajidRashidov/mycop](https://github.com/AbdumajidRashidov/mycop) 🦀 🏠 🍎 🐧 - AI code security scanner (SAST) with 100 built-in rules covering OWASP Top 10 and CWE Top 25. MCP server exposes scan, review, explain, list_rules, and check_deps tools for detecting vulnerabilities in Python, JavaScript, and TypeScript code.
