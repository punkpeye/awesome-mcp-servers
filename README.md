...
- [salviz/gemini-mcp-server](https://github.com/salviz/gemini-mcp-server) 📇 ☁️ 🍎 🪟 🐧 - 23 tools for Google Gemini API including chat, multimodal analysis (image/audio/video/PDF), deep research with background polling, YouTube video analysis, Files API, embeddings, code execution, structured output, and translation.
...
- [salviz/google-mcp-server](https://github.com/salviz/google-mcp-server) 📇 ☁️ 🍎 🪟 🐧 - 73 tools for Google Workspace including Drive, Docs, Slides, Sheets, Calendar, Contacts, and Tasks with full CRUD, binary uploads, exports, and batch operations.
