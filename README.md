...
- [bnmbnmai/mcp-proxy](https://github.com/bnmbnmai/mcp-proxy) 📇 ☁️ - Apollo Intelligence Network — 26 AI tools via x402 micropayments. DeFi yields, OSINT, crypto prices, market intel, web scraping (190+ countries), X/Twitter search, GitHub trending, and more.
