...
- [bolivian-peru/osmoda-mcp-bridge](https://github.com/bolivian-peru/os-moda/tree/main/packages/osmoda-mcp-bridge) 📇 🏠 🐧 - 91 system-management tools for [osModa](https://github.com/bolivian-peru/os-moda), a NixOS distribution where the AI agent has root. Exposes 9 Rust daemons (system, processes, services, NixOS config, hash-chained audit ledger, atomic SafeSwitch deploys, P2P encrypted mesh, crypto wallets, local STT/TTS) as typed MCP tools.
