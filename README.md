...
- [Whitening-Sinabro/clouvel](https://github.com/Whitening-Sinabro/clouvel) 🐍 🏠 - MCP server enforcing "no code without docs" for AI-assisted development. Features regression memory, 8 C-Level manager code reviews, PRD enforcement gate, and 100+ tools for context management and error prevention.
