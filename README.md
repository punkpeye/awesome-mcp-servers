...
- [format37/youtube_mcp](https://github.com/format37/youtube_mcp) 🐍 🎧 A Docker-based MCP server that transcribes YouTube videos to English text. Uses yt-dlp to download audio and OpenAI's Whisper-1 for transcription. Simply provide a YouTube URL and get back the full transcript, automatically translated from any supported language to English.
