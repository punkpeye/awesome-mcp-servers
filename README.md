...
- [howardpen9/kimi-code-mcp](https://github.com/howardpen9/kimi-code-mcp) 📇 🏠 🍎 🪟 🐧 - MCP server bridging Claude Code with Kimi K2.5 (256K context) for cost-efficient codebase analysis. Delegate bulk file reading and code review to Kimi, saving 60-80% Claude tokens. Session caching with LRU eviction.
