...
- [odei-ai/mcp-odei](https://github.com/odei-ai/mcp-odei) 📇 ☁️ - Constitutional world model for AI agents. Persistent Neo4j knowledge graph (91 nodes, 6 semantic domains: Foundation, Vision, Strategy, Tactics, Execution, Track), 7-layer AI safety guardrails (APPROVED/REJECTED/ESCALATE), and smart contract audit. Production since Jan 2026 on Virtuals ACP (#3082), Fetch.ai Agentverse, and Clawlancer.
