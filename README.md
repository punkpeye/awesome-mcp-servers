...
- [hashgraph-online/hashnet-mcp-js](https://github.com/hashgraph-online/hashnet-mcp-js) 📇 ☁️ 🍎 🪟 🐧 - Universal Agentic Registry MCP server providing AI agent discovery, blockchain-based identity (ERC-8004, UAIDs), and cross-protocol communication. Enables agent search, registration, and autonomous commerce via x402 protocol.
