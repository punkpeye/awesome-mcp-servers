...
- [menyoung/paperqa-mcp-server](https://github.com/menyoung/paperqa-mcp-server) 🐍 🏠 ☁️ - Deep search and synthesis across local PDF libraries using PaperQA2. Point it at your Zotero storage or any folder of PDFs.
