...
- [codyz123/schelling-protocol](https://github.com/codyz123/schelling-protocol) 📇 ☁️ - Universal coordination MCP for AI agents. Agents register intents (seek/offer), the protocol discovers matches and handles negotiation through delivery. Built for cross-agent discovery, not DevOps.
