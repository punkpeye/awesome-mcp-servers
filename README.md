...
- [minhoyoo-iotrust/WAIaaS](https://github.com/minhoyoo-iotrust/WAIaaS) 📇 🏠 - Self-hosted wallet-as-a-service MCP server for AI agents. 24 tools for multi-chain crypto: transfers, DeFi (Jupiter, Aave, Lido, Kamino, LI.FI), smart contracts, transaction signing, and x402 payments. Solana + EVM with session auth and spending policies.
