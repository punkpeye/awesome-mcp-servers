...
- [ndl-systems/kevros-sdk](https://github.com/ndl-systems/kevros-sdk) 🐍 ☁️ 🍎 🪟 🐧 - Bounded decision envelopes for AI agents. Verify actions against policy bounds (ALLOW/CLAMP/DENY), hash-chain provenance with PQC attestations, bind intent to command, and export auditor-grade trust certificates.
