...
- [revsmoke/promptrejectormcp](https://github.com/revsmoke/promptrejectormcp) 📇 🏠 - Dual-layer security gateway that screens AI agent inputs for prompt injection attacks, jailbreaks, and web vulnerabilities (XSS, SQLi) using LLM semantic analysis and static pattern matching.
