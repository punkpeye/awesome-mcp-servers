...
- [tranhoangtu-it/mcpman](https://github.com/tranhoangtu-it/mcpman) 📇 🏠 🍎 🪟 🐧 - The package manager for MCP servers. Install, manage, and health-check MCP servers across Claude Desktop, Cursor, VS Code, and Windsurf from a single CLI with lockfile support.
