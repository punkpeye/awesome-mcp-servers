...
- **[mcp-rustdesk](https://github.com/meumeu-dev/mcp-rustdesk)** - Let an LLM see and control a remote machine over the RustDesk protocol (E2EE NaCl, AV1/H264/VP9 codecs, NAT hole-punch via self-hosted hbbs). Includes optional Gemini Live watcher for continuous narration.
