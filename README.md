...
- [pronunciation-assessment](https://smithery.ai/server/fabiosuizu/pronunciation-assessment) 🐍 ☁️ - Managed pronunciation scoring API for AI agents. Scores English pronunciation at phoneme, word, and sentence levels with IPA/ARPAbet notation. 17MB model, sub-300ms latency, benchmarked on speechocean762.
