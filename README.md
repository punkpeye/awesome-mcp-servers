...
- [ds1/pincerpay](https://github.com/ds1/pincerpay) 📇 ☁️ - Open-source on-chain USDC payment gateway connecting AI agents to merchants. MCP server enables x402 payments, paywall creation, and transaction management on Solana, Base, and Polygon.
