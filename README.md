...
- [skypher/clawpage-mcp](https://github.com/skypher/clawpage-mcp) 📇 ☁️ - Extract and structure any web page into clean JSON (text, tables, prices, contacts, hours, ratings). Handles JS-rendered SPAs and bot-blocked sites. Free tier: 10 extractions/day. Also supports x402 micropayments and prepaid USDC.
