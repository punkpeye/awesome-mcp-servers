...
- [moxiespirit/curistat-mcp](https://github.com/moxiespirit/MyClone/tree/main/curistat_mcp) 🐍 ☁️ - Futures volatility forecasting for ES/NQ. Daily CVN rating (1-10), regime detection (CRC composite), directional signals, economic calendar with impact analytics. 10 MCP tools.
