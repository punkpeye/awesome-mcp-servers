...
- [beycom/onetool](https://github.com/beycom/onetool) 🐍 🏠 🍎 🪟 🐧 - One MCP server, 100+ tools. Code-based tool calling eliminates tool tax and context rot — 96% fewer tokens, 24× lower cost. Includes Brave, Gemini, Context7, Chrome DevTools, Excel, File Ops, Database.
