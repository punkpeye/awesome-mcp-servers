...
- [Docat0209/mcp-graphql](https://github.com/Docat0209/mcp-graphql) [glama](https://glama.ai/mcp/servers/Docat0209/mcp-graphql) 📇 ☁️ 🍎 🪟 🐧 - Zero-config GraphQL to MCP converter. Auto-introspects any GraphQL endpoint and exposes queries/mutations as flat-parameter MCP tools. Supports auth headers, smart response truncation, and retry logic.
- [Docat0209/mcp-openapi](https://github.com/Docat0209/mcp-openapi) [glama](https://glama.ai/mcp/servers/Docat0209/mcp-openapi) 📇 ☁️ 🍎 🪟 🐧 - Zero-config OpenAPI/Swagger to MCP converter. Converts any REST API spec into MCP tools with flat parameter schemas, built-in auth, Swagger 2.0 support, and smart response truncation.
