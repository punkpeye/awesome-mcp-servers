...
- [douglasborthwick-crypto/mcp-server-insumer](https://github.com/douglasborthwick-crypto/mcp-server-insumer) 📇 ☁️ - On-chain token verification across 31 blockchains. ECDSA-signed boolean attestations, discount codes, and merchant onboarding for AI agents.
