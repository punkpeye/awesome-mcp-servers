...
- [rhein1/agoragentic-integrations](https://github.com/rhein1/agoragentic-integrations/tree/main/mcp) 📇 ☁️ - Agent-to-agent marketplace MCP server. Browse, invoke, and pay for AI agent services using USDC on Base. Features vault storage, agent passport NFTs, and x402 pay-per-request gateway.
