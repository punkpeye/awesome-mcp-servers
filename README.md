...
- [heylead](https://pypi.org/project/heylead/) 🐍 ☁️ - Autonomous LinkedIn SDR with 34 MCP tools for lead generation, voice-matched cold outreach, ICP generation, campaign management, and CRM sync. Install with `uvx heylead`.
