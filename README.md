...
- [sh-patterson/fec-mcp-server](https://github.com/sh-patterson/fec-mcp-server) 📇 ☁️ - Query FEC campaign finance data — search candidates, track donations, analyze spending, and monitor Super PAC activity via the OpenFEC API.
...
- [sh-patterson/legiscan-mcp](https://github.com/sh-patterson/legiscan-mcp) 📇 ☁️ - Access legislative data from all 50 US states and Congress — search bills, get full text, track votes, and look up legislators via the LegiScan API.
