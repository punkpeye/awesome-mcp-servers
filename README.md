...
- [Jthora/archangel-agency-mcp](https://github.com/Jthora/archangel-agency-mcp) 📇 ☁️ - Remote MCP server for ontological research context. Universal Language briefings, FusionGirl context JSONs, service catalog, and agent metadata. Cloudflare Workers with x402 payment gate.
