...
- [rushikeshmore/agent-karma](https://github.com/rushikeshmore/agent-karma) 📇 ☁️ - Credit bureau for AI agent wallets. Scores wallet addresses for trustworthiness using ERC-8004 and x402 on-chain data across Ethereum, Base, and Arbitrum. REST API, TypeScript SDK, and MCP server with 6 tools. 10K+ wallets indexed, 85K+ transactions.
