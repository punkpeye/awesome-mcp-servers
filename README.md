...
- [LawMem](https://github.com/lawmem-ai/lawmem-mcp) — Persistent semantic memory-as-a-service for legal AI agents. Store and recall case notes, client context, and matter history via MCP. Namespace-isolated, audit-logged, GDPR-compliant. Free tier + paid plans.
