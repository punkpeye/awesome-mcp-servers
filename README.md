...
- [PROSPIRE-TECHNOLOGY-SERVICES](https://github.com/PROSPIRE-TECHNOLOGY-SERVICES/nagios-mcp) - Host and service status, get alerts, process info, etc. from the Nagios Core Server.
