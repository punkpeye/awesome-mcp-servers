...
- [neilberkman/editorconfig-mcp-server](https://github.com/neilberkman/editorconfig-mcp-server) 📇 🏠 - Formats files using .editorconfig rules, preventing formatting errors from AI coding agents by ensuring files are correct from the start.
