...
- [Ratnaditya-J/csvglow](https://github.com/Ratnaditya-J/csvglow) 🐍 🏠 🍎 🪟 🐧 - Generate beautiful HTML dashboards from CSV/Excel files with auto-detected charts, correlations, scatter plots, and a sortable data table in a single self-contained HTML file.
