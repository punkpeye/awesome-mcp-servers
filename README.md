...
- [Guid-Lab/cv-forge-mcp](https://github.com/Guid-Lab/cv-forge-mcp) 🐍 🏠 🍎 🪟 🐧 - Generate professional ATS-friendly CVs as PDF/DOCX from AI conversations. Auto-manages a Docker container with live visual editor for manual tweaks.
