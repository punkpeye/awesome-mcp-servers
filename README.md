...
- [kiruna-labs/userdispatch-mcp](https://github.com/kiruna-labs/userdispatch-mcp) 📇 ☁️ - User feedback widget and MCP server for AI coding agents. Captures bug reports, ratings, and questions via an embeddable widget, then exposes an MCP server tool for triaging, response drafting, and PR creation through Claude Code and any other AI agent.
