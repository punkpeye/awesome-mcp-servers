...
- [TheArtOfService Compliance Intelligence](https://github.com/GJB65/compliance-platform) ☁️ - Query 692 compliance frameworks (ISO, NIST, GDPR, SOC 2, etc.), 14,000+ controls, and 819K+ cross-framework control mappings. Search frameworks, retrieve controls, map controls across frameworks, and generate coverage reports.
