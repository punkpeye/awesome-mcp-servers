...
- [jau123/MeiGen-Art](https://github.com/jau123/MeiGen-Art) 📇 ☁️ 🏠 - AI design MCP server with 1,300+ curated prompt library, smart prompt enhancement, and multi-provider image generation (local ComfyUI, MeiGen Cloud, OpenAI-compatible APIs).
