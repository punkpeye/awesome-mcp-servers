...
- [opspawn/bazaar-mcp-server](https://github.com/opspawn/bazaar-mcp-server) 📇 ☁️ - MCP server for x402 micropayment-powered developer tools — screenshot capture, AI analysis, PDF/HTML generation, code scanning, and dependency auditing via USDC micropayments.
