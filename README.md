...
- [dx111ge/engram](https://github.com/dx111ge/engram) 🦀 🏠 🪟 🐧 - AI memory engine with knowledge graph, BM25 + HNSW hybrid search, confidence lifecycle, forward/backward chaining inference, and ed25519 peer-to-peer mesh sync. Single 8 MB binary, single .brain file, zero dependencies. HTTP REST, MCP, and gRPC APIs.
