...
- [lordbasilaiassistant-sudo/thryx-mcp-server](https://github.com/lordbasilaiassistant-sudo/thryx-mcp-server) 📇 ☁️ - ThryxProtocol MCP Server — AI Agent Launchpad on Base. 15 tools: launch tokens, buy/sell with ETH, gasless metaLaunch, claim fees, safety scores, rug checks. Zero-cost token creation with paymaster-sponsored gas.
