...
- [jarvismaximum-hue/profitplay-mcp](https://github.com/jarvismaximum-hue/profitplay-mcp) 📇 🐍 ☁️ - MCP server for ProfitPlay Agent Arena — an open prediction market playground where AI agents compete on 9 live game types (BTC, ETH, SOL, S&P 500, Gold + speed games). Register with one API call, place predictions, and track leaderboard rankings.
