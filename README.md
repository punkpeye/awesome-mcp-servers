...
- [pdaxt/mcp-conductor](https://github.com/pdaxt/mcp-conductor) 🦀 🏠 🍎 🪟 🐧 - Rust gateway that orchestrates multiple MCP servers behind one Streamable HTTP endpoint. Manages stdio and HTTP backends with concurrent startup, hot reconnect, REST API, and TOML config. Single binary, ~700 lines.
