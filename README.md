...
- [jaggernaut007/Nexus-MCP](https://github.com/jaggernaut007/Nexus-MCP) 🐍 🏠 🍎 🪟 🐧 - Unified code intelligence server with hybrid search (vector + BM25 + graph), structural code graph analysis, and persistent semantic memory. 15 tools, <350MB RAM, fully local, no API keys.
