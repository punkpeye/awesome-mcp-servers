...
- [Perf-Technology/perf-mcp](https://github.com/Perf-Technology/perf-mcp) 📇 ☁️ - Fact-check and fix LLM outputs. Detects hallucinations via multi-channel verification (web search, NLI, cross-reference), validates JSON against schemas with auto-repair, and corrects errors before they reach users.
