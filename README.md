...
- [linus-phobomail/phobomail](https://github.com/linus-phobomail/phobomail) 📇 ☁️ - Disposable @phobomail.com email addresses for AI agents. Self-register, send, receive, and poll for OTP codes autonomously via MCP — no human required.
