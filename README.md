...
- [S2TConsulting/accelerators-mcp](https://github.com/S2TConsulting/accelerators-mcp) 📇 ☁️ - 36 enterprise MCP tools: IAM policy validation, MFA compliance, CloudFormation generation, DynamoDB design, OAuth validation, vector embeddings, error pattern analysis, 12 ACI governance tools for AI agent safety, and stakeholder interview automation. Free tier available.
...
- [S2TConsulting/accelerators-mcp](https://github.com/S2TConsulting/accelerators-mcp) 📇 ☁️ - 36 production-ready tools for AWS infrastructure (CloudFormation, DynamoDB), security compliance (IAM, MFA, OAuth), AI workflows (vector embeddings, error analysis), agent orchestration, stakeholder interviews, and ACI governance with audit trails.
