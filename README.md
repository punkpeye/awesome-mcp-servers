...
- [aeoess/agent-passport-mcp](https://github.com/aeoess/agent-passport-mcp) 📇 🏠 🍎 🪟 🐧 - Cryptographic identity and trust protocol for AI agents. 38 tools across 8 layers: Ed25519 identity, delegation chains, values compliance, signed communication (Agora), policy engine, task coordination, and agentic commerce. 264 tests.
