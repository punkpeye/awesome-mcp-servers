...
- [LakyFx/CogniLayer](https://github.com/LakyFx/CogniLayer) 🐍 🏠 🍎 🪟 🐧 - Persistent knowledge + code graph MCP server for Claude Code and Codex CLI. 17 tools: tree-sitter AST indexing, symbol search, blast radius analysis, hybrid FTS5 + vector search, heat decay, session bridges, and subagent context compression. Local SQLite, zero external services.
