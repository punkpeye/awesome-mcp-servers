...
- [LimitGuard Trust Intelligence](https://github.com/JWconsultancy1234/limitguard-ai) [glama](https://glama.ai/mcp/connectors/ai.limitguard.api/trust-intelligence) ☁️ 🐍 - Entity verification, sanctions screening (PEP/OFAC/UN), and trust scoring for AI agents. 8 data sources, x402 USDC payments.
