...
- [zach-abraham/sentinel-mcp](https://github.com/zach-abraham/sentinel-mcp) 🐍 🏠 🍎 🪟 🐧 - AI SOC analyst MCP server with log analysis (auth.log, syslog, firewall, CloudTrail), ML anomaly detection (Isolation Forest), 20 Sigma-inspired detection rules, MITRE ATT&CK mapping, event correlation, IOC checking, and automated incident report generation.
