...
- [meltingpixelsai/harvey-budget](https://github.com/meltingpixelsai/harvey-budget) 📇 ☁️ - Agent spending management MCP server. Budget tracking, spend approval, ROI analysis, and optimization recommendations. Agents pay per call via x402 USDC on Solana.
...
- [meltingpixelsai/harvey-verify](https://github.com/meltingpixelsai/harvey-verify) 📇 ☁️ - Post-transaction outcome verification for AI agents. LLM-as-judge checks if services delivered what was promised, with quality database and service reputation scores. Pay per call via x402 USDC.
