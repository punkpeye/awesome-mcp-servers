...
- [Candice AI](https://mcp.candiceai.com/mcp?apikey=YOUR_API_KEY) - Document intelligence platform with verifiable, citation-backed outputs and governance-ready trust layer.
