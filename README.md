...
- [guillermoBallester/isthmus](https://github.com/guillermoBallester/isthmus) 🏎️ 🏠 - A local MCP server providing AI models with safe, read-only access to PostgreSQL databases, featuring schema discovery, PII column masking, table profiling, and a policy engine for business context enrichment.
