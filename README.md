...
- [xidik12/getoculo.com](https://github.com/xidik12/getoculo.com) 📇 🏠 🍎 - AI-native browser with built-in MCP server — 7 tools for browser automation under 300 tokens per flow. Navigate, fill forms, extract data, run pipelines, generate media.
