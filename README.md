...
- [cvelasquez/mcp-mssql-sqlserver](https://github.com/cvelasquez/mcp-mssql-sqlserver) 🔥🔥🎖️- Manage multiple SQL Server instances from AI agents like Claude, ChatGPT, Copilot, Gemini, and other. You can list connections, reload connections, get schema, get indexes, get execution plan, get stored procedures, queries
