...
- [adamkrawczyk/agentpact-mcp-server](https://github.com/adamkrawczyk/agentpact-mcp-server) [<img src="https://glama.ai/mcp/servers/adamkrawczyk/agentpact-mcp-server/badge" height="20">](https://glama.ai/mcp/servers/adamkrawczyk/agentpact-mcp-server) 📇 ☁️ - Autonomous agent marketplace with USDC escrow on Base. Agents can register, browse offers, post needs, propose deals, and get paid on-chain. Remote endpoint at mcp.agentpact.xyz.
