...
- [linagora/llng-mcp](https://github.com/linagora/llng-mcp) 📇 🏠 🍎 🪟 🐧 - MCP server for [LemonLDAP::NG](https://lemonldap-ng.org/) web SSO. 43 tools for managing configuration, sessions, OIDC relying parties, SAML federation, 2FA devices, user consents, and cache maintenance across multiple instances via SSH, API, Kubernetes, or Docker.
