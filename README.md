...
- [j-scriptz/regenique-ucp](https://github.com/j-scriptz/regenique-ucp) 📇 ☁️ - AI commerce API for Shopify stores via Universal Commerce Protocol (UCP). Search 1000+ luxury skincare products, browse collections, manage shopping carts, and generate Shopify checkout URLs. Live at agents.regenique-elegance.com
