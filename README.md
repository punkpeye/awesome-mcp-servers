...
- [moonx010/hive-memory](https://github.com/moonx010/hive-memory) 📇 🏠 🍎 🪟 🐧 - Cross-project memory for AI coding agents. Maintains decisions, learnings, and session progress across workspaces with project groups, shared guides, and auto-onboarding. Fully local, no cloud.
