...
- [hyperpolymath/boj-server](https://github.com/hyperpolymath/boj-server) [glama](https://glama.ai/mcp/servers/hyperpolymath/boj-server) 🏠 🐧 - Unified capability catalogue exposing 18 cartridges (database, container, git, secrets, queues, IaC, observability, SSG, proofs, fleet, neurosymbolic, agent, cloud, k8s, LSP, DAP, BSP, feedback) through a single MCP stdio server. Formally verified with Idris2 dependent types, Zig FFI, V-lang adapter. Community-hosted via Umoja federation.
