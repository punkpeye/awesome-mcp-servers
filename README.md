...
- [blockrunai/blockrun-mcp](https://github.com/blockrunai/blockrun-mcp) 📇 ☁️ - Access 30+ AI models (GPT-5, Claude Opus, Gemini) via x402 micropayments. Zero API keys needed, pay-per-use USDC billing.
