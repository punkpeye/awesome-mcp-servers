...
- [augiemazza/varrd](https://github.com/augiemazza/varrd) 🐍 ☁️ - Validated quant research. Test any trading idea with real market data — event studies, backtests, stop-loss optimization — with 8 statistical guardrails enforced at infrastructure level. Returns exact entry/stop/target prices. Currently used by top US traders. Available for a limited time as standalone while in brokerage integration talks.
