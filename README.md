...
- [berkayderin/nextscan](https://github.com/berkayderin/nextscan) 📇 🏠 🍎 🪟 🐧 - Scans Next.js projects and returns a compact summary of routes, API endpoints, database schema (Prisma + Drizzle), and security issues in a single tool call.
