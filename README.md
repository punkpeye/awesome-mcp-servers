...
- [jamie8johnson/cqs](https://github.com/jamie8johnson/cqs) 🦀 🏠 🐧 🪟 - Semantic code search for Claude Code. Find functions by what they do, not their names. Local ML embeddings with GPU acceleration and HNSW index.
