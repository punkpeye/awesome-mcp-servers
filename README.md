...
- [jdguggs10/flaim](https://github.com/jdguggs10/flaim) [glama](https://glama.ai/mcp/connectors/app.flaim/mcp) 📇 ☁️ - Connect ESPN, Yahoo, and Sleeper fantasy leagues to AI assistants via MCP. Read-only tools for rosters, standings, matchups, free agents, and transactions across football, baseball, basketball, and hockey.
