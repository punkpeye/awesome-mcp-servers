...
- [Halyxa/flowmcp](https://github.com/Halyxa/flowmcp) 📇 ☁️ 🏠 🍎 🪟 🐧 - MCP server connecting AI assistants to Flow Immersive 3D spatial data visualization with 71 tools for data analysis, transformation, network graphs, force layout pre-computation, narrative intelligence, and direct API upload.
