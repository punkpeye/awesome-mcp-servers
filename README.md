...
- [mbeato/conway](https://github.com/mbeato/conway) 📇 ☁️ - 18 x402-payable web analysis APIs for AI agents. Pay-per-call with USDC on Base — no API keys needed. Tools include domain availability, SEO audit, security headers, Core Web Vitals, redirect chains, and more.
