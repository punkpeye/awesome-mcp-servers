...
- [SageMindAI/moltbridge](https://github.com/SageMindAI/moltbridge) 📇 ☁️ 🍎 🪟 🐧 - Agent network intelligence for trust verification, broker discovery, and capability matching. Ed25519 identity, graph-based trust scoring, USDC payments, and MCP tools for agent registration, search, and trust attestation.
