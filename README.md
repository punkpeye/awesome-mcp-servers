...
- [bnmbnmai/mcp-proxy](https://github.com/bnmbnmai/mcp-proxy) 📇 ☁️ - Apollo Intelligence Network — 21 AI-curated data tools via x402 micropayments on Base. Web scraping, X/Twitter search, market intelligence, crypto prices, agent trends, GitHub trending, and more.
