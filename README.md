...
- [thryxagi/obsd-launchpad](https://github.com/thryxagi/obsd-launchpad) 📇 ☁️ - Full token lifecycle MCP for AI agents on Base. 12 tools: deploy tokens, buy, sell, claim fees, get quotes, referral program, and query earnings via `npx obsd-launchpad-mcp`. Treasury-backed intrinsic value floor, progressive sell tax, 37.5% passive OBSD fee income. 10 verified contracts, 275 tests.
