...
- [garagon/aguara-mcp](https://github.com/garagon/aguara-mcp) 🏎️ 🏠 🍎 🪟 🐧 - Security scanner for AI agent skills and MCP servers. Scans tool definitions and skill descriptions for prompt injection, credential theft, exfiltration, and 12 other threat categories. 148 rules, zero network access, fully deterministic.
