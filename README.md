...
- [firas-mcp-servers/mcp-sql-bridge](https://github.com/firas-mcp-servers/mcp-sql-bridge) 🐍 🏠 - Read-only MCP server for SQL — schema-aware access to SQLite, PostgreSQL, and MySQL. No cloud, no writes. Works with Cursor and Claude Desktop.
