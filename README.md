...
- [ds1/pincerpay](https://github.com/ds1/pincerpay) 📇 ☁️ - On-chain USDC payment gateway for AI agents. MCP server enables x402 payments, paywall creation, and transaction management on Solana, Base, and Polygon.
