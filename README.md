...
- [TombStoneDash/agent-bazaar](https://noui.bot) 📇 ☁️ 🍎 🪟 🐧 - Per-call billing and metering proxy for MCP tool servers. Providers set pricing, consumers pay via Stripe Connect. Features trust scores, signed receipts, SLA monitoring, and an open billing spec (MIT). No vendor lock-in.
