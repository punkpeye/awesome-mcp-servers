...
- [quotewise/mcp](https://github.com/quotewise/mcp) 📇 ☁️ - Semantic quote search with 600K quotes. Setup CLI connects AI assistants to hosted MCP server with source transparency via QuoteSightings.
