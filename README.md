...
- [mizukaizen/hive-doctrine-mcp](https://github.com/mizukaizen/hive-doctrine-mcp) 📇 ☁️ 🏠 🍎 🪟 🐧 - Multi-agent governance MCP server implementing the Hive Doctrine framework. Exposes agent identity (SOUL.md), tiered memory architecture, and 30+ structured delegation tools for AI agent systems.
