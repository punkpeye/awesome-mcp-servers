...
- [mcmurrym/virga](https://github.com/mcmurrym/virga) 📇 ☁️ - Agent-first Weather API with autonomous onboarding, prepaid credits, and normalized weather data. Agents can self-register, accept terms, and query current, forecast, and historical weather via MCP.
