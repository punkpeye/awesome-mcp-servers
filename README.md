...
- [huanglei288766/china-mcp-servers](https://github.com/huanglei288766/china-mcp-servers) 📇 ☁️ 🍎 🪟 🐧 - MCP servers for Chinese workplace platforms (Feishu/Lark and DingTalk). Send messages, create docs, manage calendars, handle approvals through Claude Code or any MCP client.
