...
- [opanel-mc/opanel-mcp](https://github.com/opanel-mc/opanel-mcp) [glama](https://glama.ai/mcp/servers/@opanel-mc/opanel-mcp) 📇 ☁️ - A MCP server integrated with the OPanel server management panel, enabling LLM-assisted management of Minecraft servers.
