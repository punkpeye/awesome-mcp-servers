...
- [henry-ships/sparkforge-mcp](https://github.com/henry-ships/sparkforge) 📇 ☁️ 🍎 🪟 🐧 - 20-tool utility API platform for AI agents — image gen, video gen, TTS, BTC signals, crypto prices, token research, wallet analysis, web scraping, screenshots, PDF-to-markdown, code review, QR codes, and more. Free via MCP or pay-per-use via x402 USDC micropayments on Base/Polygon/Solana.
