...
- [fasuizu-br/speech-ai-examples](https://github.com/fasuizu-br/speech-ai-examples) [glama](https://glama.ai/mcp/connectors/io.github.fasuizu-br/speech-ai) 🐍 ☁️ - Production speech AI platform with pronunciation scoring, speech-to-text, and text-to-speech. 10 tools including phoneme-level assessment, audio transcription, multi-voice synthesis, and phoneme inventory lookup.
