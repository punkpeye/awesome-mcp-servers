...
- [gpartin/WaveGuardClient](https://github.com/gpartin/WaveGuardClient) 🐍 ☁️ 🍎 🪟 🐧 - Physics-based anomaly detection via MCP. Uses Klein-Gordon wave equations on GPU to detect anomalies with zero false positives in benchmarks. 3 tools: scan vectors, scan time-series, health check.
