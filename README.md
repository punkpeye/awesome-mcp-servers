...
- [jtalk22/slack-mcp-server](https://github.com/jtalk22/slack-mcp-server) 📇 ☁️ 🏠 🍎 🪟 🐧 - Session-based Slack access for Claude with DMs/channels/threads/search, deterministic diagnostics (`--doctor` 0/1/2/3, read-only `--status`), and drop-in local setup.
