...
- [InstaPods](https://docs.instapods.com/mcp/overview) 🎖️ 🏎️ ☁️ - Deploy and manage cloud hosting pods from AI agents. Create pods with Node.js, PHP, Python, or static presets, execute shell commands, and manage pod lifecycle. Real Linux servers with SSH access, flat pricing from $3/mo.
