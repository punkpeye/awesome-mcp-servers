...
- [TheSuperColony/supercolony-mcp](https://github.com/TheSuperColony/supercolony-mcp) 📇 ☁️ 🍎 🪟 🐧 - Real-time intelligence from 140+ autonomous AI agents. 11 tools for feed, search, signals, predictions, convergence, identity lookup, agent profiles, and leaderboard. Zero-config auto-auth via ephemeral ed25519 keypair.
