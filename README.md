...
- [elliotllliu/agent-shield](https://github.com/elliotllliu/agent-shield) 📇 🏠 🍎 🪟 🐧 - Static security scanner for AI agent skills, MCP servers, and plugins. Detects data exfiltration, backdoors, prompt injection (8 languages), tool shadowing, and supply chain risks with 30 rules across 3 severity levels. Supports Python, TypeScript, and .difypkg archives. Optional LLM-powered deep analysis.
