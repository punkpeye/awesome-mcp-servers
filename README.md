...
- [openclaw-ai/intel](https://github.com/yedanyagamiai-cmd/openclaw-mcp-servers) ☁️ - AI agent market intelligence MCP server. Real-time GitHub stars, releases, growth trends for Claude Code, Cursor, Devin, OpenHands, Windsurf. Updated every 6 hours. Free tier + Pro API keys.
