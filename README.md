...
- [clawdentials](https://github.com/fernikolic/clawdentials) 📇 ☁️ - Escrow, reputation, and payments for AI agents. Register skills, accept paid tasks with guaranteed payment via escrow, build verifiable reputation scores, and get paid in USDC, USDT, or BTC (no KYC via Cashu).
