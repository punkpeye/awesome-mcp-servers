...
- [ahmadsl/kachink](https://github.com/ahmadsl/kachink) 📇 ☁️ - Personal finance tracker with multi-currency support, recurring transactions, and an interactive dashboard rendered as an MCP App.
