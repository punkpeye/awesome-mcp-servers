...
- [djd-agent-score](https://github.com/jacobsd32-cpu/djd-agent-score) 📇 ☁️ - Reputation scoring API for AI agent wallets on Base. Returns 0–100 trust scores across 5 dimensions (identity, behavior, reliability, viability, capability) using on-chain transaction patterns, sybil detection, and gaming velocity checks. x402 micropayments, free tier available.
