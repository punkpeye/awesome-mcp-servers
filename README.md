...
- [WeberG619/RevitMCPBridge2026](https://github.com/WeberG619/RevitMCPBridge2026) [glama](https://glama.ai/mcp/servers/WeberG619/RevitMCPBridge2026) #️⃣ 🏠 🪟 - MCP server providing 705+ API endpoints for AI-driven Building Information Modeling (BIM) with Autodesk Revit. Enables AI agents to create/modify walls, doors, windows, MEP systems, generate construction document sheets, manage views, run code compliance checks, and perform full read-write operations on Revit models via named pipe communication.
