...
- [LuciferForge/agent-safety-mcp](https://github.com/LuciferForge/agent-safety-mcp) 🐍 🏠 🍎 🪟 🐧 - Unified MCP safety server combining prompt injection detection (75 regex patterns, <1ms), LLM output scanning (secrets, PII, system prompt leakage, hallucinated URLs), cost guard budgets, and decision tracing. Zero ML dependencies — pure Python stdlib pre-filter layer.
