...
- [rsdouglas/janee](https://github.com/rsdouglas/janee) 📇 🏠 🍎 🪟 🐧 - Just-in-time credential provisioning for MCP servers. Janee provides capability-based tokens so LLMs never see long-lived secrets. Features OAuth flows, secret rotation, and audit logging for secure AI agent interactions.
