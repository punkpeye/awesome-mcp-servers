...
- [br-ai-n/brain-mcp-icon-visual](https://github.com/n0isy/brain-mcp-icon-visual) 🦀 ☁️ 🍎 🪟 🐧 - Visual icon search, retrieval, and comparison for AI agents. Search 200k+ icons semantically, render side-by-side comparison grids, and retrieve raw SVG markup — all tools return images so vision-capable LLMs can see the icons.
