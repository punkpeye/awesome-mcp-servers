...
- [trssantos/website-intel-mcp](https://github.com/trssantos/website-intel-mcp) 📇 ☁️ 🏠 🍎 🪟 🐧 - Website intelligence for AI agents — tech stack detection (35+ technologies), SEO analysis with scoring, contact extraction, and social link discovery. Zero API costs.
...
- [trssantos/subdomain-intel-mcp](https://github.com/trssantos/subdomain-intel-mcp) 📇 ☁️ 🏠 🍎 🪟 🐧 - Subdomain discovery, DNS enumeration, and attack surface analysis for AI agents. Zero API costs.
