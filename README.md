...
- [Semgrep MCP Server](https://github.com/semgrep/mcp-security-audit) 📇🛡️☁️ Allow AI agents to scan code for security vulnerabilites using [Semgrep](https://semgrep.dev).
