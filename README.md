...
- [Whitemarmot/markly-mcp-server](https://github.com/Whitemarmot/markly-mcp-server) 📇 ☁️ - Add text or logo watermarks to images via the Markly.cloud API. Supports batch processing.
