...
- [dmilad/ocp-viewer-mcp](https://github.com/dmilad/ocp-viewer-mcp) 🐍 🏠 - MCP server for capturing screenshots from OCP CAD Viewer — lets AI assistants see your 3D CAD models.
