...
- [Kodadocs/kodadocs](https://github.com/kodadocs/kodadocs) 🐍 ☁️ 🏠 🍎 🪟 🐧 - AI-generated help documentation for web apps via Claude Code MCP. Captures screenshots with Playwright, annotates UI elements, analyzes codebase structure, and assembles a complete VitePress documentation site with one command.
