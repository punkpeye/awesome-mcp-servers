...
- [joinQuantish/kalshi-mcp](https://github.com/joinQuantish/kalshi-mcp) 📇 ☁️ - Self-hosted MCP server for Kalshi prediction market trading via DFlow on Solana. 40 tools for market discovery, order management, position tracking, wallet management, and Jupiter swaps.
- [joinQuantish/limitless-mcp](https://github.com/joinQuantish/limitless-mcp) 📇 ☁️ - MCP server for Limitless Exchange prediction markets on Base. 34 tools for market access, limit order trading, wallet management with AES-256-GCM encryption, and position tracking.
- [joinQuantish/polymarket-mcp](https://github.com/joinQuantish/polymarket-mcp) 📇 ☁️ - Self-hosted MCP server for AI agent trading on Polymarket. 42 tools covering market discovery, order placement, position management, wallet intelligence, copy trading, and reward discovery. Polygon/Gnosis Safe with gasless transactions.
