...
- [megamind-0x/skillaudit](https://github.com/megamind-0x/skillaudit) 📇 ☁️ - AI agent skill security scanner. Scans SKILL.md files, agent configs, and tool definitions for credential theft, data exfiltration, prompt injection, reverse shells, and dangerous capability combinations. Free API with zero-friction `GET /scan/quick?url=` endpoint.
