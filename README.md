...
- [twzrd-sol/wzrd-mcp](https://github.com/twzrd-sol/wzrd-mcp) 📇 ☁️ - AI model attention markets on Solana. Velocity feeds, signal classification, yield simulation, and Jupiter routing. Streamable HTTP at `https://app.twzrd.xyz/api/mcp`.
