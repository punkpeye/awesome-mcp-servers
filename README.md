...
- [kaizen-yutani/playwright-autopilot](https://github.com/kaizen-yutani/playwright-autopilot) 📇 🏠 - Playwright E2E test debugging and interactive browser exploration. Runs tests with action capture (DOM snapshots, network, console, screenshots), diagnoses failures, and provides interactive browser tools for navigating, clicking, and inspecting pages through ARIA snapshots.
