...
- [niuheilong/stock-mcp-server](https://github.com/niuheilong/stock-mcp-server) 🐍 🏠 ☁️ - Real-time A-share stock data for AI agents via MCP protocol.### 🎮 <a name="gaming"></a>Gaming
