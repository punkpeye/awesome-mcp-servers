...
- [codeix](https://github.com/montanetech/codeix) 🦀 🏠 🍎 🪟 🐧 - Fast semantic code search for AI agents — find symbols, references, and callers across any codebase. Pre-built index committed to git, instant MCP queries.
