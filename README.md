...
- [bethington/ghidra-mcp](https://github.com/bethington/ghidra-mcp) ☕ 🐍 🏠 🍎 🪟 🐧 - Production-grade Ghidra MCP server with 179 tools for AI-powered reverse engineering. Features Ghidra Server integration, cross-binary function documentation transfer via normalized hash index, full headless operation, Docker deployment, and automated analysis pipelines.
...
- [bethington/cheat-engine-server-python](https://github.com/bethington/cheat-engine-server-python) 🐍 🏠 🪟 - MCP server for safe, read-only memory analysis and debugging through Cheat Engine. Provides process enumeration, memory reading, pattern scanning, disassembly, pointer chain resolution, and CT table import for security researchers and game modders.
