...
- **[protect-mcp](https://www.npmjs.com/package/protect-mcp)** — Local-first MCP security gateway/wrapper for existing stdio servers. Per-tool access policies, approval gates, rate limiting, and Ed25519-signed decision receipts. Source-available (FSL-1.1-MIT). [Docs](https://scopeblind.com/docs/mcp)
