...
- [Jaden-JJH/trust-security-scanner](https://github.com/Jaden-JJH/trust-security-scanner) [glama](https://glama.ai/mcp/servers/Jaden-JJH/trust-security) [smithery](https://smithery.ai/servers/trust-security/scanner) 🐍 ☁️ - AI-native security scanner with 8 MCP tools. Scans websites (Nuclei DAST) and GitHub repos (Semgrep SAST, Gitleaks secrets, npm audit SCA), then generates AI-powered fix code with before/after diffs.
