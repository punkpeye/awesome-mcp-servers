...
- [pumpclaw/pumpclaw-mcp](https://github.com/clawd800/pumpclaw/tree/main/mcp-server) 📇 ☁️ - Free token launcher on Base (Uniswap V4). AI agents can list, inspect, and deploy ERC-20 tokens with 80% creator fee share and forever-locked LP. No ETH cost to launch.
