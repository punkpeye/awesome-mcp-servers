...
- [araujota/arcagent](https://github.com/araujota/arcagent/tree/main/mcp-server) 📇 ☁️ - Remote ArcAgent MCP server for end-to-end bounty workflows: browse and claim tasks, run workspace commands, submit solutions, and track verification status.
