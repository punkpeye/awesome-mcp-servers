...
- [raphasouthall/neurostack](https://github.com/raphasouthall/neurostack) [![raphasouthall/neurostack MCP server](https://glama.ai/mcp/servers/raphasouthall/neurostack/badges/score.svg)](https://glama.ai/mcp/servers/raphasouthall/neurostack) 🐍 🏠 ☁️ - Local-first MCP server for Markdown knowledge graphs. Semantic search, prediction error tracking, and Leiden community detection — cloud or local.
