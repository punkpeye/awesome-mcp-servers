...
- [gpartin/WaveGuardClient](https://github.com/gpartin/WaveGuardClient) [glama](https://glama.ai/mcp/servers/@gpartin/WaveGuardClient) 🐍 ☁️ 🍎 🪟 🐧 - Physics-based anomaly detection via MCP. Uses Klein-Gordon wave equations on GPU to detect anomalies with high precision (avg 0.90). 9 tools: scan, fingerprint, compare, token risk, wallet profiling, volume check, price manipulation detection.
