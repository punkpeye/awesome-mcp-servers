...
- [Skyvern-AI/skyvern](https://github.com/Skyvern-AI/skyvern) [glama](https://glama.ai/mcp/connectors/io.github.Skyvern-AI/skyvern) – AI-powered browser automation MCP server that lets agents control a real browser to navigate sites, fill forms, extract structured data, and run multi-step workflows.
