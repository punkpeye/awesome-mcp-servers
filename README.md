...
- [timmeck/brain](https://github.com/timmeck/brain) 📇 🏠 🍎 🪟 🐧 - Adaptive error memory and code intelligence for Claude Code. Learns from errors and solutions with Wilson Score confidence, indexes reusable code across projects, and connects knowledge through a Hebbian synapse network with spreading activation.
