...
- [SolanaProx](https://github.com/solanaprox/mcp-server) - Prepaid, per-request AI gateway over Solana/USDC. Enables autonomous agents to discover models, check pricing, and make AI requests paid with USDC via Phantom wallet. No API keys, no accounts, wallet is your identity.
