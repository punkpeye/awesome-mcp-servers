...
- [primordia-ai/mcp-server](https://github.com/primordia-ai/mcp-server) 📇 ☁️ - AI agent economic settlement. Verify receipts, emit meters (FREE). Net settlements, credit lines, audit-grade balance sheets (PAID/402).
