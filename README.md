...
- [GeiserX/genieacs-mcp](https://github.com/GeiserX/genieacs-mcp) 🏎️ ☁️ 🍎 🪟 🐧 - MCP server that bridges any GenieACS (TR-069) instance, exposing device data, firmware management, and CPE actions (reboot, parameter refresh, firmware download) over JSON-RPC.
