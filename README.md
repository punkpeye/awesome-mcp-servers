...
- [sgroy10/speclock](https://github.com/sgroy10/speclock) 📇 🏠 🍎 🪟 🐧 - AI constraint engine (22 tools) with persistent memory, active enforcement, semantic conflict detection, file-level guards, constraint templates, violation reports, and git pre-commit hooks. Stops AI from breaking locked code across sessions.
