...
- [imran-siddique/agentos-mcp-server](https://github.com/microsoft/agent-governance-toolkit/tree/main/packages/agent-os-kernel/extensions/mcp-server) [glama](https://glama.ai/mcp/servers/@imran-siddique/agentos-mcp-server) - Agent OS MCP server for AI agent governance with policy enforcement, code safety verification, multi-model hallucination detection, and immutable audit trails.
