...
- [isgudtek/mycrab-mcp](https://github.com/isgudtek/mycrab-mcp) 🐍 ☁️ 🍎 🪟 🐧 - Instant public HTTPS Cloudflare tunnels for AI agents. Free ephemeral URLs in under 60 seconds, or permanent custom subdomains via Solana micropayment (x402). Install with `uvx mycrab-mcp`.
