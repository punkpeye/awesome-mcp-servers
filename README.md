...
- [PostcardBot/mcp-server](https://github.com/PostcardBot/mcp-server) 📇 ☁️ - Send real physical postcards worldwide via AI agents. Bulk send up to 500 recipients. Volume pricing from $0.72/card. Powered by [Postcard.bot](https://postcard.bot).
