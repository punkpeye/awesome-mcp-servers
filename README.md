...
- [manavaga/web3-signals-mcp](https://github.com/manavaga/web3-signals-mcp) [![glama badge](https://glama.ai/mcp/servers/manavaga/web3-signals-mcp/badge)](https://glama.ai/mcp/servers/manavaga/web3-signals-mcp) 🐍 ☁️ - AI-powered crypto signal intelligence for 20 assets. 6 scoring dimensions (whale, technical, derivatives, narrative, sentiment, market), market regime detection, and portfolio optimization. 9 MCP tools, free via MCP, $0.001 USDC via x402 on Base for REST API.
