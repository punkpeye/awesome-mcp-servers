...
- [Tyox-all/Weave_Protocol](https://github.com/Tyox-all/Weave_Protocol) 📇 🏠 🍎 🪟 🐧 - AI agent security scanner detecting secrets, PII, prompt injection, and data exfiltration. Part of Weave Protocol suite with compliance (SOC2/HIPAA/PCI-DSS/ISO27001) and blockchain anchoring.
