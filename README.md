...
- [shanjai-raj/commune-mcp](https://github.com/shanjai-raj/commune-mcp) 📇 ☁️ - Email and SMS infrastructure for AI agents — send and receive email, search inboxes, send/receive SMS, and manage dedicated phone numbers via the Commune API.
