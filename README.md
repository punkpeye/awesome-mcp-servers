...
- [voyagi/upwork-mcp-server](https://github.com/voyagi/upwork-mcp-server) 📇 ☁️ - Supabase CRM database integration with customer, ticket, and product CRUD, analytics dashboard, and schema introspection. Built with TypeScript, Zod validation, and full test suite.
