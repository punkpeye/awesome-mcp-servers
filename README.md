...
- [darktw/usecortex-mcp](https://github.com/darktw/usecortex-mcp) [glama](https://glama.ai/mcp/servers/darktw/usecortex-mcp) 📇 ☁️ - Persistent memory for AI coding agents. Store coding standards, architecture decisions, and project context across sessions. Two-way read/write, AES-256 encrypted, structured by topic.
