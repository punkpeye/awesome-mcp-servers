...
- [doubletick-cli](https://github.com/cseguinlz/doubletick-cli) 📇 ☁️ - Email read tracking via Gmail. Send tracked emails, check if they were opened with open count, device, and timing.
