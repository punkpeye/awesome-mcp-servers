...
- [gitmem-dev/gitmem](https://github.com/gitmem-dev/gitmem) 📇 🏠 ☁️ 🍎 🪟 🐧 - Institutional memory for AI coding agents. Captures lessons learned as scars that surface automatically before mistakes repeat. Semantic search, session tracking, and temporal decay. Works with Claude Code, Cursor, VS Code, and Windsurf.
