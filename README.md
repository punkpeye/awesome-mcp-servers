...
- [PocketMCP](https://github.com/axonixtools/PocketMCP) ☕ 🏠 🐧 - Turn your Android phone into an MCP (Model Context Protocol) server. AI agents and desktop scripts can call your phone for live data and actions over LAN or Tailscale.
