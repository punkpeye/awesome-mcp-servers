...
- [chhavimishra/originselect-mcp-server](https://github.com/chhavimishra/originselect-mcp-server) [![chhavimishra/originselect-mcp-server MCP server](https://glama.ai/mcp/servers/chhavimishra/originselect-mcp-server/badges/score.svg)](https://glama.ai/mcp/servers/chhavimishra/originselect-mcp-server) 📇 ☁️ - MCP server for OriginSelect — search ethical, origin-verified products and brands from different countries via AI agents. Discover products by category, values, and country of origin.
