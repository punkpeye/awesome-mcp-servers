...
- [kyomi-ai/mcp-server](https://github.com/kyomi-ai/mcp-server) 🦀 ☁️ - AI data intelligence platform that brings your data warehouse, dashboards, monitoring, and accumulated business knowledge into any MCP client. Connects to BigQuery, Snowflake, PostgreSQL, MySQL, ClickHouse, Redshift, Databricks, SQL Server, and Azure Synapse.
