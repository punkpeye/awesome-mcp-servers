...
- [airano-ir/mcphub](https://github.com/airano-ir/mcphub) [glama](https://glama.ai/mcp/servers/@airano-ir/mcphub) 🐍 ☁️ 🏠 🍎 🪟 🐧 - Unified MCP server for managing WordPress, WooCommerce, Gitea, n8n, Supabase, OpenPanel, Appwrite, and Directus with 596 tools, multi-site support, and OAuth 2.1 authentication.
