...
- [MidOSresearch/midos-mcp](https://github.com/MidOSresearch/midos-mcp) 🐍 🏠 🍎 🪟 🐧 - Curated Knowledge API for AI Agents with 48 MCP tools, 104 skill packs, semantic search, and 5-layer validation pipeline. Works with Claude Code, Cursor, Cline, Windsurf.
