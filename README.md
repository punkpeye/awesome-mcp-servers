...
- [sgx-labs/statelessagent](https://github.com/sgx-labs/statelessagent) 🏎️ 🏠 🍎 🪟 🐧 - Persistent memory for AI coding agents. 12 MCP tools, semantic + keyword search, cross-vault federation, 6-gate context surfacing. Single Go binary, SQLite, fully local, no API keys.
