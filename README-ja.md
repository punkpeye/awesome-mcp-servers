...
- [rohitg00/kubectl-mcp-server](https://github.com/rohitg00/kubectl-mcp-server) 🐍 ☁️/🏠 - Claude、Cursor、その他のAIアシスタントが自然言語を介してKubernetesクラスターと対話できるようにするモデルコンテキストプロトコル（MCP）サーバー。
