...
- [JamesANZ/video-toolkit-mcp](https://github.com/JamesANZ/video-toolkit-mcp) 📇 ☁️ 🏠 🍎 🪟 🐧 - トランスクリプト、ダウンロード、AI字幕生成のためのビデオツールキット。YouTube/Vimeo/Bilibiliからトランスクリプトを取得、yt-dlpで動画をダウンロード、OpenAI Whisperまたはローカルwhisperで字幕を自動生成。
