...
- [Nic9dev/Chronica](https://github.com/Nic9dev/Chronica) [![Chronica MCP server](https://glama.ai/mcp/servers/Nic9dev/Chronica/badges/score.svg)](https://glama.ai/mcp/servers/Nic9dev/Chronica) 🐍 🏠 - Claude Desktop 向け永続メモリ MCPサーバー。セッションをまたいだ記憶の自動保存・時刻認識・Streamlit キュレーションUIを提供します。
