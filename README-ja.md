...
- [Chronica](https://github.com/Nic9dev/Chronica) - Claude Desktop専用の永続記憶MCPサーバー。SQLiteに構造化された記憶を保存し、StreamlitのキュレーションUIでトークン管理も可能。 [![Glama](https://glama.ai/mcp/servers/Nic9dev/Chronica/badge)](https://glama.ai/mcp/servers/Nic9dev/Chronica)
