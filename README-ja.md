...
- [longbridge/longbridge-mcp](https://github.com/longbridge/longbridge-mcp) [![longbridge/longbridge-mcp MCP server](https://glama.ai/mcp/servers/longbridge/longbridge-mcp/badges/score.svg)](https://glama.ai/mcp/servers/longbridge/longbridge-mcp) 🎖️ 🦀 ☁️ - Longbridge公式ブローカーMCP — 米国・香港株のリアルタイム相場、オプション、取引、ファンダメンタルズ、アナリスト評価など128ツール。`https://openapi.longbridge.com/mcp` でホスト、OAuth 2.1対応。
