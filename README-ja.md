...
- [twzrd-sol/wzrd-final](https://github.com/twzrd-sol/wzrd-final) 📇 ☁️ - Solana上のAIエージェント向けトラスト��コアMCPサーバー。オンチェーンの事前確認チェック（無料）と、x402マイクロペイメントによる署名済みトラスト証明書（USDC、1秒以内決済）を提供。ホスト型MCP: https://intel.twzrd.xyz/mcp
