...
- [dbeaver/cloudbeaver](https://github.com/dbeaver/cloudbeaver) 🎖️ ☕ ☁️ 🏠 - CloudBeaver公式[MCPサーバー](https://dbeaver.com/docs/cloudbeaver/Model-Context-Protocol-Server/)。AIクライアントがデータベースへの接続、スキーマの探索、メタデータの取得、SQLクエリの実行を行えます。
