...
- [shunshi-ai/bazi-reader-mcp](https://github.com/shunshi-ai/bazi-reader-mcp) 📇 🏠 🍎 🪟 🐧 - 生年月日と出生地から四柱推命の命式を計算。真太陽時（均時差）補正を内蔵、90+ 都市の座標キャッシュ、多言語対応（中文 / English / 日本語 / 한국어）。Shunshi.AI の計算エンジンを使用。
