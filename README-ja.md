...
- [stackloklabs/toolhive](https://github.com/StacklokLabs/toolhive) 🔒 🐝 - ToolHive（thv）は、MCP（Model Context Protocol）サーバーのデプロイと管理を簡素化するために設計された軽量ユーティリティで、使いやすさ、一貫性、およびセキュリティを確保します。
