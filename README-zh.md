...
- [JamesANZ/video-toolkit-mcp](https://github.com/JamesANZ/video-toolkit-mcp) 📇 ☁️ 🏠 🍎 🪟 🐧 - 视频工具包，用于获取字幕、下载视频和AI字幕生成。从YouTube/Vimeo/Bilibili获取字幕，通过yt-dlp下载视频，使用OpenAI Whisper或本地whisper自动生成字幕。
