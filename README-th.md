...
- [mobbin/mobbin-mcp-server](https://github.com/mobbin/mobbin-mcp-server) 🎖️ ☁️ - ค้นหาตัวอย่างการออกแบบ UI จริง — หน้าจอ โฟลว์การใช้งานแบบหลายขั้นตอน และส่วนต่าง ๆ ของเว็บไซต์ — จากแอปและเว็บไซต์หลายพันแห่ง ใช้เอนด์พอยต์ Streamable HTTP ที่โฮสต์ไว้ที่ `https://api.mobbin.com/mcp` ด้วย OAuth (ไม่ต้องใช้ API key) และแสดงผลลัพธ์เป็นแกลเลอรีแบบอินเทอร์แอกทีฟในไคลเอนต์ที่รองรับ MCP Apps
