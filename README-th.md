...
- [globalpocket/mcp-routing-gateway](https://github.com/globalpocket/mcp-routing-gateway) - เกตเวย์การกำหนดเส้นทาง MCP แบบไร้สถานะ (stateless) และ Pure Proxy เพื่อจัดการ กรอง และสร้างสภาพแวดล้อมเสมือนสำหรับเครื่องมือที่นำเสนอต่อ LLMs อย่างปลอดภัย
...
- [globalpocket/mcp-mlx-launcher](https://github.com/globalpocket/mcp-mlx-launcher) - เซิร์ฟเวอร์ MCP สำหรับจัดการ เริ่มต้น และปิดอินสแตนซ์ `mlx-lm` ในเครื่องบน Apple Silicon โดยอัตโนมัติ
