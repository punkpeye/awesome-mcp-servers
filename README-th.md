...
- [s60yucca/mnemos](https://github.com/s60yucca/mnemos) 🏎️ 🏠 🍎 🪟 🐧 - เครื่องมือจัดการหน่วยความจำถาวรสำหรับตัวแทน AI ด้านการเขียนโค้ด ไบนารี Go เดียว ไม่มีการพึ่งพา runtime ใช้งาน MCP โดยตรง จัดเก็บ ค้นหา และลบข้อมูลซ้ำในหน่วยความจำข้ามเซสชันโดยใช้ SQLite แบบฝังตัวพร้อมการค้นหาแบบไฮบริด FTS + semantic การลดลงของหน่วยความจำ กราฟความสัมพันธ์ และการประกอบบริบทตามงบประมาณโทเค็น
