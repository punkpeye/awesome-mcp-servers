...
- [memcell-ai/cli](https://github.com/memcell-ai/cli) 📇 🏠 🍎 🪟 🐧 - หน่วยความจำแบบมีชีวิตสำหรับ AI coding agents (Claude Code, Cursor, Copilot, Codex) หน่วยความจำถาวรข้ามเครื่องมือ การเรียกค้นการตัดสินใจ และการปรับเทียบผลลัพธ์ผ่าน MCP และ hooks `npm install -g memcell`
