...
- [PaddlePaddle/PaddleOCR](https://paddlepaddle.github.io/PaddleOCR/latest/en/version3.x/deployment/mcp_server.html) - เซิร์ฟเวอร์ MCP ที่มอบความสามารถในการรู้จำข้อความ (OCR) และการแยกวิเคราะห์เอกสารระดับองค์กรให้กับแอปพลิเคชัน AI
