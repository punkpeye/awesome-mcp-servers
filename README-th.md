...
- [longbridge/longbridge-mcp](https://github.com/longbridge/longbridge-mcp) [![longbridge/longbridge-mcp MCP server](https://glama.ai/mcp/servers/longbridge/longbridge-mcp/badges/score.svg)](https://glama.ai/mcp/servers/longbridge/longbridge-mcp) 🎖️ 🦀 ☁️ - MCP อย่างเป็นทางการของโบรกเกอร์ Longbridge — 128 เครื่องมือสำหรับราคาหุ้นสหรัฐฯ/ฮ่องกงแบบเรียลไทม์ ออปชัน การซื้อขาย ข้อมูลพื้นฐาน การแจ้งเตือนราคา และการวิเคราะห์พอร์ต โฮสต์ที่ `https://openapi.longbridge.com/mcp` รองรับ OAuth 2.1
