...
- [team-telnyx/telnyx-mcp-server](https://github.com/team-telnyx/telnyx-mcp-server) 🎖️ 🐍 ☁️ 🏠 - เซิร์ฟเวอร์ MCP อย่างเป็นทางการสำหรับสร้างแอปพลิเคชันการสื่อสารที่ขับเคลื่อนด้วย AI สร้างผู้ช่วยเสียง ส่งแคมเปญ SMS จัดการหมายเลขโทรศัพท์ และผสานรวมการส่งข้อความแบบเรียลไทม์ด้วยความน่าเชื่อถือระดับองค์กร รวมเซิร์ฟเวอร์ระยะไกล [streamable-http](https://api.telnyx.com/v2/mcp) และ [sse](https://api.telnyx.com/mcp/sse)
