...
- [KwanLeeFrmVi/mcp-server-memory](https://github.com/kwanLeeFrmVi/mcp-server-memory)📇 🏠 เซิร์ฟเวอร์ MCP แบบอินเมมโมรีความเร็วสูง สำหรับการทดสอบ ดีบัก และการพัฒนาอย่างรวดเร็ว ปรับแต่งเพื่อความเร็วโดยใช้หน่วยความจำ พร้อมความสามารถในการบันทึกข้อมูลลง JSON อย่างชาญฉลาด ให้คุณได้ทั้งประสิทธิภาพและความทนทาน
