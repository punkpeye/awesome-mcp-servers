...
- [preloop/preloop](https://github.com/preloop/preloop) 🐍 ☁️ 🏠 🍎 🪟 🐧 - แพลตฟอร์มอัตโนมัติ AI แบบขับเคลื่อนด้วยเหตุการณ์พร้อมความปลอดภัย human-in-the-loop ในตัวที่ใช้การพร็อกซี MCP
