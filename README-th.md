...
- [freema/mcp-design-system-extractor](https://github.com/freema/mcp-design-system-extractor) 📇 🏠 - ดึงข้อมูลคอมโพเนนต์จากระบบออกแบบ Storybook ให้ HTML สไตล์ คุณสมบัติ การพึ่งพา โทเค็นธีม และเมทาดาต้าคอมโพเนนต์สำหรับการวิเคราะห์ระบบออกแบบที่ขับเคลื่อนด้วย AI
