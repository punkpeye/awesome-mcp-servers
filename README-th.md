...
- [TWZRD Agent Intel](https://intel.twzrd.xyz) 📇 ☁️ - เซิร์ฟเวอร์ MCP บน Solana สำหรับให้คะแนนความน่าเชื่อถือของ AI agents. 4 เครื่องมือฟรีตรวจสอบ wallet Solana ใดๆ; `get_trust_receipt` แบบชำระเงินคืนโทเค็นความน่าเชื่อถือ `twzrd.receipt.v5` ที่เซ็นชื่อแล้วผ่าน HTTP 402 + USDC. MCP endpoint: https://intel.twzrd.xyz/mcp
