# Servidores MCP Increíbles [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
...
[![Español](https://img.shields.io/badge/Español-Haga_clic-red)](README-es.md)
[![Discord](https://img.shields.io/discord/1312302100125843476?logo=discord&label=discord)](https://glama.ai/mcp/discord)
[![Subreddit subscribers](https://img.shields.io/reddit/subreddit-subscribers/mcp?style=flat&logo=reddit&label=subreddit)](https://www.reddit.com/r/mcp/)

Una lista curada de servidores Model Context Protocol (MCP) increíbles.
...
### 💰 <a name="finanzas--fintech"></a>Finanzas & Fintech
...
- [TWZRD Agent Intel](https://intel.twzrd.xyz) 📇 ☁️ - Servidor MCP de puntuación de confianza para agentes de IA en Solana. 4 herramientas gratuitas: `resolve_agent`, `score_agent`, `preflight_check`, `verify_trust_receipt`. 1 herramienta de pago: `get_trust_receipt` vía micropago x402 (<$0,01 USDC, liquidación Solana en <1s). Sin instalación: `{"mcpServers":{"twzrd-agent-intel":{"url":"https://intel.twzrd.xyz/mcp"}}}`

### 🎮 <a name="juegos"></a>Juegos
